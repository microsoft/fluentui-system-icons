...
const AddFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10.5 2.75a.75.75 0 0 0-1.5 0V9H2.75a.75.75 0 0 0 0 1.5H9v6.25a.75.75 0 0 0 1.5 0V10.5h6.25a.75.75 0 0 0 0-1.5H10.5V2.75Z" fill={primaryFill} /></Svg>;;
}
...
const AddRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10 2.5a.5.5 0 0 0-1 0V9H2.5a.5.5 0 0 0 0 1H9v6.5a.5.5 0 0 0 1 0V10h6.5a.5.5 0 0 0 0-1H10V2.5Z" fill={primaryFill} /></Svg>;;
}
...
const AddCircleFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M18 10a8 8 0 1 1-16 0 8 8 0 0 1 16 0ZM6 10c0 .28.22.5.5.5h3v3a.5.5 0 0 0 1 0v-3h3a.5.5 0 0 0 0-1h-3v-3a.5.5 0 0 0-1 0v3h-3a.5.5 0 0 0-.5.5Z" fill={primaryFill} /></Svg>;;
}
...
const AddCircleRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 10c0-.28.22-.5.5-.5h3v-3a.5.5 0 0 1 1 0v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3A.5.5 0 0 1 6 10Zm4 8a8 8 0 1 0 0-16 8 8 0 0 0 0 16Zm0-1a7 7 0 1 1 0-14 7 7 0 0 1 0 14Z" fill={primaryFill} /></Svg>;;
}
...
const AddSquareFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M5 3a2 2 0 0 0-2 2v10c0 1.1.9 2 2 2h10a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5Zm5.5 3.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3a.5.5 0 0 1 1 0Z" fill={primaryFill} /></Svg>;;
}
...
const AddSquareRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3 5c0-1.1.9-2 2-2h10a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5Zm2-1a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1H5Zm5 2c.28 0 .5.22.5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3c0-.28.22-.5.5-.5Z" fill={primaryFill} /></Svg>;;
}
...
const AddSquareMultipleRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16 5.27V13a3 3 0 0 1-3 3H5.27c.34.6.99 1 1.73 1h6a4 4 0 0 0 4-4V7a2 2 0 0 0-1-1.73ZM11.5 9.5a.5.5 0 0 0 0-1h-2v-2a.5.5 0 1 0-1 0v2h-2a.5.5 0 0 0 0 1h2v2a.5.5 0 0 0 1 0v-2h2ZM13 3a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5c0-1.1.9-2 2-2h8Zm1 2a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V5Z" fill={primaryFill} /></Svg>;;
}
...
const AirplaneFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9 2c.6 0 1.16.36 1.4.92l2.37 5.4 3.23-.2a1.88 1.88 0 0 1 2 1.76V10c0 1.04-.84 1.88-1.88 1.88H16l-3.23-.2-2.37 5.4c-.24.56-.8.92-1.4.92a.88.88 0 0 1-.88-.88v-.06l.7-5.63-2.46-.16-1.14 2.28a.8.8 0 0 1-.72.45.5.5 0 0 1-.5-.5v-2.38l-1.06-.06a1 1 0 0 1-.94-1v-.12a1 1 0 0 1 .94-1L4 8.88V6.5c0-.28.22-.5.5-.5.3 0 .59.17.72.45l1.14 2.28 2.46-.16L8.12 3A.88.88 0 0 1 9 2Z" fill={primaryFill} /></Svg>;;
}
...
const AlbumFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M2 6c0-1.1.9-2 2-2v12a2 2 0 0 1-2-2V6Zm7 2.5c0-.28.22-.5.5-.5h4c.28 0 .5.22.5.5v1a.5.5 0 0 1-.5.5h-4a.5.5 0 0 1-.5-.5v-1ZM5 16V4h11a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5Zm4.5-9C8.67 7 8 7.67 8 8.5v1c0 .83.67 1.5 1.5 1.5h4c.83 0 1.5-.67 1.5-1.5v-1c0-.83-.67-1.5-1.5-1.5h-4Z" fill={primaryFill} /></Svg>;;
}
...
const AlbumRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M8 8.5C8 7.67 8.67 7 9.5 7h4c.83 0 1.5.67 1.5 1.5v1c0 .83-.67 1.5-1.5 1.5h-4A1.5 1.5 0 0 1 8 9.5v-1ZM9.5 8a.5.5 0 0 0-.5.5v1c0 .28.22.5.5.5h4a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-4ZM2 6c0-1.1.9-2 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6Zm4 9h10a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H6v10ZM5 5H4a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h1V5Z" fill={primaryFill} /></Svg>;;
}
...
const AlertFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M12.45 16a2.5 2.5 0 0 1-4.9 0h4.9ZM10 2a5.92 5.92 0 0 1 5.98 5.36l.02.22V11.4l.95 2.6.03.08.01.09v.08c0 .32-.19.6-.51.71l-.12.03-.11.01H3.75a.75.75 0 0 1-.74-.76v-.12l.04-.12L4 11.4V7.57A5.9 5.9 0 0 1 10 2Z" fill={primaryFill} /></Svg>;;
}
...
const AlertBadgeFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M12.45 16a2.5 2.5 0 0 1-4.9 0h4.9ZM10 2c1.09 0 2.11.28 3 .77a3 3 0 0 0 3 5.06v3.58l.95 2.59.03.08.01.09v.08c0 .32-.19.6-.51.71l-.12.03-.11.01H3.75a.75.75 0 0 1-.74-.76v-.12l.04-.12L4 11.4V7.57A5.9 5.9 0 0 1 10 2Zm5 5a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z" fill={primaryFill} /></Svg>;;
}
...
const AlertOffRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 7.57c.04-.82.24-1.59.58-2.28L2.15 2.85a.5.5 0 1 1 .7-.7l15 15a.5.5 0 0 1-.7.7L14.3 15h-1.8v.17a2.5 2.5 0 0 1-5 0V15H4a1 1 0 0 1-.26-.03l-.13-.04a1 1 0 0 1-.6-1.05l.02-.13.05-.13L4 11.4V7.57ZM13.3 14 5.34 6.05a4.6 4.6 0 0 0-.32 1.33L5 7.6V11.5l-.04.2L4 14h9.3Zm-1.8 1h-3v.14a1.5 1.5 0 0 0 1.36 1.34l.14.01c.78 0 1.42-.6 1.5-1.36V15Zm3.54-3.32.87 2.1.86.85c.15-.17.23-.4.23-.64v-.13l-.02-.08a1 1 0 0 0-.06-.17L16 11.4V7.58l-.02-.22A5.92 5.92 0 0 0 10 2a6.1 6.1 0 0 0-4.21 1.66l.7.71A5.1 5.1 0 0 1 10 3a4.9 4.9 0 0 1 5 4.6l.01.21v3.69l.04.2Z" fill={primaryFill} /></Svg>;;
}
...
const AlignBottomFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M2.5 17a.5.5 0 0 1 0-1h15a.5.5 0 0 1 0 1h-15ZM4 13c0 1.1.9 2 2 2h1a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8Zm7 0c0 1.1.9 2 2 2h1a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-1a2 2 0 0 0-2 2v5Z" fill={primaryFill} /></Svg>;;
}
...
const AlignCenterHorizontalFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M18 9.5a.5.5 0 0 1-.5.5H16v2a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-2H9v4a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-4H2.5a.5.5 0 0 1 0-1H4V5c0-1.1.9-2 2-2h1a2 2 0 0 1 2 2v4h2V7c0-1.1.9-2 2-2h1a2 2 0 0 1 2 2v2h1.5c.28 0 .5.22.5.5Z" fill={primaryFill} /></Svg>;;
}
...
const AlignCenterVerticalFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10.5 18a.5.5 0 0 1-.5-.5V16H8a2 2 0 0 1-2-2v-1c0-1.1.9-2 2-2h2V9H6a2 2 0 0 1-2-2V6c0-1.1.9-2 2-2h4V2.5a.5.5 0 0 1 1 0V4h4a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-4v2h2a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-2v1.5a.5.5 0 0 1-.5.5Z" fill={primaryFill} /></Svg>;;
}
...
const AlignCenterVerticalRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10.5 18a.5.5 0 0 1-.5-.5V16H8a2 2 0 0 1-2-2v-1c0-1.1.9-2 2-2h2V9H6a2 2 0 0 1-2-2V6c0-1.1.9-2 2-2h4V2.5a.5.5 0 0 1 1 0V4h4a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-4v2h2a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-2v1.5a.5.5 0 0 1-.5.5ZM6 5a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h9a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H6Zm2 7a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1v-1a1 1 0 0 0-1-1H8Z" fill={primaryFill} /></Svg>;;
}
...
const AlignEndHorizontalFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16 17.5a.5.5 0 0 0 1 0v-15a.5.5 0 0 0-1 0v15Z" fill={primaryFill} /><Path d="M10 4a2 2 0 0 0-2 2v8c0 1.1.9 2 2 2h2a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-2Z" fill={primaryFill} /></Svg>;;
}
...
const AlignEndVerticalFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 10c0-1.1.9-2 2-2h8a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-2Z" fill={primaryFill} /><Path d="M2 16.5c0-.28.22-.5.5-.5h15a.5.5 0 0 1 0 1h-15a.5.5 0 0 1-.5-.5Z" fill={primaryFill} /></Svg>;;
}
...
const AlignEndVerticalRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 8a2 2 0 0 0-2 2v2c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2H6Zm-1 2a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1v-2Z" fill={primaryFill} /><Path d="M2 16.5c0-.28.22-.5.5-.5h15a.5.5 0 0 1 0 1h-15a.5.5 0 0 1-.5-.5Z" fill={primaryFill} /></Svg>;;
}
...
const AlignLeftFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3.5 2a.5.5 0 0 0-.5.5v15a.5.5 0 0 0 1 0v-15a.5.5 0 0 0-.5-.5ZM7 11a2 2 0 0 0-2 2v1c0 1.1.9 2 2 2h5a2 2 0 0 0 2-2v-1a2 2 0 0 0-2-2H7ZM5 6c0-1.1.9-2 2-2h8a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6Z" fill={primaryFill} /></Svg>;;
}
...
const AlignLeftRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3.5 2a.5.5 0 0 0-.5.5v15a.5.5 0 0 0 1 0v-15a.5.5 0 0 0-.5-.5ZM7 11a2 2 0 0 0-2 2v1c0 1.1.9 2 2 2h5a2 2 0 0 0 2-2v-1a2 2 0 0 0-2-2H7Zm-1 2a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1v-1ZM5 6c0-1.1.9-2 2-2h8a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6Zm2-1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H7Z" fill={primaryFill} /></Svg>;;
}
...
const AlignRightFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16.5 2c.28 0 .5.22.5.5v15a.5.5 0 0 1-1 0v-15c0-.28.22-.5.5-.5ZM13 11a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-1c0-1.1.9-2 2-2h5Zm2-5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v1c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V6Z" fill={primaryFill} /></Svg>;;
}
...
const AlignRightRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16.5 2c.28 0 .5.22.5.5v15a.5.5 0 0 1-1 0v-15c0-.28.22-.5.5-.5ZM13 11a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-1c0-1.1.9-2 2-2h5Zm1 2a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1v-1Zm1-7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v1c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V6Zm-2-1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h8Z" fill={primaryFill} /></Svg>;;
}
...
const AlignSpaceAroundHorizontalFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M7.5 16c.83 0 1.5-.67 1.5-1.5v-9C9 4.67 8.33 4 7.5 4h-2C4.67 4 4 4.67 4 5.5v9c0 .83.67 1.5 1.5 1.5h2Z" fill={primaryFill} /><Path d="M14.5 16c.83 0 1.5-.67 1.5-1.5v-9c0-.83-.67-1.5-1.5-1.5h-2c-.83 0-1.5.67-1.5 1.5v9c0 .83.67 1.5 1.5 1.5h2Z" fill={primaryFill} /></Svg>;;
}
...
const AlignSpaceAroundHorizontalRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 4h1a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6c0-1.1.9-2 2-2ZM5 6v8a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1Z" fill={primaryFill} /><Path d="M13 4a2 2 0 0 0-2 2v8c0 1.1.9 2 2 2h1a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-1Zm-1 2a1 1 0 0 1 1-1h1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1V6Z" fill={primaryFill} /></Svg>;;
}
...
const AlignSpaceAroundVerticalFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 4a2 2 0 0 0-2 2v1c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H6Z" fill={primaryFill} /><Path d="M6 11a2 2 0 0 0-2 2v1c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2v-1a2 2 0 0 0-2-2H6Z" fill={primaryFill} /></Svg>;;
}
...
const AlignSpaceBetweenHorizontalFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3 4a2 2 0 0 0-2 2v8c0 1.1.9 2 2 2h1a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H3Z" fill={primaryFill} /><Path d="M16 4a2 2 0 0 0-2 2v8c0 1.1.9 2 2 2h1a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-1Z" fill={primaryFill} /></Svg>;;
}
...
const AlignSpaceBetweenVerticalFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 1a2 2 0 0 0-2 2v1c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2H6Z" fill={primaryFill} /><Path d="M6 14a2 2 0 0 0-2 2v1c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2v-1a2 2 0 0 0-2-2H6Z" fill={primaryFill} /></Svg>;;
}
...
const AlignSpaceBetweenVerticalRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 1a2 2 0 0 0-2 2v1c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2H6ZM5 3a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V3Z" fill={primaryFill} /><Path d="M6 14a2 2 0 0 0-2 2v1c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2v-1a2 2 0 0 0-2-2H6Zm-1 2a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1v-1Z" fill={primaryFill} /></Svg>;;
}
...
const AlignSpaceEvenlyHorizontalRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3 16a2 2 0 0 1-2-2V6c0-1.1.9-2 2-2h1a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H3Zm-1-2a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v8Zm7 2a2 2 0 0 1-2-2V6c0-1.1.9-2 2-2h1a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H9Zm-1-2a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v8Zm7 2a2 2 0 0 1-2-2V6c0-1.1.9-2 2-2h1a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-1Zm-1-2a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1h-1a1 1 0 0 0-1 1v8Z" fill={primaryFill} /></Svg>;;
}
...
const AlignSpaceFitVerticalFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 1a2 2 0 0 0-2 2v4.5c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2H6Z" fill={primaryFill} /><Path d="M6 10.5a2 2 0 0 0-2 2V17c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2v-4.5a2 2 0 0 0-2-2H6Z" fill={primaryFill} /></Svg>;;
}
...
const AlignSpaceFitVerticalRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 1a2 2 0 0 0-2 2v4.5c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2H6ZM5 3a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v4.5a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V3Z" fill={primaryFill} /><Path d="M6 10.5a2 2 0 0 0-2 2V17c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2v-4.5a2 2 0 0 0-2-2H6Zm-1 2a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1V17a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1v-4.5Z" fill={primaryFill} /></Svg>;;
}
...
const AlignStartHorizontalFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3 17.5a.5.5 0 0 0 1 0v-15a.5.5 0 0 0-1 0v15Z" fill={primaryFill} /><Path d="M8 4a2 2 0 0 0-2 2v8c0 1.1.9 2 2 2h2a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H8Z" fill={primaryFill} /></Svg>;;
}
...
const AlignStartVerticalFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M2.5 3a.5.5 0 0 0 0 1h15a.5.5 0 0 0 0-1h-15Z" fill={primaryFill} /><Path d="M6 6a2 2 0 0 0-2 2v2c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2H6Z" fill={primaryFill} /></Svg>;;
}
...
const AlignTopFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M2 3.5c0-.28.22-.5.5-.5h15a.5.5 0 0 1 0 1h-15a.5.5 0 0 1-.5-.5ZM11 7c0-1.1.9-2 2-2h1a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2V7ZM6 5a2 2 0 0 0-2 2v8c0 1.1.9 2 2 2h1a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H6Z" fill={primaryFill} /></Svg>;;
}
...
const AnimalCatFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4.97 18H13v-1.5a2.5 2.5 0 0 0-2.5-2.5h-1a.5.5 0 0 1 0-1h1a3.5 3.5 0 0 1 3.5 3.5V18h.25c.47 0 .9-.2 1.21-.5h.04v-.04c.29-.3.47-.72.47-1.18v-7.6a2.12 2.12 0 0 0 1.7-3.24l-.5-.81c-.38-.63-1.06-1-1.8-1h-1.43v-.64a.99.99 0 0 0-.99-.99 2.45 2.45 0 0 0-2.44 2.45V7.9a4.28 4.28 0 0 0-2.95 1.58 6.69 6.69 0 0 0-1.04 1.8c-.23.46-.39.96-.47 1.49l-.01.06A17.04 17.04 0 0 0 5.63 17h-.66a1.97 1.97 0 0 1-1.44-3.32l.92-.98a3.59 3.59 0 0 0-.09-4.99l-.9-.9a.5.5 0 1 0-.7.7l.9.9a2.59 2.59 0 0 1 .06 3.6l-.92 1A2.97 2.97 0 0 0 4.97 18Z" fill={primaryFill} /></Svg>;;
}
...
const AnimalDogFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M12 2c-.33 0-.81.1-1.23.4-.44.31-.77.84-.77 1.6v1.25c0 .13.04.34.16.5.09.12.25.25.59.25.34 0 .5-.13.6-.26a.9.9 0 0 0 .15-.49.5.5 0 1 1 1 0c0 .3-.08.71-.35 1.08-.28.39-.74.67-1.4.67-.32 0-.6-.06-.82-.18a6.5 6.5 0 0 1-1.78 3.83 7.47 7.47 0 0 0-1.89 3.48A9.33 9.33 0 0 0 6 15.95v.08a1.34 1.34 0 0 1-.13.5.82.82 0 0 1-.28.32c-.12.08-.3.15-.59.15a2 2 0 0 1-1.2-3.6.5.5 0 1 0-.6-.8A3 3 0 0 0 5 18h8v-.5c0-.4-.19-1.05-.73-1.33-.19-.1-.44-.17-.77-.17h-1a.5.5 0 0 1 0-1h1c.18 0 .34.01.5.04V12.5a.5.5 0 0 1 1 0v2.95c.79.57 1 1.52 1 2.05v.5h2.5a.5.5 0 0 0 .5-.5c0-.87-.3-1.52-.8-1.95-.36-.29-.78-.45-1.2-.51V7h.5c.83 0 1.5-.67 1.5-1.5V4.28a1 1 0 0 0-.49-.85l-1.78-1.07A2.5 2.5 0 0 0 13.45 2H12Z" fill={primaryFill} /></Svg>;;
}
...
const AppFolderFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M5 6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V6Zm0 6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1v-2Zm6-6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1V6Zm0 6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-2ZM2 5a3 3 0 0 1 3-3h10a3 3 0 0 1 3 3v10a3 3 0 0 1-3 3H5a3 3 0 0 1-3-3V5Zm3-2a2 2 0 0 0-2 2v10c0 1.1.9 2 2 2h10a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5Z" fill={primaryFill} /></Svg>;;
}
...
const AppRecentFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M7 2a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h6a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H7ZM2 6c0-1.1.9-2 2-2v12a2 2 0 0 1-2-2V6Zm14 10V4a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2Z" fill={primaryFill} /></Svg>;;
}
...
const AppTitleFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M7 3a3 3 0 0 0-3 3v6a3 3 0 0 0 3 3h6a3 3 0 0 0 3-3V6a3 3 0 0 0-3-3H7ZM4.5 17a.5.5 0 0 0 0 1h11a.5.5 0 0 0 0-1h-11Z" fill={primaryFill} /></Svg>;;
}
...
const AppTitleRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 6a3 3 0 0 1 3-3h6a3 3 0 0 1 3 3v6a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3V6Zm3-2a2 2 0 0 0-2 2v6c0 1.1.9 2 2 2h6a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H7ZM4 17.5c0-.28.22-.5.5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5Z" fill={primaryFill} /></Svg>;;
}
...
const AppsFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4.5 17A1.5 1.5 0 0 1 3 15.65V4.5c0-.78.6-1.42 1.36-1.5H9c.78 0 1.42.6 1.5 1.36v.4l2.19-2.27a1.5 1.5 0 0 1 2-.14l.12.1 2.76 2.72c.55.55.6 1.42.11 2.02l-.1.11-2.31 2.2h.23c.78 0 1.42.6 1.5 1.36v4.64c0 .78-.6 1.42-1.36 1.5H4.5Zm5-6.5H4v5c0 .22.14.4.33.47l.08.02.09.01h5v-5.5Zm6 0h-5V16h5a.5.5 0 0 0 .5-.4V11a.5.5 0 0 0-.41-.5h-.09Zm-5-2.79V9.5h1.79L10.5 7.71ZM9 4.01H4.5a.5.5 0 0 0-.5.4v5.1h5.5v-5a.5.5 0 0 0-.33-.48l-.08-.02H9Z" fill={primaryFill} /></Svg>;;
}
...
const AppsListFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M8 4.5c0-.28.22-.5.5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5Zm0 6c0-.28.22-.5.5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5Zm0 6c0-.28.22-.5.5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5Zm-6-1c0-.83.67-1.5 1.5-1.5h1c.83 0 1.5.67 1.5 1.5v1c0 .83-.67 1.5-1.5 1.5h-1A1.5 1.5 0 0 1 2 16.5v-1Zm0-6C2 8.67 2.67 8 3.5 8h1C5.33 8 6 8.67 6 9.5v1c0 .83-.67 1.5-1.5 1.5h-1A1.5 1.5 0 0 1 2 10.5v-1Zm0-6C2 2.67 2.67 2 3.5 2h1C5.33 2 6 2.67 6 3.5v1C6 5.33 5.33 6 4.5 6h-1A1.5 1.5 0 0 1 2 4.5v-1Z" fill={primaryFill} /></Svg>;;
}
...
const ArchiveFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M2 4.25C2 3.56 2.56 3 3.25 3h13.5c.69 0 1.25.56 1.25 1.25v1.5C18 6.44 17.44 7 16.75 7H3.25C2.56 7 2 6.44 2 5.75v-1.5ZM3 8h14v6a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V8Zm5.5 2a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1h-3Z" fill={primaryFill} /></Svg>;;
}
...
const ArchiveRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M8.5 10a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1h-3ZM2 4.75C2 3.78 2.78 3 3.75 3h12.5c.97 0 1.75.78 1.75 1.75v1.5c0 .7-.4 1.3-1 1.58V14a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V7.83c-.6-.28-1-.88-1-1.58v-1.5ZM3.75 4a.75.75 0 0 0-.75.75v1.5c0 .41.34.75.75.75h12.5c.41 0 .75-.34.75-.75v-1.5a.75.75 0 0 0-.75-.75H3.75ZM4 8v6c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V8H4Z" fill={primaryFill} /></Svg>;;
}
...
const ArchiveMultipleFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3.5 2C2.67 2 2 2.67 2 3.5v1C2 5.33 2.67 6 3.5 6h11c.83 0 1.5-.67 1.5-1.5v-1c0-.83-.67-1.5-1.5-1.5h-11ZM15 7H3v5.5A3.5 3.5 0 0 0 6.5 16h5a3.5 3.5 0 0 0 3.5-3.5V7ZM7 8.5c0-.28.22-.5.5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5ZM8.5 18c-.95 0-1.82-.38-2.45-1h6.45a3.5 3.5 0 0 0 3.5-3.5V7.09c.58.2 1 .76 1 1.41v5a4.5 4.5 0 0 1-4.5 4.5h-4Z" fill={primaryFill} /></Svg>;;
}
...
const ArchiveMultipleRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M7.5 8a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1h-3Zm-4-6C2.67 2 2 2.67 2 3.5v2c0 .66.42 1.21 1 1.42A.5.5 0 0 0 3 7v5.5A3.5 3.5 0 0 0 6.5 16h5a3.5 3.5 0 0 0 3.5-3.5V7a.5.5 0 0 0 0-.08c.58-.2 1-.76 1-1.42v-2c0-.83-.67-1.5-1.5-1.5h-11ZM4 12.5V7h10v5.5a2.5 2.5 0 0 1-2.5 2.5h-5A2.5 2.5 0 0 1 4 12.5Zm-1-9c0-.28.22-.5.5-.5h11c.28 0 .5.22.5.5v2a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-2ZM8.5 18c-.95 0-1.82-.38-2.45-1h6.45a3.5 3.5 0 0 0 3.5-3.5V7.09c.58.2 1 .76 1 1.41v5a4.5 4.5 0 0 1-4.5 4.5h-4Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowAutofitDownRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16.14 15.2 15 16.36V2.5a.5.5 0 1 0-1 0v13.87l-1.14-1.18a.5.5 0 1 0-.72.7l1.82 1.88c.3.3.79.3 1.08 0l1.82-1.88a.5.5 0 1 0-.72-.7ZM5 17a2 2 0 0 1-2-2V5c0-1.1.9-2 2-2h6.5a.5.5 0 0 1 0 1H5a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h4.5a.5.5 0 1 1 0 1H5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowAutofitUpRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16.14 4.8 15 3.64V17.5a.5.5 0 1 1-1 0V3.63L12.86 4.8a.5.5 0 0 1-.72-.7l1.82-1.88c.3-.3.79-.3 1.08 0l1.82 1.88a.5.5 0 1 1-.72.7ZM5 3a2 2 0 0 0-2 2v10c0 1.1.9 2 2 2h6.5a.5.5 0 0 0 0-1H5a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1h4.5a.5.5 0 0 0 0-1H5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowAutofitWidthDottedRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="m15.2 16.14 1.7-1.64-1.7-1.64a.5.5 0 0 1 .69-.72l1.88 1.82c.3.3.3.79 0 1.08l-1.88 1.82a.5.5 0 1 1-.7-.72ZM17 5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v4.5a.5.5 0 0 0 1 0V5a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v4.5a.5.5 0 1 0 1 0V5Zm-2 9.5a.5.5 0 0 1-.5.5H13a.5.5 0 1 1 0-1h1.5c.28 0 .5.23.5.5ZM7 15a.5.5 0 1 0 0-1H5.5a.5.5 0 0 0 0 1H7Zm4-.5a.5.5 0 0 1-.5.5h-1a.5.5 0 1 1 0-1h1c.28 0 .5.23.5.5Zm-6.19 1.64-1.7-1.64 1.7-1.64a.5.5 0 0 0-.7-.72l-1.88 1.82c-.3.3-.3.79 0 1.08l1.89 1.82a.5.5 0 1 0 .69-.72Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowBetweenDownRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 2a.5.5 0 0 0-1 0v.5C3 3.33 3.67 4 4.5 4h10c.83 0 1.5-.67 1.5-1.5V2a.5.5 0 0 0-1 0v.5a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5V2Zm5.5 3c.28 0 .5.22.5.5v7.8l3.65-3.65a.5.5 0 0 1 .7.7l-4.5 4.5a.5.5 0 0 1-.7 0l-4.5-4.5a.5.5 0 0 1 .7-.7L9 13.29V5.5c0-.28.22-.5.5-.5ZM3 17.5c0-.83.67-1.5 1.5-1.5h10c.83 0 1.5.67 1.5 1.5v.5a.5.5 0 0 1-1 0v-.5a.5.5 0 0 0-.5-.5h-10a.5.5 0 0 0-.5.5v.5a.5.5 0 0 1-1 0v-.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowBidirectionalUpDownRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6.35 7.35a.5.5 0 1 1-.7-.7l3.5-3.5c.2-.2.5-.2.7 0l3.5 3.5a.5.5 0 0 1-.7.7L10 4.71v10.58l2.65-2.64a.5.5 0 0 1 .7.7l-3.5 3.5a.5.5 0 0 1-.7 0l-3.5-3.5a.5.5 0 0 1 .7-.7L9 15.29V4.71L6.35 7.35Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowBounceFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M2.75 6a.75.75 0 0 0-.75.75v6.5a.75.75 0 0 0 1.5 0V8.56l6.47 6.47c.3.3.77.3 1.06 0l6.75-6.75a.75.75 0 0 0-1.06-1.06l-6.22 6.22L4.56 7.5h4.69a.75.75 0 0 0 0-1.5h-6.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowBounceRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M2.5 6a.5.5 0 0 0-.5.5v7a.5.5 0 0 0 1 0V7.7l7.15 7.15c.2.2.5.2.7 0l7-7a.5.5 0 0 0-.7-.7l-6.65 6.64L3.7 7h5.8a.5.5 0 0 0 0-1h-7Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCircleDownFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M18 10a8 8 0 1 1-16 0 8 8 0 0 1 16 0Zm-4.65.85a.5.5 0 0 0-.7-.7l-2.15 2.14V6.5a.5.5 0 0 0-1 0v5.8l-2.15-2.15a.5.5 0 0 0-.7.7l3 3c.2.2.5.2.7 0l3-3Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCircleDownRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="m13.35 10.85-3 3a.5.5 0 0 1-.7 0l-3-3a.5.5 0 0 1 .7-.7l2.15 2.14V6.5a.5.5 0 0 1 1 0v5.8l2.15-2.15a.5.5 0 0 1 .7.7ZM10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16Zm7-8a7 7 0 1 1-14 0 7 7 0 0 1 14 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCircleDownDoubleRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="m9 12.2-1.65 1.65a.5.5 0 0 1-.7 0L5 12.21a.5.5 0 1 1 .7-.71l.8.8V6.5a.5.5 0 0 1 1 0v5.8l.8-.8a.5.5 0 1 1 .7.7Zm1 5.8a8 8 0 1 0 0-16 8 8 0 0 0 0 16Zm7-8a7 7 0 1 1-14 0 7 7 0 0 1 14 0Zm-3.65 3.85L15 12.21a.5.5 0 1 0-.7-.71l-.8.8V6.5a.5.5 0 0 0-1 0v5.8l-.8-.8a.5.5 0 1 0-.7.7l1.65 1.65c.2.2.5.2.7 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCircleDownRightFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10 2a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm2.85 10.86a.5.5 0 0 1-.35.14h-5a.5.5 0 0 1 0-1h3.8L7.14 7.85a.5.5 0 1 1 .7-.7L12 11.29V7.5a.5.5 0 0 1 1 0v5a.5.5 0 0 1-.14.35Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCircleDownRightRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M12.85 12.86a.5.5 0 0 1-.35.14h-5a.5.5 0 0 1 0-1h3.8L7.14 7.85a.5.5 0 1 1 .7-.7L12 11.29V7.5a.5.5 0 0 1 1 0v5a.5.5 0 0 1-.14.35ZM10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16Zm7-8a7 7 0 1 1-14 0 7 7 0 0 1 14 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCircleLeftFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10 18a8 8 0 1 1 0-16 8 8 0 0 1 0 16Zm-.85-4.65a.5.5 0 0 0 .7-.7L7.71 10.5h5.79a.5.5 0 0 0 0-1H7.7l2.15-2.15a.5.5 0 0 0-.7-.7l-3 3a.5.5 0 0 0 0 .7l3 3Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCircleLeftRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="m9.15 13.35-3-3a.5.5 0 0 1 0-.7l3-3a.5.5 0 1 1 .7.7L7.71 9.5h5.79a.5.5 0 0 1 0 1H7.7l2.15 2.15a.5.5 0 0 1-.7.7ZM2 10a8 8 0 1 0 16 0 8 8 0 0 0-16 0Zm8 7a7 7 0 1 1 0-14 7 7 0 0 1 0 14Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCircleRightFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16Zm.85-4.65a.5.5 0 0 1-.7-.7l2.14-2.15H6.5a.5.5 0 0 1 0-1h5.8l-2.15-2.15a.5.5 0 0 1 .7-.7l3 3c.2.2.2.5 0 .7l-3 3Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCircleRightRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="m10.85 13.35 3-3a.5.5 0 0 0 0-.7l-3-3a.5.5 0 0 0-.7.7l2.14 2.15H6.5a.5.5 0 0 0 0 1h5.8l-2.15 2.15a.5.5 0 0 0 .7.7ZM18 10a8 8 0 1 1-16 0 8 8 0 0 1 16 0Zm-8 7a7 7 0 1 0 0-14 7 7 0 0 0 0 14Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCircleUpFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M2 10a8 8 0 1 1 16 0 8 8 0 0 1-16 0Zm4.65-.85a.5.5 0 1 0 .7.7L9.5 7.71v5.79a.5.5 0 0 0 1 0V7.7l2.15 2.15a.5.5 0 0 0 .7-.7l-3-3a.5.5 0 0 0-.7 0l-3 3Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCircleUpRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="m6.65 9.15 3-3c.2-.2.5-.2.7 0l3 3a.5.5 0 0 1-.7.7L10.5 7.71v5.79a.5.5 0 0 1-1 0V7.7L7.35 9.86a.5.5 0 0 1-.7-.7ZM10 2a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm-7 8a7 7 0 1 1 14 0 7 7 0 0 1-14 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCircleUpLeftFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16ZM7.15 7.14A.5.5 0 0 1 7.5 7h5a.5.5 0 0 1 0 1H8.7l4.15 4.15a.5.5 0 0 1-.7.7L8 8.71v3.79a.5.5 0 0 1-1 0v-5a.5.5 0 0 1 .14-.35Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCircleUpLeftRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M7.15 7.14A.5.5 0 0 1 7.5 7h5a.5.5 0 0 1 0 1H8.7l4.15 4.15a.5.5 0 0 1-.7.7L8 8.71v3.79a.5.5 0 0 1-1 0v-5a.5.5 0 0 1 .14-.35ZM10 2a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm-7 8a7 7 0 1 1 14 0 7 7 0 0 1-14 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowClockwiseRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3.07 9.05a7 7 0 0 1 12.55-3.22l.13.17H12.5a.5.5 0 1 0 0 1h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 0-1 0v2.2a8 8 0 1 0 1.99 4.77.5.5 0 0 0-1 .08 7 7 0 1 1-13.92-.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowClockwiseDashesRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M8.13 2.22a8.02 8.02 0 0 1 3.74 0 .5.5 0 0 1-.23.97 7.02 7.02 0 0 0-3.28 0 .5.5 0 1 1-.23-.97ZM6.51 3.34a.5.5 0 0 1-.17.69 7.04 7.04 0 0 0-2.31 2.31.5.5 0 0 1-.85-.52 8.04 8.04 0 0 1 2.64-2.64.5.5 0 0 1 .69.16Zm7.67-.16a.5.5 0 1 0-.52.85c.82.5 1.53 1.18 2.09 1.97H12.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 0-1 0v2.2a8.04 8.04 0 0 0-1.82-1.52ZM2.82 7.76a.5.5 0 0 1 .37.6 7.02 7.02 0 0 0 0 3.28.5.5 0 0 1-.97.23 8.02 8.02 0 0 1 0-3.74.5.5 0 0 1 .6-.37ZM18 10v-.5a.5.5 0 0 0-1 0v.5c0 .56-.07 1.11-.2 1.64a.5.5 0 1 0 .98.23c.14-.6.22-1.23.22-1.87ZM3.34 13.5a.5.5 0 0 1 .69.16 7.04 7.04 0 0 0 2.31 2.31.5.5 0 1 1-.52.85 8.04 8.04 0 0 1-2.64-2.64.5.5 0 0 1 .16-.69Zm13.48.68a.5.5 0 0 0-.85-.52 7.04 7.04 0 0 1-2.31 2.31.5.5 0 0 0 .52.85 8.04 8.04 0 0 0 2.64-2.64Zm-9.06 3a.5.5 0 0 1 .6-.37 7.02 7.02 0 0 0 3.28 0 .5.5 0 1 1 .23.97 8.02 8.02 0 0 1-3.74 0 .5.5 0 0 1-.37-.6Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCollapseAllRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M2 4.5c0-.28.22-.5.5-.5h15a.5.5 0 0 1 0 1h-15a.5.5 0 0 1-.5-.5Zm3.15 2.65c.2-.2.5-.2.7 0l2.5 2.5a.5.5 0 0 1-.7.7L6 8.71v6.79a.5.5 0 0 1-1 0V8.7l-1.65 1.65a.5.5 0 0 1-.7-.7l2.5-2.5ZM17.5 8h-7a.5.5 0 0 1 0-1h7a.5.5 0 0 1 0 1Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCounterclockwiseFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9.37 2.03A8 8 0 1 1 2 9.73a.75.75 0 0 1 1.5.05 6.5 6.5 0 1 0 1.57-4.03l-.2.25h2.38l.1.01a.75.75 0 0 1 0 1.49H3.15a.75.75 0 0 1-.64-.64V2.66c.04-.34.3-.6.64-.65h.2c.34.05.6.3.65.64v2.06a7.98 7.98 0 0 1 5.37-2.68Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCounterclockwiseRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16.93 9.05A7 7 0 0 0 4.38 5.83L4.25 6H7.5a.5.5 0 1 1 0 1h-4a.5.5 0 0 1-.5-.5v-4a.5.5 0 1 1 1 0v2.2a8 8 0 1 1-1.99 4.77.5.5 0 1 1 1 .08 7 7 0 1 0 13.92-.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCurveDownLeftRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M13.26 2.93a.5.5 0 0 0-.52-.86A6.95 6.95 0 0 0 9.86 5.1C9.26 6.38 9 7.96 9 10v6.3l-3.15-3.15a.5.5 0 1 0-.7.7l4 4c.2.2.5.2.7 0l4-4a.5.5 0 0 0-.7-.7L10 16.29V10c0-1.96.25-3.38.76-4.47a5.96 5.96 0 0 1 2.5-2.6Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCurveDownRightRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6.74 2.93a.5.5 0 1 1 .52-.86 6.95 6.95 0 0 1 2.88 3.03c.6 1.28.86 2.86.86 4.9v6.3l3.15-3.15a.5.5 0 0 1 .7.7l-4 4a.5.5 0 0 1-.7 0l-4-4a.5.5 0 1 1 .7-.7L10 16.29V10c0-1.96-.25-3.38-.76-4.47a5.96 5.96 0 0 0-2.5-2.6Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCurveUpLeftRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M5.85 6.85a.5.5 0 1 1-.7-.7l4-4c.2-.2.5-.2.7 0l4 4a.5.5 0 0 1-.7.7L10 3.71V10c0 1.96.25 3.38.76 4.47a5.96 5.96 0 0 0 2.5 2.6.5.5 0 0 1-.52.86 6.95 6.95 0 0 1-2.88-3.03C9.26 13.62 9 12.04 9 10V3.7L5.85 6.86Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowCurveUpRightRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M14.15 6.85a.5.5 0 0 0 .7-.7l-4-4a.5.5 0 0 0-.7 0l-4 4a.5.5 0 1 0 .7.7L10 3.71V10c0 1.96-.25 3.38-.76 4.47a5.96 5.96 0 0 1-2.5 2.6.5.5 0 0 0 .52.86 6.95 6.95 0 0 0 2.88-3.03c.6-1.28.86-2.86.86-4.9V3.7l3.15 3.15Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowDownFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16.8 11.27a.75.75 0 0 0-1.1-1.04l-4.95 5.24V2.75a.75.75 0 0 0-1.5 0v12.73l-4.96-5.25a.75.75 0 0 0-1.09 1.04l6.07 6.41a1 1 0 0 0 1.45 0l6.07-6.41Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowDownRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16.87 10.84a.5.5 0 1 0-.74-.68l-5.63 6.17V2.5a.5.5 0 0 0-1 0v13.83l-5.63-6.17a.5.5 0 0 0-.74.68l6.31 6.91a.75.75 0 0 0 1.11 0l6.32-6.91Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowDownLeftFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M12 16.25c0 .41-.34.75-.75.75h-7.5a.75.75 0 0 1-.75-.75v-7.5a.75.75 0 1 1 1.5 0v5.69L15.72 3.22a.75.75 0 1 1 1.06 1.06L5.56 15.5h5.7c.4 0 .74.34.74.75Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowDownLeftRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M11.5 16a.5.5 0 0 1 0 1h-8a.5.5 0 0 1-.5-.5v-8a.5.5 0 0 1 1 0v6.8L16.15 3.14a.5.5 0 1 1 .7.7L4.71 16h6.79Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowDownloadRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M15.5 17a.5.5 0 0 1 .09 1H4.5a.5.5 0 0 1-.09-1H15.5ZM10 2a.5.5 0 0 1 .5.41V14.3l3.64-3.65a.5.5 0 0 1 .64-.06l.07.06c.17.17.2.44.06.63l-.06.07-4.5 4.5a.5.5 0 0 1-.25.14L10 16a.5.5 0 0 1-.4-.2l-4.46-4.45a.5.5 0 0 1 .64-.76l.07.06 3.65 3.64V2.5c0-.27.22-.5.5-.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowEjectFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M11.2 4.6c-.6-.8-1.8-.8-2.4 0l-4.5 6A1.5 1.5 0 0 0 5.5 13h9a1.5 1.5 0 0 0 1.2-2.4l-4.5-6ZM4 15a.5.5 0 0 0 0 1h12a.5.5 0 0 0 0-1H4Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowEjectRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9.6 5.2a.5.5 0 0 1 .8 0l4.5 6a.5.5 0 0 1-.4.8h-9a.5.5 0 0 1-.4-.8l4.5-6Zm1.6-.6c-.6-.8-1.8-.8-2.4 0l-4.5 6A1.5 1.5 0 0 0 5.5 13h9a1.5 1.5 0 0 0 1.2-2.4l-4.5-6ZM4 15a.5.5 0 0 0 0 1h12a.5.5 0 0 0 0-1H4Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowEnterLeftFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="m4.64 12.5 2.87 2.7a.75.75 0 0 1-1.02 1.1l-4.25-4a.75.75 0 0 1 0-1.1l4.25-4A.75.75 0 1 1 7.5 8.3L4.64 11h10.11c.97 0 1.75-.78 1.75-1.75v-4.5a.75.75 0 0 1 1.5 0v4.5c0 1.8-1.46 3.25-3.25 3.25H4.65Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowEnterLeftRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="m3.76 12 3.33 3.14a.5.5 0 0 1-.68.72l-4.25-4a.5.5 0 0 1 0-.72l4.25-4a.5.5 0 1 1 .68.72L3.76 11H15a2 2 0 0 0 2-2V4.5a.5.5 0 0 1 1 0V9a3 3 0 0 1-3 3H3.76Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowEnterUpFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M8.8 2.24a.75.75 0 0 0-1.1 0l-4 4.25A.75.75 0 1 0 4.8 7.5l2.7-2.87v10.11c0 1.8 1.46 3.25 3.25 3.25h4.5a.75.75 0 0 0 0-1.5h-4.5c-.97 0-1.75-.78-1.75-1.75V4.65l2.7 2.86a.75.75 0 1 0 1.1-1.02l-4-4.25Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowEnterUpRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M8.86 2.16a.5.5 0 0 0-.72 0l-4 4.25a.5.5 0 0 0 .72.68L8 3.76V15a3 3 0 0 0 3 3h4.5a.5.5 0 0 0 0-1H11a2 2 0 0 1-2-2V3.76l3.14 3.33a.5.5 0 0 0 .72-.68l-4-4.25Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowExportLtrRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M2.5 4c.28 0 .5.22.5.5v11a.5.5 0 0 1-1 0v-11c0-.28.22-.5.5-.5ZM5 10c0-.28.22-.5.5-.5h10.8l-3.15-3.15a.5.5 0 0 1 .7-.7l4 4a.5.5 0 0 1 0 .7l-4 4a.5.5 0 0 1-.7-.7l3.14-3.15H5.5A.5.5 0 0 1 5 10Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowExportRtlRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M17.5 4a.5.5 0 0 0-.5.5v11a.5.5 0 0 0 1 0v-11a.5.5 0 0 0-.5-.5ZM15 10a.5.5 0 0 0-.5-.5H3.7l3.15-3.15a.5.5 0 0 0-.7-.7l-4 4a.5.5 0 0 0 0 .7l4 4a.5.5 0 0 0 .7-.7L3.71 10.5H14.5a.5.5 0 0 0 .5-.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowExportUpFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10.53 1.72a.75.75 0 0 0-1.06 0l-4 4a.75.75 0 0 0 1.06 1.06l2.72-2.72v10.19a.75.75 0 0 0 1.5 0V4.06l2.72 2.72a.75.75 0 1 0 1.06-1.06l-4-4ZM4.5 16.5a.75.75 0 0 0 0 1.5h11a.75.75 0 0 0 0-1.5h-11Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowExportUpRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9.65 2.15c.2-.2.5-.2.7 0l4 4a.5.5 0 0 1-.7.7L10.5 3.71V14.5a.5.5 0 0 1-1 0V3.7L6.35 6.86a.5.5 0 1 1-.7-.7l4-4ZM4 17.5c0-.28.22-.5.5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowForwardFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="m15.69 9.5-2.96 2.96a.75.75 0 0 0 .97 1.14l.09-.08 4.24-4.24a.75.75 0 0 0 .07-.98l-.07-.08-4.24-4.24a.75.75 0 0 0-1.14.97l.08.09L15.69 8H10a7.75 7.75 0 0 0-7.75 7.5v.25a.75.75 0 0 0 1.5 0A6.25 6.25 0 0 1 9.77 9.5H15.7Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowForwardRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="m16.3 9-3.4 3.39a.5.5 0 0 0 .64.76l.07-.05 4.24-4.25a.5.5 0 0 0 .06-.63l-.06-.07-4.24-4.25a.5.5 0 0 0-.76.64l.05.07L16.3 8H10a7.5 7.5 0 0 0-7.5 7.26v.24a.5.5 0 0 0 1 0A6.5 6.5 0 0 1 9.77 9h6.53Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowHookDownLeftRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 4.5c0-.28.22-.5.5-.5H11c1.64 0 2.9.62 3.75 1.57C15.59 6.52 16 7.77 16 9s-.41 2.48-1.25 3.43A4.85 4.85 0 0 1 11 14H5.7l2.65 2.65a.5.5 0 0 1-.7.7l-3.5-3.5a.5.5 0 0 1 0-.7l3.5-3.5a.5.5 0 1 1 .7.7L5.71 13H11c1.36 0 2.35-.5 3-1.24.66-.74 1-1.74 1-2.76 0-1.02-.34-2.02-1-2.76A3.86 3.86 0 0 0 11 5H6.5a.5.5 0 0 1-.5-.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowHookDownRightFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9 14c.06 0-.06 0 0 0h4.65l-2.27 2.27a.75.75 0 1 0 1.06 1.06l3.35-3.35a.75.75 0 0 0 .21-.64.75.75 0 0 0-.21-.45l-3.25-3.24a.75.75 0 1 0-1.06 1.06l1.8 1.79H9a3.5 3.5 0 1 1 0-7h4.25a.75.75 0 0 0 0-1.5H9a5 5 0 0 0 0 10Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowHookDownRightRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 9a5 5 0 0 1 5-5h4.5a.5.5 0 0 1 0 1H9a4 4 0 1 0 0 8h5.3l-2.7-2.7a.5.5 0 1 1 .7-.7l3.54 3.53a.5.5 0 0 1 .13.5.5.5 0 0 1-.14.25L12.3 17.4a.5.5 0 0 1-.71-.7l2.7-2.71H9a5 5 0 0 1-5-5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowHookUpRightFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9 6c.06 0-.06 0 0 0h4.65l-2.27-2.27a.75.75 0 1 1 1.06-1.06l3.35 3.35c.17.18.24.42.21.64a.75.75 0 0 1-.21.45l-3.25 3.24a.75.75 0 1 1-1.06-1.06l1.8-1.79H9a3.5 3.5 0 1 0 0 7h4.25a.75.75 0 0 1 0 1.5H9A5 5 0 0 1 9 6Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowHookUpRightRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 11a5 5 0 0 0 5 5h4.5a.5.5 0 0 0 0-1H9a4 4 0 0 1 0-8h5.3l-2.7 2.7a.5.5 0 1 0 .7.7l3.54-3.53a.5.5 0 0 0 .13-.5.5.5 0 0 0-.14-.25L12.3 2.6a.5.5 0 1 0-.71.7L14.29 6H9a5 5 0 0 0-5 5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowImportRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M17.5 4c.28 0 .5.22.5.5v11a.5.5 0 0 1-1 0v-11c0-.28.22-.5.5-.5ZM2 10c0-.28.22-.5.5-.5h10.8l-3.15-3.15a.5.5 0 0 1 .7-.7l4 4A.5.5 0 0 1 15 10a.5.5 0 0 1-.15.35l-4 4a.5.5 0 0 1-.7-.7l3.14-3.15H2.5A.5.5 0 0 1 2 10Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowLeftFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M8.73 16.8a.75.75 0 0 0 1.03-1.1l-5.24-4.95h12.73a.75.75 0 0 0 0-1.5H4.52l5.24-4.96A.75.75 0 1 0 8.73 3.2L2.31 9.27a1 1 0 0 0 0 1.46l6.42 6.07Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowLeftRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9.16 16.37a.5.5 0 1 0 .67-.74L3.67 10H17.5a.5.5 0 0 0 0-1H3.67l6.16-5.63a.5.5 0 0 0-.67-.74L2.24 8.94a.75.75 0 0 0 0 1.11l6.92 6.32Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowMaximizeFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16 3a1 1 0 0 1 1 1v5.25a.75.75 0 0 1-1.5 0v-3.7L5.56 15.5h3.69a.75.75 0 0 1 0 1.5H4a1 1 0 0 1-1-1v-5.25a.75.75 0 0 1 1.5 0v3.69l9.94-9.94h-3.69a.75.75 0 0 1 0-1.5H16Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowMaximizeVerticalFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9.58 1.33a.6.6 0 0 1 .84 0l2.13 2.13a.6.6 0 0 1-.85.84l-1.1-1.1v4.3a.6.6 0 1 1-1.2 0V3.2L8.3 4.3a.6.6 0 0 1-.85-.84l2.13-2.13ZM3.9 10c0-.33.27-.6.6-.6h11a.6.6 0 1 1 0 1.2h-11a.6.6 0 0 1-.6-.6Zm6.7 6.8v-4.3a.6.6 0 0 0-1.2 0v4.3l-1.1-1.1a.6.6 0 0 0-.85.85l2.13 2.12a.6.6 0 0 0 .84 0l2.13-2.12a.6.6 0 1 0-.85-.85l-1.1 1.1Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowMaximizeVerticalRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9.65 1.4c.2-.2.5-.2.7 0l2.12 2.13a.5.5 0 0 1-.7.7L10.5 2.96V7.5a.5.5 0 0 1-1 0V2.96L8.23 4.23a.5.5 0 1 1-.7-.7L9.65 1.4ZM4 10c0-.28.22-.5.5-.5h11a.5.5 0 0 1 0 1h-11A.5.5 0 0 1 4 10Zm6.5 7.04V12.5a.5.5 0 0 0-1 0v4.54l-1.27-1.27a.5.5 0 1 0-.7.7l2.12 2.13c.2.2.5.2.7 0l2.12-2.12a.5.5 0 0 0-.7-.71l-1.27 1.27Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowNextRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M13.5 5a.5.5 0 0 1 .5.41v9.09a.5.5 0 0 1-1 .09V5.5c0-.28.22-.5.5-.5Zm-7.85.15a.5.5 0 0 1 .63-.06l.07.06 4.5 4.5c.18.17.2.44.06.63l-.06.07-4.5 4.5a.5.5 0 0 1-.76-.63l.06-.07L9.79 10 5.65 5.85a.5.5 0 0 1 0-.7Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowOutlineUpRightFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16.33 2c.96-.1 1.77.71 1.66 1.67l-1.08 9.7a1.5 1.5 0 0 1-2.55.9L13.3 13.2l-4.36 4.36a1.5 1.5 0 0 1-2.12 0l-4.37-4.37a1.5 1.5 0 0 1 0-2.12L6.8 6.7 5.74 5.64a1.5 1.5 0 0 1 .89-2.55L16.33 2Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowPreviousFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 4.75c-.38 0-.7.28-.74.65l-.01.1v9a.75.75 0 0 0 1.5.1V5.5A.75.75 0 0 0 6 4.75Zm8.28.22a.75.75 0 0 0-.98-.07l-.08.07-4.5 4.5a.75.75 0 0 0-.07.98l.07.08 4.5 4.5a.75.75 0 0 0 1.13-.98l-.07-.08L10.31 10l3.97-3.97c.3-.3.3-.77 0-1.06Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowPreviousRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 5a.5.5 0 0 0-.5.41v9.09a.5.5 0 0 0 1 .09V5.5A.5.5 0 0 0 6 5Zm7.85.15a.5.5 0 0 0-.63-.06l-.07.06-4.5 4.5a.5.5 0 0 0-.06.63l.06.07 4.5 4.5a.5.5 0 0 0 .76-.63l-.06-.07L9.71 10l4.14-4.15a.5.5 0 0 0 0-.7Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowRedoFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M13.14 6.5h-2.39a.75.75 0 1 0 0 1.5h4.4c.47 0 .85-.38.85-.85v-4.4a.75.75 0 0 0-1.5 0V5.7l-3.06-2.66a5.25 5.25 0 0 0-6.88 7.92l8.17 7.1a.75.75 0 1 0 .98-1.13l-8.17-7.1a3.75 3.75 0 1 1 4.92-5.66l2.68 2.33Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowRedoRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M15 2.5a.5.5 0 0 1 1 0v4.9a.6.6 0 0 1-.6.6h-4.9a.5.5 0 0 1 0-1h3.6l-3.48-3.02a4 4 0 1 0-5.24 6.04l8.17 7.1a.5.5 0 1 1-.66.76l-8.17-7.1a5 5 0 1 1 6.56-7.55L15 6.46V2.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowReplyRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="m3.7 9 3.4 3.39a.5.5 0 0 1-.64.76l-.07-.05-4.24-4.25a.5.5 0 0 1-.06-.63l.06-.07L6.39 3.9a.5.5 0 0 1 .76.64l-.05.07L3.7 8H10a7.5 7.5 0 0 1 7.5 7.26v.24a.5.5 0 0 1-1 0A6.5 6.5 0 0 0 10.23 9H3.7l3.4 3.39L3.7 9Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowReplyDownRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="m3.7 11 3.4-3.4a.5.5 0 0 0-.64-.76l-.07.06-4.24 4.24a.5.5 0 0 0-.06.64l.06.07 4.24 4.24a.5.5 0 0 0 .76-.63l-.05-.07-3.4-3.4H10a7.5 7.5 0 0 0 7.5-7.25V4.5a.5.5 0 0 0-1 0 6.5 6.5 0 0 1-6.27 6.5H3.7l3.4-3.4L3.7 11Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowResetFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6.03 2.47c.3.3.3.77 0 1.06L4.81 4.75H11A6.25 6.25 0 1 1 4.75 11a.75.75 0 0 1 1.5 0A4.75 4.75 0 1 0 11 6.25H4.81l1.22 1.22a.75.75 0 0 1-1.06 1.06l-2.5-2.5a.75.75 0 0 1 0-1.06l2.5-2.5c.3-.3.77-.3 1.06 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowResetRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M5.85 2.65c.2.2.2.5 0 .7L4.21 5H11a6 6 0 1 1-6 6 .5.5 0 0 1 1 0 5 5 0 1 0 5-5H4.2l1.65 1.65a.5.5 0 1 1-.7.7l-2.5-2.5a.5.5 0 0 1 0-.7l2.5-2.5c.2-.2.5-.2.7 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowRightFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M11.27 3.2a.75.75 0 0 0-1.04 1.1l5.24 4.95H2.75a.75.75 0 0 0 0 1.5h12.73l-5.25 4.96a.75.75 0 1 0 1.04 1.09l6.41-6.07a1 1 0 0 0 0-1.46l-6.41-6.06Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowRightRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10.84 2.63a.5.5 0 0 0-.68.74L16.33 9H2.5a.5.5 0 0 0 0 1h13.83l-6.17 5.63a.5.5 0 0 0 .68.74l6.91-6.32a.75.75 0 0 0 0-1.1l-6.91-6.32Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowRotateClockwiseRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3 10a7 7 0 1 1 10 6.33V14.5a.5.5 0 0 0-1 0v3c0 .28.22.5.5.5h3a.5.5 0 0 0 0-1h-1.62A8 8 0 1 0 2 10a.5.5 0 0 0 1 0Zm7 2a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm0-1a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowRotateCounterclockwiseRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M17 10a7 7 0 1 0-10 6.33V14.5a.5.5 0 0 1 1 0v3a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1 0-1h1.62A8 8 0 1 1 18 10a.5.5 0 0 1-1 0Zm-7 2a2 2 0 1 1 0-4 2 2 0 0 1 0 4Zm0-1a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowSortDownFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9.75 17c.23 0 .45-.1.59-.28l2.94-2.94a.75.75 0 0 0-1.06-1.06l-1.72 1.71V3.75a.75.75 0 0 0-1.5 0v10.7L7.28 12.7a.75.75 0 1 0-1.06 1.06l3 3.01c.15.15.34.22.53.22Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowSortDownRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="m10 15.29 2.65-2.64a.5.5 0 0 1 .7.7L9.9 16.82a.5.5 0 0 1-.74.03h-.01l-3.5-3.5a.5.5 0 1 1 .71-.7L9 15.29V3.5a.5.5 0 0 1 1 0v11.79Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowSortDownLinesRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="m7.2 15.29 2.65-2.64a.5.5 0 0 1 .71.7L7.1 16.82a.5.5 0 0 1-.74.03l-3.5-3.5a.5.5 0 1 1 .71-.7l2.65 2.64V3.5a.5.5 0 0 1 1 0v11.79ZM9.5 4a.5.5 0 0 0 0 1h7a.5.5 0 1 0 0-1h-7Zm0 3a.5.5 0 0 0 0 1h5a.5.5 0 1 0 0-1h-5Zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 1 0 0-1h-2Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowSortUpFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9.75 3c.23 0 .45.1.59.28l2.94 2.94a.75.75 0 0 1-1.06 1.06L10.5 5.57v10.68a.75.75 0 0 1-1.5 0V5.55L7.28 7.3a.75.75 0 1 1-1.06-1.06l3-3.01A.73.73 0 0 1 9.75 3Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowSortUpRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9 4.71 6.35 7.35a.5.5 0 1 1-.7-.7L9.1 3.18a.5.5 0 0 1 .74-.03h.01l3.5 3.5a.5.5 0 1 1-.71.7L10 4.71V16.5a.5.5 0 0 1-1 0V4.71Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowSquareDownFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M5 3a2 2 0 0 0-2 2v10c0 1.1.9 2 2 2h10a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5Zm5.5 3.5v5.8l2.65-2.65a.5.5 0 0 1 .7.7l-3.5 3.5a.5.5 0 0 1-.7 0l-3.5-3.5a.5.5 0 0 1 .7-.7l2.65 2.64V6.5a.5.5 0 0 1 1 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowStepBackFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M7.85 3.15c.2.2.2.5 0 .7L4.71 7H10a8 8 0 0 1 6.94 4.04.5.5 0 1 1-.88.5A7 7 0 0 0 10 8H4.7l3.15 3.15a.5.5 0 0 1-.7.7L3.15 7.87a.5.5 0 0 1-.01-.72l4-4c.19-.2.5-.2.7 0ZM12 15a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowStepBackRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M7.85 3.15c.2.2.2.5 0 .7L4.71 7H10a8 8 0 0 1 6.94 4.04.5.5 0 1 1-.88.5A7 7 0 0 0 10 8H4.7l3.15 3.15a.5.5 0 0 1-.7.7L3.15 7.87a.5.5 0 0 1-.01-.72l4-4c.19-.2.5-.2.7 0ZM8 15a2 2 0 1 1 4 0 2 2 0 0 1-4 0Zm2-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowStepInFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M12 16a2 2 0 1 1-4 0 2 2 0 0 1 4 0ZM10 2c.28 0 .5.22.5.5v7.8l3.15-3.15a.5.5 0 0 1 .7.7l-4 4a.5.5 0 0 1-.7 0l-4-4a.5.5 0 1 1 .7-.7l3.15 3.14V2.5c0-.28.22-.5.5-.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowStepInRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10 15a1 1 0 1 0 0 2 1 1 0 0 0 0-2Zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0Zm2-14c.28 0 .5.22.5.5v7.8l3.15-3.15a.5.5 0 0 1 .7.7l-4 4a.5.5 0 0 1-.7 0l-4-4a.5.5 0 1 1 .7-.7l3.15 3.14V2.5c0-.28.22-.5.5-.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowStepInLeftFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 12a2 2 0 1 1 0-4 2 2 0 0 1 0 4Zm14-2a.5.5 0 0 1-.5.5H9.7l3.15 3.15a.5.5 0 0 1-.7.7l-4-4a.5.5 0 0 1 0-.7l4-4a.5.5 0 0 1 .7.7L9.71 9.5h7.79c.28 0 .5.22.5.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowStepInLeftRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M5 10a1 1 0 1 0-2 0 1 1 0 0 0 2 0ZM4 8a2 2 0 1 1 0 4 2 2 0 0 1 0-4Zm14 2a.5.5 0 0 1-.5.5H9.7l3.15 3.15a.5.5 0 0 1-.7.7l-4-4a.5.5 0 0 1 0-.7l4-4a.5.5 0 0 1 .7.7L9.71 9.5h7.79c.28 0 .5.22.5.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowStepInRightFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16 8a2 2 0 1 1 0 4 2 2 0 0 1 0-4ZM2 10c0-.28.22-.5.5-.5h7.8L7.14 6.35a.5.5 0 1 1 .7-.7l4 4c.2.2.2.5 0 .7l-4 4a.5.5 0 0 1-.7-.7l3.14-3.15H2.5A.5.5 0 0 1 2 10Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowStepInRightRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M15 10a1 1 0 1 0 2 0 1 1 0 0 0-2 0Zm1 2a2 2 0 1 1 0-4 2 2 0 0 1 0 4ZM2 10c0-.28.22-.5.5-.5h7.8L7.14 6.35a.5.5 0 1 1 .7-.7l4 4c.2.2.2.5 0 .7l-4 4a.5.5 0 0 1-.7-.7l3.14-3.15H2.5A.5.5 0 0 1 2 10Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowStepOutFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M12 16a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm-2-4a.5.5 0 0 0 .5-.5V3.7l3.15 3.15a.5.5 0 0 0 .7-.7l-4-4a.5.5 0 0 0-.7 0l-4 4a.5.5 0 1 0 .7.7L9.5 3.71v7.79c0 .28.22.5.5.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowStepOutRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10 15a1 1 0 1 0 0 2 1 1 0 0 0 0-2Zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0Zm2-4a.5.5 0 0 0 .5-.5V3.7l3.15 3.15a.5.5 0 0 0 .7-.7l-4-4a.5.5 0 0 0-.7 0l-4 4a.5.5 0 1 0 .7.7L9.5 3.71v7.79c0 .28.22.5.5.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowStepOverFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M12.15 3.15a.5.5 0 0 0 0 .7L15.29 7H10a8 8 0 0 0-6.94 4.04.5.5 0 1 0 .88.5A7 7 0 0 1 10 8h5.3l-3.15 3.15a.5.5 0 1 0 .7.7l3.99-3.98a.5.5 0 0 0 .01-.72l-4-4a.5.5 0 0 0-.7 0ZM8 15a2 2 0 1 0 4 0 2 2 0 0 0-4 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowSwapRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M12.15 3.15c.2-.2.5-.2.7 0l3 3c.2.2.2.5 0 .7l-3 3a.5.5 0 0 1-.7-.7L14.29 7H4.5a.5.5 0 0 1 0-1h9.8l-2.15-2.15a.5.5 0 0 1 0-.7Zm-4.3 7c.2.2.2.5 0 .7L5.71 13h9.79a.5.5 0 0 1 0 1H5.7l2.15 2.15a.5.5 0 0 1-.7.7l-3-3a.5.5 0 0 1 0-.7l3-3c.2-.2.5-.2.7 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTrendingRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M17.96 5.3a.5.5 0 0 0-.46-.3h-6a.5.5 0 0 0 0 1h4.8l-5.8 5.8-2.15-2.15a.5.5 0 0 0-.7 0l-5.5 5.5a.5.5 0 0 0 .7.7L8 10.71l2.15 2.14c.2.2.5.2.7 0L17 6.71v4.79a.5.5 0 0 0 1 0v-6a.5.5 0 0 0-.04-.2Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTrendingDownRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M17.96 14.7a.5.5 0 0 1-.46.3h-6a.5.5 0 0 1 0-1h4.8l-5.8-5.8-2.15 2.15a.5.5 0 0 1-.7 0l-5.5-5.5a.5.5 0 1 1 .7-.7L8 9.29l2.15-2.14c.2-.2.5-.2.7 0L17 13.29V8.5a.5.5 0 0 1 1 0v6a.5.5 0 0 1-.04.2Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnBidirectionalDownRightRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M13.85 2.15a.5.5 0 0 0-.7.7L16.29 6H9a3 3 0 0 0-3 3v7.3l-3.15-3.15a.5.5 0 0 0-.7.7l4 4c.2.2.5.2.7 0l4-4a.5.5 0 0 0-.7-.7L7 16.29V9c0-1.1.9-2 2-2h7.3l-3.15 3.15a.5.5 0 0 0 .7.7l4-4a.5.5 0 0 0 0-.7l-4-4Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnDownLeftFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9.28 16.78c-.3.3-.77.3-1.06 0l-4-4a.75.75 0 0 1 0-1.06l4-4a.75.75 0 0 1 1.06 1.06L6.56 11.5H13c.83 0 1.5-.67 1.5-1.5V3.75a.75.75 0 0 1 1.5 0V10a3 3 0 0 1-3 3H6.56l2.72 2.72c.3.3.3.77 0 1.06Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnDownLeftRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M8.85 16.85a.5.5 0 0 1-.7 0l-4-4a.5.5 0 0 1 0-.7l4-4a.5.5 0 1 1 .7.7L5.71 12H12a2 2 0 0 0 2-2V3.5a.5.5 0 0 1 1 0V10a3 3 0 0 1-3 3H5.7l3.15 3.15c.2.2.2.5 0 .7Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnDownRightFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10.72 16.78c.3.3.77.3 1.06 0l4-4c.3-.3.3-.77 0-1.06l-4-4a.75.75 0 1 0-1.06 1.06l2.72 2.72H7A1.5 1.5 0 0 1 5.5 10V3.75a.75.75 0 0 0-1.5 0V10a3 3 0 0 0 3 3h6.44l-2.72 2.72c-.3.3-.3.77 0 1.06Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnDownRightRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M11.15 16.85c.2.2.5.2.7 0l4-4a.5.5 0 0 0 0-.7l-4-4a.5.5 0 0 0-.7.7L14.29 12H8a2 2 0 0 1-2-2V3.5a.5.5 0 0 0-1 0V10a3 3 0 0 0 3 3h6.3l-3.15 3.15a.5.5 0 0 0 0 .7Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnDownUpFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16.45 3.47a.75.75 0 0 0-1.03-.4l-5 2.5a.75.75 0 1 0 .67 1.35l3.24-1.62L10 15.12 5.44 4.45a.75.75 0 0 0-1.38.6l4.8 11.19c.43 1 1.85 1 2.29 0l4.6-10.46 1.3 3.25a.75.75 0 1 0 1.4-.56l-2-5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnDownUpRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M15.57 3a.5.5 0 0 1 .4.31l2 5a.5.5 0 1 1-.93.38L15.5 4.85l-4.59 11.52a1 1 0 0 1-1.85.03L4.04 4.7a.5.5 0 0 1 .92-.4L9.98 16l4.57-11.47-3.83 1.92a.5.5 0 1 1-.44-.9l4.98-2.49a.5.5 0 0 1 .3-.06Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnLeftDownFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3.22 10.72c-.3.3-.3.77 0 1.06l4 4c.3.3.77.3 1.06 0l4-4a.75.75 0 1 0-1.06-1.06L8.5 13.44V7c0-.83.67-1.5 1.5-1.5h6.25a.75.75 0 0 0 0-1.5H10a3 3 0 0 0-3 3v6.44l-2.72-2.72a.75.75 0 0 0-1.06 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnLeftDownRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3.15 11.15a.5.5 0 0 0 0 .7l4 4c.2.2.5.2.7 0l4-4a.5.5 0 0 0-.7-.7L8 14.29V8c0-1.1.9-2 2-2h6.5a.5.5 0 0 0 0-1H10a3 3 0 0 0-3 3v6.3l-3.15-3.15a.5.5 0 0 0-.7 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnLeftRightFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M15.53 15.45a.75.75 0 0 0 .4-1.03l-2.5-5a.75.75 0 1 0-1.35.67l1.62 3.24L3.88 9l10.67-4.57a.75.75 0 1 0-.6-1.38L2.77 7.86a1.25 1.25 0 0 0 0 2.29l10.46 4.6-3.25 1.3a.75.75 0 1 0 .56 1.4l5-2Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnLeftRightRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16 14.57a.5.5 0 0 1-.31.4l-5 2a.5.5 0 0 1-.38-.93l3.84-1.54L2.63 9.91a1 1 0 0 1-.03-1.85l11.7-5.02a.5.5 0 0 1 .4.92L3 8.98l11.47 4.57-1.92-3.83a.5.5 0 0 1 .9-.44l2.49 4.98c.05.1.07.2.06.3Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnLeftUpFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3.22 9.28a.75.75 0 0 1 0-1.06l4-4c.3-.3.77-.3 1.06 0l4 4a.75.75 0 0 1-1.06 1.06L8.5 6.56V13c0 .83.67 1.5 1.5 1.5h6.25a.75.75 0 0 1 0 1.5H10a3 3 0 0 1-3-3V6.56L4.28 9.28c-.3.3-.77.3-1.06 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnLeftUpRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3.15 8.85a.5.5 0 0 1 0-.7l4-4c.2-.2.5-.2.7 0l4 4a.5.5 0 0 1-.7.7L8 5.71V12c0 1.1.9 2 2 2h6.5a.5.5 0 0 1 0 1H10a3 3 0 0 1-3-3V5.7L3.85 8.86a.5.5 0 0 1-.7 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnRightFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10.72 3.22c.3-.3.77-.3 1.06 0l4 4c.3.3.3.77 0 1.06l-4 4a.75.75 0 1 1-1.06-1.06l2.72-2.72H7c-.83 0-1.5.67-1.5 1.5v6.25a.75.75 0 0 1-1.5 0V10a3 3 0 0 1 3-3h6.44l-2.72-2.72a.75.75 0 0 1 0-1.06Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnRightRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M11.15 3.15c.2-.2.5-.2.7 0l4 4c.2.2.2.5 0 .7l-4 4a.5.5 0 0 1-.7-.7L14.29 8H8a2 2 0 0 0-2 2v6.5a.5.5 0 0 1-1 0V10a3 3 0 0 1 3-3h6.3l-3.15-3.15a.5.5 0 0 1 0-.7Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnRightDownFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16.78 10.72c.3.3.3.77 0 1.06l-4 4c-.3.3-.77.3-1.06 0l-4-4a.75.75 0 1 1 1.06-1.06l2.72 2.72V7c0-.83-.67-1.5-1.5-1.5H3.75a.75.75 0 0 1 0-1.5H10a3 3 0 0 1 3 3v6.44l2.72-2.72c.3-.3.77-.3 1.06 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnRightDownRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16.85 11.15c.2.2.2.5 0 .7l-4 4a.5.5 0 0 1-.7 0l-4-4a.5.5 0 0 1 .7-.7L12 14.29V8a2 2 0 0 0-2-2H3.5a.5.5 0 0 1 0-1H10a3 3 0 0 1 3 3v6.3l3.15-3.15c.2-.2.5-.2.7 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnRightLeftFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4.47 15.45a.75.75 0 0 1-.4-1.03l2.5-5a.75.75 0 1 1 1.35.67L6.3 13.33 16.12 9 5.45 4.44a.75.75 0 0 1 .6-1.38l11.19 4.8c1 .43 1 1.85 0 2.29l-10.46 4.6 3.25 1.3a.75.75 0 1 1-.56 1.4l-5-2Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnRightLeftRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 14.57a.5.5 0 0 0 .31.4l5 2a.5.5 0 1 0 .38-.93L5.85 14.5l11.52-4.59a1 1 0 0 0 .03-1.85L5.7 3.04a.5.5 0 0 0-.4.92L17 8.98 5.53 13.55l1.92-3.83a.5.5 0 1 0-.9-.44l-2.49 4.98a.5.5 0 0 0-.06.3Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnRightUpFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16.78 9.28c.3-.3.3-.77 0-1.06l-4-4a.75.75 0 0 0-1.06 0l-4 4a.75.75 0 0 0 1.06 1.06l2.72-2.72V13c0 .83-.67 1.5-1.5 1.5H3.75a.75.75 0 0 0 0 1.5H10a3 3 0 0 0 3-3V6.56l2.72 2.72c.3.3.77.3 1.06 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnRightUpRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16.85 8.85a.5.5 0 0 0 0-.7l-4-4a.5.5 0 0 0-.7 0l-4 4a.5.5 0 1 0 .7.7L12 5.71V12a2 2 0 0 1-2 2H3.5a.5.5 0 0 0 0 1H10a3 3 0 0 0 3-3V5.7l3.15 3.15c.2.2.5.2.7 0Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnUpDownFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16.45 16.53a.75.75 0 0 1-1.03.4l-5-2.5a.75.75 0 1 1 .67-1.35l3.24 1.62L10 4.88 5.44 15.55a.75.75 0 1 1-1.38-.6l4.8-11.19c.43-1 1.85-1 2.29 0l4.6 10.46 1.3-3.25a.75.75 0 0 1 1.4.56l-2 5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnUpDownRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M15.57 17a.5.5 0 0 0 .4-.31l2-5a.5.5 0 0 0-.93-.38l-1.54 3.84-4.59-11.52a1 1 0 0 0-1.85-.03L4.04 15.3a.5.5 0 1 0 .92.4L9.98 4l4.57 11.47-3.83-1.92a.5.5 0 1 0-.44.9l4.98 2.49c.1.05.2.07.3.06Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnUpLeftFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9.28 3.22a.75.75 0 0 0-1.06 0l-4 4c-.3.3-.3.77 0 1.06l4 4a.75.75 0 0 0 1.06-1.06L6.56 8.5H13c.83 0 1.5.67 1.5 1.5v6.25a.75.75 0 0 0 1.5 0V10a3 3 0 0 0-3-3H6.56l2.72-2.72c.3-.3.3-.77 0-1.06Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowTurnUpLeftRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M8.85 3.15a.5.5 0 0 0-.7 0l-4 4a.5.5 0 0 0 0 .7l4 4a.5.5 0 0 0 .7-.7L5.71 8H12a2 2 0 0 1 2 2v6.5a.5.5 0 0 0 1 0V10a3 3 0 0 0-3-3H5.7l3.15-3.15a.5.5 0 0 0 0-.7Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowUndoFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6.86 6.5h2.39a.75.75 0 0 1 0 1.5h-4.4A.85.85 0 0 1 4 7.15v-4.4a.75.75 0 0 1 1.5 0V5.7l3.06-2.66a5.25 5.25 0 0 1 6.89 7.92l-8.17 7.1a.75.75 0 1 1-.99-1.13l8.17-7.1a3.75 3.75 0 1 0-4.92-5.66L6.86 6.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowUndoRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M5 2.5a.5.5 0 0 0-1 0v4.9c0 .33.27.6.6.6h4.9a.5.5 0 0 0 0-1H5.9l3.48-3.02a4 4 0 0 1 5.25 6.04l-8.17 7.1a.5.5 0 0 0 .65.76l8.17-7.1a5 5 0 0 0-6.56-7.55L5 6.46V2.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowUpFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3.2 8.73a.75.75 0 0 0 1.1 1.04l4.95-5.24v12.72a.75.75 0 0 0 1.5 0V4.52l4.95 5.25a.75.75 0 0 0 1.1-1.04l-6.08-6.41a1 1 0 0 0-1.45 0L3.2 8.73Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowUpRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3.13 9.16a.5.5 0 1 0 .74.68L9.5 3.67V17.5a.5.5 0 1 0 1 0V3.67l5.63 6.17a.5.5 0 1 0 .74-.68l-6.32-6.92a.75.75 0 0 0-1.1 0L3.13 9.16Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowUpLeftFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M12 3.75a.75.75 0 0 0-.75-.75h-7.5a.75.75 0 0 0-.75.75v7.5a.75.75 0 0 0 1.5 0V5.56l11.22 11.22a.75.75 0 0 0 1.06-1.06L5.56 4.5h5.69c.41 0 .75-.34.75-.75Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowUpLeftRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M11.5 4a.5.5 0 0 0 0-1h-8a.5.5 0 0 0-.5.5v8a.5.5 0 0 0 1 0V4.7l12.15 12.15a.5.5 0 0 0 .7-.7L4.71 4h6.79Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowUpRightFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M8 3.75c0-.41.34-.75.75-.75h7.5c.41 0 .75.34.75.75v7.5a.75.75 0 1 1-1.5 0V5.56L4.28 16.78a.75.75 0 0 1-1.06-1.06L14.44 4.5h-5.7A.75.75 0 0 1 8 3.75Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowUpRightRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M8.5 4a.5.5 0 1 1 0-1h8c.28 0 .5.22.5.5v8a.5.5 0 0 1-1 0V4.7L3.85 16.86a.5.5 0 0 1-.7-.7L15.29 4H8.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowUploadRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M15 3a.5.5 0 0 0 .09-.99H4a.5.5 0 0 0-.09.98L4 3h11ZM9.5 18a.5.5 0 0 0 .5-.41V5.7l3.64 3.65c.17.18.44.2.64.06l.07-.06a.5.5 0 0 0 .06-.63l-.06-.07-4.5-4.5A.5.5 0 0 0 9.6 4h-.1a.5.5 0 0 0-.4.19L4.64 8.65a.5.5 0 0 0 .64.76l.07-.06L9 5.71V17.5c0 .28.22.5.5.5Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowWrapRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M14 4a3 3 0 1 1 0 6H6a2 2 0 1 0 0 4h10.3l-.65-.65a.5.5 0 0 1 .7-.7l1.5 1.5c.2.2.2.5 0 .7l-1.5 1.5a.5.5 0 0 1-.7-.7l.64-.65H6a3 3 0 1 1 0-6h8a2 2 0 1 0 0-4H3.5a.5.5 0 0 1 0-1H14Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowsBidirectionalFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6.68 5.03c.2.08.32.26.32.47V8h6V5.5a.5.5 0 0 1 .87-.33l4 4.5a.5.5 0 0 1 0 .66l-4 4.5a.5.5 0 0 1-.87-.33V12H7v2.5a.5.5 0 0 1-.87.33l-4-4.5a.5.5 0 0 1 0-.66l4-4.5a.5.5 0 0 1 .55-.14Z" fill={primaryFill} /></Svg>;;
}
...
const ArrowsBidirectionalRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6.68 5.03c.2.08.32.26.32.47V8h6V5.5a.5.5 0 0 1 .87-.33l4 4.5a.5.5 0 0 1 0 .66l-4 4.5a.5.5 0 0 1-.87-.33V12H7v2.5a.5.5 0 0 1-.87.33l-4-4.5a.5.5 0 0 1 0-.66l4-4.5a.5.5 0 0 1 .55-.14ZM3.17 10 6 13.18V11.5c0-.28.22-.5.5-.5h7c.28 0 .5.22.5.5v1.68L16.83 10 14 6.82V8.5a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5V6.82L3.17 10Z" fill={primaryFill} /></Svg>;;
}
...
const AttachFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="m5.28 10.6 5.3-5.3a2.75 2.75 0 1 1 3.9 3.9L8.1 15.55a1.25 1.25 0 1 1-1.77-1.77L12 8.13a.75.75 0 0 0-1.06-1.06l-5.66 5.66a2.75 2.75 0 0 0 3.89 3.89l6.36-6.36a4.25 4.25 0 0 0-6-6.02l-5.31 5.3a.75.75 0 0 0 1.06 1.07Z" fill={primaryFill} /></Svg>;;
}
...
const AttachRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="m4.83 10.48 5.65-5.65a3 3 0 0 1 4.25 4.24L8 15.8a1.5 1.5 0 0 1-2.12-2.12l6-6.01a.5.5 0 1 0-.7-.71l-6 6.01a2.5 2.5 0 0 0 3.53 3.54l6.71-6.72a4 4 0 1 0-5.65-5.66L4.12 9.78a.5.5 0 0 0 .7.7Z" fill={primaryFill} /></Svg>;;
}
...
const AttachTextRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6.5 4A2.5 2.5 0 0 0 4 6.5V14a.5.5 0 0 1-1 0V6.5a3.5 3.5 0 1 1 7 0V15a2 2 0 0 1-4 0V6.5a.5.5 0 0 1 1 0V15a1 1 0 1 0 2 0V6.5A2.5 2.5 0 0 0 6.5 4ZM12 5.5c0-.28.22-.5.5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5Zm.5 2.5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5Zm-.5 3.5c0-.28.22-.5.5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5Zm.5 2.5a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1h-3Z" fill={primaryFill} /></Svg>;;
}
...
const AutoFitHeightRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 2a.5.5 0 0 0 0 1h11a.5.5 0 0 0 0-1H4Zm0 15a.5.5 0 0 0 0 1h11a.5.5 0 0 0 0-1H4ZM9.15 5.15c.2-.2.5-.2.7 0l2 2a.5.5 0 0 1-.7.7L10 6.71v6.58l1.15-1.14a.5.5 0 0 1 .7.7l-2 2a.5.5 0 0 1-.7 0l-2-2a.5.5 0 0 1 .7-.7L9 13.29V6.71L7.85 7.85a.5.5 0 1 1-.7-.7l2-2Z" fill={primaryFill} /></Svg>;;
}
...
const AutocorrectRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9.14 5.48a1 1 0 0 1 1.72 0L12.98 9h-.48a3.75 3.75 0 1 0 2.3 1h2.7a.5.5 0 0 0 0-1h-3.35l-2.44-4.03a2 2 0 0 0-3.42 0L2.07 15.24a.5.5 0 0 0 .86.52L9.14 5.48ZM12.25 10a2.75 2.75 0 1 1 0 5.5 2.75 2.75 0 0 1 0-5.5Z" fill={primaryFill} /></Svg>;;
}
...
const AutosumFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3.81 3.7a.75.75 0 0 1 .69-.45h11a.75.75 0 0 1 0 1.5H6.26l4.15 4.3c.26.28.28.72.03 1l-4.34 5.2h9.4a.75.75 0 0 1 0 1.5h-11a.75.75 0 0 1-.58-1.23l4.94-5.9-4.9-5.1a.75.75 0 0 1-.15-.81Z" fill={primaryFill} /></Svg>;;
}
...
const AutosumRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4.04 3.8a.5.5 0 0 1 .46-.3h11a.5.5 0 1 1 0 1H5.67l4.56 4.73a.5.5 0 0 1 .02.67l-4.68 5.6h9.93a.5.5 0 1 1 0 1h-11a.5.5 0 0 1-.38-.82L9.2 9.6 4.14 4.35a.5.5 0 0 1-.1-.55Z" fill={primaryFill} /></Svg>;;
}
...
const BackspaceFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M8.28 4a2.5 2.5 0 0 0-1.7.66L2.8 8.16a2.5 2.5 0 0 0 0 3.68l3.79 3.5a2.5 2.5 0 0 0 1.7.66h7.21a2.5 2.5 0 0 0 2.5-2.5v-7A2.5 2.5 0 0 0 15.5 4H8.28Zm.87 3.15c.2-.2.5-.2.7 0L12 9.29l2.15-2.14a.5.5 0 0 1 .7.7L12.71 10l2.14 2.15a.5.5 0 0 1-.7.7L12 10.71l-2.15 2.14a.5.5 0 0 1-.7-.7L11.29 10 9.15 7.85a.5.5 0 0 1 0-.7Z" fill={primaryFill} /></Svg>;;
}
...
const BackspaceRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9.15 7.15c.2-.2.5-.2.7 0L12 9.29l2.15-2.14a.5.5 0 0 1 .7.7L12.71 10l2.14 2.15a.5.5 0 0 1-.7.7L12 10.71l-2.15 2.14a.5.5 0 0 1-.7-.7L11.29 10 9.15 7.85a.5.5 0 0 1 0-.7ZM6.59 4.66A2.5 2.5 0 0 1 8.29 4h7.21A2.5 2.5 0 0 1 18 6.5v7a2.5 2.5 0 0 1-2.5 2.5H8.28a2.5 2.5 0 0 1-1.7-.66l-3.78-3.5a2.5 2.5 0 0 1 0-3.68l3.79-3.5Zm1.7.34c-.38 0-.75.14-1.03.4L3.48 8.9a1.5 1.5 0 0 0 0 2.2l3.78 3.5c.28.26.65.4 1.02.4h7.22c.83 0 1.5-.67 1.5-1.5v-7c0-.83-.67-1.5-1.5-1.5H8.28Z" fill={primaryFill} /></Svg>;;
}
...
const BadgeFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16 6a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm0 1a3 3 0 0 0 1-.17V15a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5c0-1.1.9-2 2-2h8.17A3 3 0 0 0 16 7Z" fill={primaryFill} /></Svg>;;
}
...
const BadgeRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M16 6a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm1 9V6.83A3 3 0 0 1 16 7v8a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1h8a3 3 0 0 1 .17-1H5a2 2 0 0 0-2 2v10c0 1.1.9 2 2 2h10a2 2 0 0 0 2-2Z" fill={primaryFill} /></Svg>;;
}
...
const BarcodeScannerRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M2 5.5A2.5 2.5 0 0 1 4.5 3h1a.5.5 0 0 1 0 1h-1C3.67 4 3 4.67 3 5.5v1a.5.5 0 0 1-1 0v-1Zm12-2c0-.28.22-.5.5-.5h1A2.5 2.5 0 0 1 18 5.5v1a.5.5 0 0 1-1 0v-1c0-.83-.67-1.5-1.5-1.5h-1a.5.5 0 0 1-.5-.5ZM2.5 13c.28 0 .5.22.5.5v1c0 .83.67 1.5 1.5 1.5h1a.5.5 0 0 1 0 1h-1A2.5 2.5 0 0 1 2 14.5v-1c0-.28.22-.5.5-.5Zm15 0c.28 0 .5.22.5.5v1a2.5 2.5 0 0 1-2.5 2.5h-1a.5.5 0 0 1 0-1h1c.83 0 1.5-.67 1.5-1.5v-1c0-.28.22-.5.5-.5Zm-12-7c.28 0 .5.22.5.5v7a.5.5 0 0 1-1 0v-7c0-.28.22-.5.5-.5Zm3.5.5a.5.5 0 0 0-1 0v7a.5.5 0 0 0 1 0v-7Zm2.5-.5c.28 0 .5.22.5.5v7a.5.5 0 0 1-1 0v-7c0-.28.22-.5.5-.5Zm3.5.5a.5.5 0 0 0-1 0v7a.5.5 0 0 0 1 0v-7Z" fill={primaryFill} /></Svg>;;
}
...
const Battery0FilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M2 7.5A2.5 2.5 0 0 1 4.5 5h9A2.5 2.5 0 0 1 16 7.5v.83h1.17a.83.83 0 0 1 .83.84v1.67a.83.83 0 0 1-.83.83H16v.83a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 2 12.5v-5Z" fill={primaryFill} /></Svg>;;
}
...
const Battery10FilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4.83 6.95a.84.84 0 0 0-.83.83v4.33c0 .46.37.84.83.84h8.33c.47 0 .84-.38.84-.84V7.78a.84.84 0 0 0-.84-.83H4.83ZM2 7.5A2.5 2.5 0 0 1 4.5 5h9A2.5 2.5 0 0 1 16 7.5v.83h1.17a.83.83 0 0 1 .83.84v1.67a.83.83 0 0 1-.83.83H16v.83a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 2 12.5v-5Z" fill={primaryFill} /></Svg>;;
}
...
const Battery1FilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M13.5 5A2.5 2.5 0 0 1 16 7.5v.83h1.17a.83.83 0 0 1 .83.84v1.67a.83.83 0 0 1-.83.83H16v.83a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 2 12.5v-5A2.5 2.5 0 0 1 4.5 5h9Zm-9 1.95a.5.5 0 0 0-.5.5v5a.5.5 0 1 0 1 0v-5a.5.5 0 0 0-.5-.5Z" fill={primaryFill} /></Svg>;;
}
...
const Battery2FilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4.83 6.95a.84.84 0 0 0-.83.83v4.33c0 .46.37.84.83.84h.33c.47 0 .84-.38.84-.84V7.78a.84.84 0 0 0-.84-.83h-.33ZM2 7.5A2.5 2.5 0 0 1 4.5 5h9A2.5 2.5 0 0 1 16 7.5v.83h1.17a.83.83 0 0 1 .83.84v1.67a.83.83 0 0 1-.83.83H16v.83a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 2 12.5v-5Z" fill={primaryFill} /></Svg>;;
}
...
const Battery4FilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4.83 6.95a.84.84 0 0 0-.83.83v4.33c0 .46.37.84.83.84h2.33c.47 0 .84-.38.84-.84V7.78a.84.84 0 0 0-.84-.83H4.83ZM2 7.5A2.5 2.5 0 0 1 4.5 5h9A2.5 2.5 0 0 1 16 7.5v.83h1.17a.83.83 0 0 1 .83.84v1.67a.83.83 0 0 1-.83.83H16v.83a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 2 12.5v-5Z" fill={primaryFill} /></Svg>;;
}
...
const Battery5FilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4.83 6.95a.84.84 0 0 0-.83.83v4.33c0 .46.37.84.83.84h3.33c.47 0 .84-.38.84-.84V7.78a.84.84 0 0 0-.84-.83H4.83ZM2 7.5A2.5 2.5 0 0 1 4.5 5h9A2.5 2.5 0 0 1 16 7.5v.83h1.17a.83.83 0 0 1 .83.84v1.67a.83.83 0 0 1-.83.83H16v.83a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 2 12.5v-5Z" fill={primaryFill} /></Svg>;;
}
...
const Battery6FilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4.83 6.95a.84.84 0 0 0-.83.83v4.33c0 .46.37.84.83.84h4.33c.47 0 .84-.38.84-.84V7.78a.84.84 0 0 0-.84-.83H4.83ZM2 7.5A2.5 2.5 0 0 1 4.5 5h9A2.5 2.5 0 0 1 16 7.5v.83h1.17a.83.83 0 0 1 .83.84v1.67a.83.83 0 0 1-.83.83H16v.83a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 2 12.5v-5Z" fill={primaryFill} /></Svg>;;
}
...
const Battery7FilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4.83 6.95a.84.84 0 0 0-.83.83v4.33c0 .46.37.84.83.84h5.33c.47 0 .84-.38.84-.84V7.78a.84.84 0 0 0-.84-.83H4.83ZM2 7.5A2.5 2.5 0 0 1 4.5 5h9A2.5 2.5 0 0 1 16 7.5v.83h1.17a.83.83 0 0 1 .83.84v1.67a.83.83 0 0 1-.83.83H16v.83a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 2 12.5v-5Z" fill={primaryFill} /></Svg>;;
}
...
const Battery8FilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4.83 6.95a.84.84 0 0 0-.83.83v4.33c0 .46.37.84.83.84h6.33c.47 0 .84-.38.84-.84V7.78a.84.84 0 0 0-.84-.83H4.83ZM2 7.5A2.5 2.5 0 0 1 4.5 5h9A2.5 2.5 0 0 1 16 7.5v.83h1.17a.83.83 0 0 1 .83.84v1.67a.83.83 0 0 1-.83.83H16v.83a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 2 12.5v-5Z" fill={primaryFill} /></Svg>;;
}
...
const Battery9FilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4.83 6.95a.84.84 0 0 0-.83.83v4.33c0 .46.37.84.83.84h7.33c.47 0 .84-.38.84-.84V7.78a.84.84 0 0 0-.84-.83H4.83ZM2 7.5A2.5 2.5 0 0 1 4.5 5h9A2.5 2.5 0 0 1 16 7.5v.83h1.17a.83.83 0 0 1 .83.84v1.67a.83.83 0 0 1-.83.83H16v.83a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 2 12.5v-5Z" fill={primaryFill} /></Svg>;;
}
...
const BeakerFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M7.25 4v4.75c0 .4-.1.81-.3 1.18l-.84 1.57h7.78l-.84-1.57a2.5 2.5 0 0 1-.3-1.18V4h.75a.5.5 0 0 0 0-1h-7a.5.5 0 0 0 0 1h.75Zm7.17 8.5H5.58l-1.23 2.3A1.5 1.5 0 0 0 5.67 17h8.66a1.5 1.5 0 0 0 1.32-2.2l-1.23-2.3Z" fill={primaryFill} /></Svg>;;
}
...
const BeakerRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6.5 4h.75v4.75c0 .4-.1.81-.3 1.18l-2.6 4.86A1.5 1.5 0 0 0 5.67 17h8.66a1.5 1.5 0 0 0 1.32-2.2l-2.6-4.87a2.5 2.5 0 0 1-.3-1.18V4h.75a.5.5 0 0 0 0-1h-7a.5.5 0 0 0 0 1Zm1.75 4.75V4h3.5v4.75c0 .57.14 1.14.41 1.65l.6 1.1H7.24l.59-1.1c.27-.5.41-1.08.41-1.65ZM6.71 12.5h6.58l1.48 2.76a.5.5 0 0 1-.44.74H5.67a.5.5 0 0 1-.44-.74L6.7 12.5Z" fill={primaryFill} /></Svg>;;
}
...
const BeakerEditFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M5.25 3v4.75c0 .4-.1.81-.3 1.18l-.84 1.57h7.78l-.84-1.57a2.5 2.5 0 0 1-.3-1.18V3h.75a.5.5 0 0 0 0-1h-7a.5.5 0 0 0 0 1h.75Zm7.17 8.5H3.58l-1.23 2.3A1.5 1.5 0 0 0 3.67 16h5.8c.16-.5.43-.96.8-1.33l2.51-2.5-.36-.67Zm-1.44 3.88 4.83-4.83a1.87 1.87 0 1 1 2.64 2.64l-4.83 4.83a2.2 2.2 0 0 1-1.02.58l-1.5.37a.89.89 0 0 1-1.07-1.07l.37-1.5c.1-.39.3-.74.58-1.02Z" fill={primaryFill} /></Svg>;;
}
...
const BedFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M15.5 9a2.5 2.5 0 0 1 2.5 2.34v5.16a.5.5 0 0 1-1 .09V14H3v2.5a.5.5 0 0 1-1 .09V11.5A2.5 2.5 0 0 1 4.34 9H15.5Zm-9-6h7A2.5 2.5 0 0 1 16 5.34V8h-2v-.5a.5.5 0 0 0-.41-.5H11a.5.5 0 0 0-.5.41V8h-1v-.5a.5.5 0 0 0-.41-.5H6.5a.5.5 0 0 0-.5.41V8H4V5.5A2.5 2.5 0 0 1 6.34 3h.16Z" fill={primaryFill} /></Svg>;;
}
...
const BedRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M13.5 3A2.5 2.5 0 0 1 16 5.34v2.71a2.5 2.5 0 0 1 2 2.28v6.17a.5.5 0 0 1-1 .09V14H3v2.5a.5.5 0 0 1-1 .09V10.5a2.5 2.5 0 0 1 2-2.45V5.5A2.5 2.5 0 0 1 6.34 3h7.16Zm2 6h-11c-.78 0-1.42.6-1.5 1.36V13h14v-2.5c0-.78-.6-1.42-1.36-1.5h-.14Zm-2-5h-7c-.78 0-1.42.6-1.5 1.36V8h1v-.5c0-.28.22-.5.5-.5H9c.28 0 .5.22.5.5V8h1v-.5c0-.28.22-.5.5-.5h2.5c.28 0 .5.22.5.5V8h1V5.5c0-.78-.6-1.42-1.36-1.5h-.14Z" fill={primaryFill} /></Svg>;;
}
...
const BinFullFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M14.75 2.93a.5.5 0 1 0-.5-.86l-12 7A.5.5 0 0 0 2 9.5v6A2.5 2.5 0 0 0 4.5 18h11a2.5 2.5 0 0 0 2.5-2.5v-6a.5.5 0 0 0-.5-.5H17V6.5c0-.83-.67-1.5-1.5-1.5h-2c-.83 0-1.5.67-1.5 1.5V7H9.5C8.67 7 8 7.67 8 8.5V9H4.35l10.4-6.07ZM12 8v1H9v-.5c0-.28.22-.5.5-.5H12Zm1 1V6.5c0-.28.22-.5.5-.5h2c.28 0 .5.22.5.5V9h-3Z" fill={primaryFill} /></Svg>;;
}
...
const BluetoothRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9.32 2.03A.5.5 0 0 0 9 2.5v6.33L6.8 7.1a.5.5 0 0 0-.6.78L8.86 10 6.2 12.1a.5.5 0 1 0 .62.8L9 11.16v6.33a.5.5 0 0 0 .87.33l4-4.5a.5.5 0 0 0-.06-.72L10.49 10l3.32-2.6a.5.5 0 0 0 .06-.73l-4-4.5a.5.5 0 0 0-.55-.14ZM10 10.9l2.77 2.17L10 16.18v-5.3Zm0-1.78v-5.3l2.77 3.13L10 9.1Z" fill={primaryFill} /></Svg>;;
}
...
const BluetoothDisabledRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9 9.7 2.15 2.86a.5.5 0 1 1 .7-.7l15 15a.5.5 0 0 1-.7.7L13.29 14l-3.42 3.84A.5.5 0 0 1 9 17.5v-6.33L6.8 12.9a.5.5 0 0 1-.6-.78L9 9.9v-.2Zm3.58 3.58L10 10.71v5.47l2.58-2.9ZM13.8 7.4l-2.4 1.9-.72-.72 2.08-1.63L10 3.82v4.06l-1-1V2.5a.5.5 0 0 1 .87-.33l4 4.5a.5.5 0 0 1-.06.72Z" fill={primaryFill} /></Svg>;;
}
...
const BlurFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10 2a8 8 0 1 0 5.3 14H10v-1h6.25a8 8 0 0 0 .68-1H10v-1h7.42c.13-.32.24-.66.33-1H10v-1h7.94c.04-.33.06-.66.06-1h-8V9h7.94c-.04-.34-.1-.67-.2-1H10V7h7.42c-.14-.35-.3-.68-.49-1H10V5h6.25c-.3-.36-.61-.7-.96-1H10V3h3.88A7.96 7.96 0 0 0 10 2Z" fill={primaryFill} /></Svg>;;
}
...
const BlurRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10 2a8 8 0 1 0 5.3 14H10v1a7 7 0 1 1 0-14h3.88A7.96 7.96 0 0 0 10 2Zm0 2h5.3c.34.3.66.64.95 1H10V4Zm6.93 2H10v1h7.42c-.14-.35-.3-.68-.49-1ZM10 8h7.75c.08.33.15.66.19 1H10V8Zm8 2h-8v1h7.94c.04-.33.06-.66.06-1Zm-8 2h7.75c-.09.34-.2.68-.33 1H10v-1Zm6.93 2H10v1h6.25a8 8 0 0 0 .68-1Z" fill={primaryFill} /></Svg>;;
}
...
const BoardFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M9.5 3v4H3V6a3 3 0 0 1 3-3h3.5Zm1 0v9H17V6a3 3 0 0 0-3-3h-3.5ZM17 13h-6.5v4H14a3 3 0 0 0 3-3v-1Zm-7.5 4V8H3v6a3 3 0 0 0 3 3h3.5Z" fill={primaryFill} /></Svg>;;
}
...
const BoardRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3 6a3 3 0 0 1 3-3h8a3 3 0 0 1 3 3v8a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V6Zm3-2a2 2 0 0 0-2 2v1.06L9.5 7V4H6Zm4.5 0v8H16V6a2 2 0 0 0-2-2h-3.5Zm5.5 9h-5.5v3H14a2 2 0 0 0 2-2v-1Zm-6.5 3V8L4 8.06V14c0 1.1.9 2 2 2h3.5Z" fill={primaryFill} /></Svg>;;
}
...
const BoardSplitFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 3a3 3 0 0 0-3 3v3h8V3H6Zm5 7H3v4a3 3 0 0 0 3 3h5v-7Zm3 7h-2v-4h5v1a3 3 0 0 1-3 3Zm3-5h-5V8h5v4Zm0-5h-5V3h2a3 3 0 0 1 3 3v1Z" fill={primaryFill} /></Svg>;;
}
...
const BoardSplitRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M3 6a3 3 0 0 1 3-3h8a3 3 0 0 1 3 3v8a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V6Zm1 4v4c0 1.1.9 2 2 2h5v-6H4Zm7-1V4H6a2 2 0 0 0-2 2v3h7Zm1 7h2a2 2 0 0 0 2-2v-1h-4v3Zm4-9V6a2 2 0 0 0-2-2h-2v3h4Zm0 1h-4v4h4V8Z" fill={primaryFill} /></Svg>;;
}
...
const BookFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 2a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h9.5a.5.5 0 0 0 0-1H6a1 1 0 0 1-1-1h10a1 1 0 0 0 1-1V4a2 2 0 0 0-2-2H6Zm.75 2.5h6.5a.75.75 0 0 1 0 1.5h-6.5a.75.75 0 0 1 0-1.5Z" fill={primaryFill} /></Svg>;;
}
...
const BookRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 5a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V5Zm1 0v1h6V5H7ZM4 4v12c0 1.1.9 2 2 2h9.5a.5.5 0 0 0 0-1H6a1 1 0 0 1-1-1h10a1 1 0 0 0 1-1V4a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2Zm10-1a1 1 0 0 1 1 1v11H5V4a1 1 0 0 1 1-1h8Z" fill={primaryFill} /></Svg>;;
}
...
const BookAddRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M14 3H6a1 1 0 0 0-1 1v11h4.02c.03.34.1.68.19 1H5a1 1 0 0 0 1 1h3.6c.18.36.4.7.66 1H6a2 2 0 0 1-2-2V4c0-1.1.9-2 2-2h8a2 2 0 0 1 2 2v5.2c-.32-.08-.66-.15-1-.18V4a1 1 0 0 0-1-1ZM6 5v1a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1Zm1 0h6v1H7V5Zm12 9.5a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0Zm-4-2a.5.5 0 0 0-1 0V14h-1.5a.5.5 0 0 0 0 1H14v1.5a.5.5 0 0 0 1 0V15h1.5a.5.5 0 0 0 0-1H15v-1.5Z" fill={primaryFill} /></Svg>;;
}
...
const BookClockFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 4c0-1.1.9-2 2-2h8a2 2 0 0 1 2 2v11a1 1 0 0 1-1 1H5a1 1 0 0 0 1 1h9.5a.5.5 0 0 1 0 1H6a2 2 0 0 1-2-2V4Zm6 9a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm-.5-6c.28 0 .5.22.5.5V9h1a.5.5 0 0 1 0 1H9.5a.5.5 0 0 1-.5-.5v-2c0-.28.22-.5.5-.5Z" fill={primaryFill} /></Svg>;;
}
...
const BookClockRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 4v12c0 1.1.9 2 2 2h9.5a.5.5 0 0 0 0-1H6a1 1 0 0 1-1-1h10a1 1 0 0 0 1-1V4a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2Zm10-1a1 1 0 0 1 1 1v11H5V4a1 1 0 0 1 1-1h8Zm-4 3a3 3 0 1 0 0 6 3 3 0 0 0 0-6ZM6 9a4 4 0 1 1 8 0 4 4 0 0 1-8 0Zm4-1.5a.5.5 0 0 0-1 0v2c0 .28.22.5.5.5H11a.5.5 0 0 0 0-1h-1V7.5Z" fill={primaryFill} /></Svg>;;
}
...
const BookCoinsFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 4c0-1.1.9-2 2-2h8a2 2 0 0 1 2 2v11a1 1 0 0 1-1 1H5a1 1 0 0 0 1 1h9.5a.5.5 0 0 1 0 1H6a2 2 0 0 1-2-2V4Zm6 1c-.76 0-1.47.16-2.02.48C7.43 5.8 7 6.31 7 7c0 .69.43 1.2.98 1.52.55.32 1.26.48 2.02.48s1.47-.16 2.02-.48c.55-.32.98-.83.98-1.52 0-.69-.43-1.2-.98-1.52A4.08 4.08 0 0 0 10 5ZM7.03 9.03a.79.79 0 0 0-.03.22c0 .3.18.55.33.71.17.18.4.36.65.5a4.1 4.1 0 0 0 4.04 0c.26-.14.48-.32.65-.5.15-.16.33-.41.33-.71a.79.79 0 0 0-.03-.22l-.45.3a5.1 5.1 0 0 1-5.49-.3Zm0 2a.79.79 0 0 0-.03.22c0 .3.18.55.33.71.17.18.4.36.65.5a4.1 4.1 0 0 0 4.04 0c.26-.14.48-.32.65-.5.15-.16.33-.41.33-.71a.79.79 0 0 0-.03-.22l-.45.3a5.1 5.1 0 0 1-5.49-.3Z" fill={primaryFill} /></Svg>;;
}
...
const BookContactsFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 2a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h9.5a.5.5 0 0 0 0-1H6a1 1 0 0 1-1-1h10a1 1 0 0 0 1-1V4a2 2 0 0 0-2-2H6Zm5.5 5.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0ZM7 10.75c0-.41.34-.75.75-.75h4.5c.41 0 .75.34.75.75V11a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2v-.25Z" fill={primaryFill} /></Svg>;;
}
...
const BookDatabaseFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 4c0-1.1.9-2 2-2h8a2 2 0 0 1 2 2v11a1 1 0 0 1-1 1H5a1 1 0 0 0 1 1h9.5a.5.5 0 0 1 0 1H6a2 2 0 0 1-2-2V4Zm4.48 2.34C8.13 6.55 8 6.8 8 7c0 .21.13.45.48.66.36.2.9.34 1.52.34a3.1 3.1 0 0 0 1.52-.34c.35-.21.48-.45.48-.66 0-.21-.13-.45-.48-.66A3.1 3.1 0 0 0 10 6a3.1 3.1 0 0 0-1.52.34Zm-.5-.86C7.43 5.8 7 6.31 7 7v4c0 .63.45 1.14.97 1.46A3.9 3.9 0 0 0 10 13c.78 0 1.5-.21 2.03-.54.52-.32.97-.83.97-1.46V7c0-.69-.43-1.2-.98-1.52A4.08 4.08 0 0 0 10 5c-.76 0-1.47.16-2.02.48ZM12 11V8.53A4.1 4.1 0 0 1 10 9a4.1 4.1 0 0 1-2-.47V11c0 .12.1.36.5.6.36.23.9.4 1.5.4s1.14-.17 1.5-.4c.4-.24.5-.48.5-.6Z" fill={primaryFill} /></Svg>;;
}
...
const BookDatabaseRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 4v12c0 1.1.9 2 2 2h9.5a.5.5 0 0 0 0-1H6a1 1 0 0 1-1-1h10a1 1 0 0 0 1-1V4a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2Zm10-1a1 1 0 0 1 1 1v11H5V4a1 1 0 0 1 1-1h8ZM8.48 6.34C8.13 6.55 8 6.8 8 7c0 .21.13.45.48.66.36.2.9.34 1.52.34a3.1 3.1 0 0 0 1.52-.34c.35-.21.48-.45.48-.66 0-.21-.13-.45-.48-.66A3.1 3.1 0 0 0 10 6a3.1 3.1 0 0 0-1.52.34ZM12 8.54A4.1 4.1 0 0 1 10 9a4.1 4.1 0 0 1-2-.47V11c0 .12.1.36.5.6.36.23.9.4 1.5.4s1.14-.17 1.5-.4c.4-.24.5-.48.5-.6V8.53ZM7 7c0-.69.43-1.2.98-1.52A4.08 4.08 0 0 1 10 5c.76 0 1.47.16 2.02.48.55.32.98.83.98 1.52v4c0 .63-.45 1.14-.97 1.46A3.9 3.9 0 0 1 10 13a3.9 3.9 0 0 1-2.03-.54C7.45 12.14 7 11.63 7 11V7Z" fill={primaryFill} /></Svg>;;
}
...
const BookExclamationMarkFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 4c0-1.1.9-2 2-2h8a2 2 0 0 1 2 2v11a1 1 0 0 1-1 1H5a1 1 0 0 0 1 1h9.5a.5.5 0 0 1 0 1H6a2 2 0 0 1-2-2V4Zm6 1a.5.5 0 0 0-.5.5v4a.5.5 0 0 0 1 0v-4A.5.5 0 0 0 10 5Zm.75 7.25a.75.75 0 1 0-1.5 0 .75.75 0 0 0 1.5 0Z" fill={primaryFill} /></Svg>;;
}
...
const BookExclamationMarkRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 4v12c0 1.1.9 2 2 2h9.5a.5.5 0 0 0 0-1H6a1 1 0 0 1-1-1h10a1 1 0 0 0 1-1V4a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2Zm10-1a1 1 0 0 1 1 1v11H5V4a1 1 0 0 1 1-1h8Zm-4 2c.28 0 .5.22.5.5v4a.5.5 0 0 1-1 0v-4c0-.28.22-.5.5-.5Zm0 8a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z" fill={primaryFill} /></Svg>;;
}
...
const BookInformationFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 2a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h9.5a.5.5 0 0 0 0-1H6a1 1 0 0 1-1-1h10a1 1 0 0 0 1-1V4a2 2 0 0 0-2-2H6Zm4.75 3.75a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm-.25 6.75a.5.5 0 0 1-1 0v-4a.5.5 0 0 1 1 0v4Z" fill={primaryFill} /></Svg>;;
}
...
const BookInformationRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 4v12c0 1.1.9 2 2 2h9.5a.5.5 0 0 0 0-1H6a1 1 0 0 1-1-1h10a1 1 0 0 0 1-1V4a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2Zm10-1a1 1 0 0 1 1 1v11H5V4a1 1 0 0 1 1-1h8Zm-3.25 2.75a.75.75 0 1 0-1.5 0 .75.75 0 0 0 1.5 0Zm-.25 6.75a.5.5 0 0 1-1 0v-4a.5.5 0 0 1 1 0v4Z" fill={primaryFill} /></Svg>;;
}
...
const BookLetterFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 2a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h9.5a.5.5 0 0 0 0-1H6a1 1 0 0 1-1-1h10a1 1 0 0 0 1-1V4a2 2 0 0 0-2-2H6Zm4 3c.2 0 .38.12.46.3l3 7a.5.5 0 0 1-.92.4l-.73-1.7H8.2l-.73 1.7a.5.5 0 0 1-.92-.4l3-7A.5.5 0 0 1 10 5Zm-1.38 5h2.76L10 6.77 8.62 10Z" fill={primaryFill} /></Svg>;;
}
...
const BookLetterRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 4v12c0 1.1.9 2 2 2h9.5a.5.5 0 0 0 0-1H6a1 1 0 0 1-1-1h10a1 1 0 0 0 1-1V4a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2Zm10-1a1 1 0 0 1 1 1v11H5V4a1 1 0 0 1 1-1h8Zm-4 2c.2 0 .38.12.46.3l3 7a.5.5 0 0 1-.92.4l-.73-1.7H8.2l-.73 1.7a.5.5 0 0 1-.92-.4l3-7A.5.5 0 0 1 10 5Zm-1.38 5h2.76L10 6.77 8.62 10Z" fill={primaryFill} /></Svg>;;
}
...
const BookNumberRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M7 7.5c0-.27.22-.5.5-.5h1.29l.22-1.1a.5.5 0 0 1 .98.2l-.18.9h.98l.22-1.1a.5.5 0 0 1 .98.2l-.18.9h.94a.5.5 0 0 1 0 1h-1.14l-.2 1h1.1a.5.5 0 1 1 0 1h-1.3L11 11.1a.5.5 0 0 1-.98-.2l.18-.9h-.98l-.22 1.1a.5.5 0 1 1-.98-.2l.18-.9h-.94a.5.5 0 0 1 0-1H8.4l.2-1H7.5a.5.5 0 0 1-.5-.5ZM10.4 9l.2-1H9.6l-.2 1h.98ZM6 2h8a2 2 0 0 1 2 2v11.5a.5.5 0 0 1-.5.5H5a1 1 0 0 0 1 1h9.5a.5.5 0 0 1 0 1H6a2 2 0 0 1-2-2V4c0-1.1.9-2 2-2ZM5 15h10V4a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1v11Z" fill={primaryFill} /></Svg>;;
}
...
const BookOpenFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10 16.14c-.5.53-1.21.86-2 .86H3.75C2.78 17 2 16.22 2 15.25V4.75C2 3.78 2.78 3 3.75 3H8c.79 0 1.5.33 2 .86.5-.53 1.21-.86 2-.86h4.25c.97 0 1.75.78 1.75 1.75v10.5c0 .97-.78 1.75-1.75 1.75H12c-.79 0-1.5-.33-2-.86ZM3.5 4.75v10.5c0 .14.11.25.25.25H8c.69 0 1.25-.56 1.25-1.25v-8.5c0-.69-.56-1.25-1.25-1.25H3.75a.25.25 0 0 0-.25.25Zm7.25 9.5c0 .69.56 1.25 1.25 1.25h4.25c.14 0 .25-.11.25-.25V4.75a.25.25 0 0 0-.25-.25H12c-.69 0-1.25.56-1.25 1.25v8.5Z" fill={primaryFill} /></Svg>;;
}
...
const BookOpenRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M10 16c-.46.6-1.18 1-2 1H3.5A1.5 1.5 0 0 1 2 15.5v-11C2 3.67 2.67 3 3.5 3H8c.82 0 1.54.4 2 1 .46-.6 1.18-1 2-1h4.5c.83 0 1.5.67 1.5 1.5v11c0 .83-.67 1.5-1.5 1.5H12a2.5 2.5 0 0 1-2-1ZM3 4.5v11c0 .28.22.5.5.5H8c.83 0 1.5-.67 1.5-1.5v-9C9.5 4.67 8.83 4 8 4H3.5a.5.5 0 0 0-.5.5Zm7.5 10c0 .83.67 1.5 1.5 1.5h4.5a.5.5 0 0 0 .5-.5v-11a.5.5 0 0 0-.5-.5H12c-.83 0-1.5.67-1.5 1.5v9Z" fill={primaryFill} /></Svg>;;
}
...
const BookPulseFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 4c0-1.1.9-2 2-2h8a2 2 0 0 1 2 2v11a1 1 0 0 1-1 1H5a1 1 0 0 0 1 1h9.5a.5.5 0 0 1 0 1H6a2 2 0 0 1-2-2V4Zm5.46 2.3a.5.5 0 0 0-.9-.02L7.18 9H6.5a.5.5 0 0 0 0 1h1a.5.5 0 0 0 .45-.28l1.03-2.06 2.06 4.55a.5.5 0 0 0 .89.05L13.28 10h.22a.5.5 0 0 0 0-1H13a.5.5 0 0 0-.43.24l-1 1.69-2.11-4.64Z" fill={primaryFill} /></Svg>;;
}
...
const BookPulseRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 16V4c0-1.1.9-2 2-2h8a2 2 0 0 1 2 2v11a1 1 0 0 1-1 1H5a1 1 0 0 0 1 1h9.5a.5.5 0 0 1 0 1H6a2 2 0 0 1-2-2ZM15 4a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1v11h10V4ZM9.46 6.3a.5.5 0 0 0-.9-.02L7.18 9H6.5a.5.5 0 0 0 0 1h1a.5.5 0 0 0 .45-.28l1.03-2.06 2.06 4.55a.5.5 0 0 0 .89.05L13.28 10h.22a.5.5 0 0 0 0-1H13a.5.5 0 0 0-.43.24l-1 1.69-2.11-4.64Z" fill={primaryFill} /></Svg>;;
}
...
const BookQuestionMarkRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 4v12c0 1.1.9 2 2 2h9.5a.5.5 0 0 0 0-1H6a1 1 0 0 1-1-1h10a1 1 0 0 0 1-1V4a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2Zm10-1a1 1 0 0 1 1 1v11H5V4a1 1 0 0 1 1-1h8ZM8.76 6.4c.19-.19.55-.4 1.24-.4s1.05.21 1.24.4c.2.22.26.47.26.6 0 .45-.27.7-.72.92a7 7 0 0 1-.35.16l-.02.01-.32.15c-.1.05-.24.12-.35.23A.73.73 0 0 0 9.5 9v1a.5.5 0 1 0 1 0v-.85l.04-.02.28-.13h.01a8 8 0 0 0 .4-.18c.54-.27 1.27-.77 1.27-1.82 0-.37-.14-.87-.54-1.28C11.55 5.29 10.91 5 10 5c-.91 0-1.55.29-1.96.72-.4.41-.54.91-.54 1.28a.5.5 0 0 0 1 0 .9.9 0 0 1 .26-.6ZM10 13a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z" fill={primaryFill} /></Svg>;;
}
...
const BookQuestionMarkRtlFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 2a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h9.5a.5.5 0 0 0 0-1H6a1 1 0 0 1-1-1h10a1 1 0 0 0 1-1V4a2 2 0 0 0-2-2H6Zm5.24 4.4c-.19-.19-.55-.4-1.24-.4s-1.05.21-1.24.4a.9.9 0 0 0-.26.6c0 .45.27.7.72.92l.35.16.02.01.32.15c.1.05.24.12.35.23.11.1.24.28.24.53v1a.5.5 0 1 1-1 0v-.85l-.04-.02A5.75 5.75 0 0 0 9.18 9h-.01a7.97 7.97 0 0 1-.4-.18C8.24 8.55 7.5 8.05 7.5 7c0-.37.14-.87.54-1.28C8.45 5.29 9.09 5 10 5c.91 0 1.55.29 1.96.72.4.41.54.91.54 1.28a.5.5 0 0 1-1 0 .9.9 0 0 0-.26-.6ZM10 13a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5Z" fill={primaryFill} /></Svg>;;
}
...
const BookQuestionMarkRtlRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 4v12c0 1.1.9 2 2 2h9.5a.5.5 0 0 0 0-1H6a1 1 0 0 1-1-1h10a1 1 0 0 0 1-1V4a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2Zm10-1a1 1 0 0 1 1 1v11H5V4a1 1 0 0 1 1-1h8Zm-2.76 3.4c.2.22.26.47.26.6a.5.5 0 0 0 1 0c0-.37-.14-.87-.54-1.28C11.55 5.29 10.91 5 10 5c-.91 0-1.55.29-1.96.72-.4.41-.54.91-.54 1.28 0 1.05.73 1.55 1.28 1.82l.39.18h.01a5.75 5.75 0 0 1 .32.15V10a.5.5 0 0 0 1 0V9a.73.73 0 0 0-.24-.53c-.11-.1-.24-.18-.35-.23l-.32-.15-.02-.01-.35-.16C8.77 7.7 8.5 7.45 8.5 7a.9.9 0 0 1 .26-.6c.19-.19.55-.4 1.24-.4s1.05.21 1.24.4ZM10 13a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5Z" fill={primaryFill} /></Svg>;;
}
...
const BookSearchFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6 2a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h9.5a.5.5 0 0 0 0-1H6a1 1 0 0 1-1-1h10a1 1 0 0 0 1-1V4a2 2 0 0 0-2-2H6Zm5.59 7.88 1.26 1.27a.5.5 0 0 1-.7.7l-1.27-1.26a2.5 2.5 0 1 1 .7-.7ZM8 8.5a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0Z" fill={primaryFill} /></Svg>;;
}
...
const BookSearchRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 4v12c0 1.1.9 2 2 2h9.5a.5.5 0 0 0 0-1H6a1 1 0 0 1-1-1h10a1 1 0 0 0 1-1V4a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2Zm10-1a1 1 0 0 1 1 1v11H5V4a1 1 0 0 1 1-1h8Zm-2.41 6.88a2.5 2.5 0 1 0-.7.7l1.26 1.27a.5.5 0 0 0 .7-.7L11.6 9.88ZM8 8.5a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0Z" fill={primaryFill} /></Svg>;;
}
...
const BookTemplateFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4.5 1A2.5 2.5 0 0 0 2 3.5v9A2.5 2.5 0 0 0 4.5 15H8V9H5.5a.5.5 0 0 1 0-1h2.67a3 3 0 0 1 .6-1H5.5a.5.5 0 0 1 0-1H16V3.5A2.5 2.5 0 0 0 13.5 1h-9ZM5 4.5c0-.28.22-.5.5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5ZM18 9a2 2 0 0 0-2-2h-5a2 2 0 0 0-2 2v8c0 1.1.9 2 2 2h6.5a.5.5 0 0 0 0-1H11a1 1 0 0 1-1-1h7.5a.5.5 0 0 0 .5-.5V9Zm-8 7V9a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v7h-7Z" fill={primaryFill} /></Svg>;;
}
...
const BookThetaRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 4v12c0 1.1.9 2 2 2h9.5a.5.5 0 0 0 0-1H6a1 1 0 0 1-1-1h10a1 1 0 0 0 1-1V4a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2Zm10-1a1 1 0 0 1 1 1v11H5V4a1 1 0 0 1 1-1h8ZM7 9c0-1.06.3-2.04.83-2.77A2.7 2.7 0 0 1 10 5c.9 0 1.66.5 2.17 1.23.52.73.83 1.71.83 2.77s-.3 2.04-.83 2.77A2.7 2.7 0 0 1 10 13c-.9 0-1.66-.5-2.17-1.23A4.79 4.79 0 0 1 7 9Zm4.97.5H8.03c.07.67.3 1.25.6 1.68.4.54.88.82 1.37.82.49 0 .97-.28 1.36-.82.31-.43.54-1.01.61-1.68Zm0-1a3.62 3.62 0 0 0-.6-1.68C10.96 6.28 10.48 6 10 6c-.49 0-.97.28-1.36.82a3.62 3.62 0 0 0-.61 1.68h3.94Z" fill={primaryFill} /></Svg>;;
}
...
const BookmarkFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 4.5A2.5 2.5 0 0 1 6.5 2h7A2.5 2.5 0 0 1 16 4.5v13a.5.5 0 0 1-.8.4L10 14.12 4.8 17.9a.5.5 0 0 1-.8-.4v-13Z" fill={primaryFill} /></Svg>;;
}
...
const BookmarkRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M4 4.5A2.5 2.5 0 0 1 6.5 2h7A2.5 2.5 0 0 1 16 4.5v13a.5.5 0 0 1-.8.4L10 14.12 4.8 17.9a.5.5 0 0 1-.8-.4v-13ZM6.5 3C5.67 3 5 3.67 5 4.5v12.02l4.7-3.42a.5.5 0 0 1 .6 0l4.7 3.42V4.5c0-.83-.67-1.5-1.5-1.5h-7Z" fill={primaryFill} /></Svg>;;
}
...
const BookmarkMultipleFilledIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6.27 3A2 2 0 0 1 8 2h4.5A3.5 3.5 0 0 1 16 5.5v10a.5.5 0 0 1-.78.42l-.22-.15V5.5A2.5 2.5 0 0 0 12.5 3H6.27ZM6 4a2 2 0 0 0-2 2v11.5a.5.5 0 0 0 .78.42L9 15.1l4.22 2.82a.5.5 0 0 0 .78-.42V6a2 2 0 0 0-2-2H6Z" fill={primaryFill} /></Svg>;;
}
...
const BookmarkMultipleRegularIcon = (props) => {
  const { fill: primaryFill = 'currentColor' } = props;
  return <Svg {...props} width={24} height={24} viewBox="0 0 20 20"><Path d="M6.27 3A2 2 0 0 1 8 2h4.5A3.5 3.5 0 0 1 16 5.5v10a.5.5 0 0 1-.78.42l-.22-.15V5.5A2.5 2.5 0 0 0 12.5 3H6.27ZM6 4a2 2 0 0 0-2 2v11.5a.5.5 0 0 0 .78.42L9 15.1l4.22 2.82a.5.5 0 0 0 .78-.42V6a2 2 0 0 0-2-2H6ZM5 6a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v10.57l-3.72-2.49a.5.5 0 0 0-.56 0L5 16.57V6Z" fill={primaryFill} /></Svg>;;
}
