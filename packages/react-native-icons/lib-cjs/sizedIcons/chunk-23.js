...
const TextUnderline24FilledIcon = props => {
  ...
  return /*#__PURE__*/React.createElement(react_native_svg_1.default, _extends({}, props, {
    ...
    d: "M9.97 7.53c-.08-.36 0-.72.22-.98.21-.26.66-.55 1.56-.55.93 0 1.57.26 1.96.49a2.57 2.57 0 0 1 .51.39 1 1 0 0 0 1.56-1.25c-.16-.11 0 0 0 0v-.01l-.01-.01a1.26 1.26 0 0 0-.08-.1 4.57 4.57 0 0 0-.96-.75A5.8 5.8 0 0 0 11.75 4c-1.35 0-2.42.46-3.1 1.27-.66.8-.83 1.8-.62 2.7.2.9.8 1.51 1.41 1.94.58.4 1.3.73 1.9 1l.07.03c.67.3 1.26.58 1.74.9.48.33.77.66.92 1.03.29.72.14 1.18-.11 1.47-.3.34-.94.66-1.96.66-1.25 0-1.87-.4-2.17-.7a1.67 1.67 0 0 1-.36-.55v-.01a1 1 0 0 0-1.94.5c.1.3 0 0 0 0v.03a1.75 1.75 0 0 0 .06.15 3.66 3.66 0 0 0 .83 1.28c.7.7 1.83 1.3 3.58 1.3 1.39 0 2.66-.43 3.46-1.33.84-.96.99-2.25.47-3.54a4.3 4.3 0 0 0-1.65-1.94c-.65-.44-1.39-.77-2.02-1.06l-.03-.01a10.7 10.7 0 0 1-1.64-.85c-.4-.28-.56-.52-.62-.74ZM7 18a1 1 0 1 0 0 2h10a1 1 0 1 0 0-2H7Z",
    fill: primaryFill
  }));
};
