...
const TableFreezeColumnAndRowRegularIcon = props => {
  ...
  return /*#__PURE__*/React.createElement(react_native_svg_1.default, _extends({
    ...
    d: "M14.5 3A2.5 2.5 0 0 1 17 5.5v9a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 3 14.5v-9A2.5 2.5 0 0 1 5.5 3h9ZM8 16h4v-3H8v3Zm5 0h1.5c.78 0 1.42-.6 1.5-1.36V13h-3v3Zm-1-4V8H8v4h4Zm4-4h-3v4h3V8ZM5.5 16H7V7h9V5.5c0-.78-.6-1.42-1.36-1.5H5.5c-.78 0-1.42.6-1.5 1.36v9.14c0 .78.6 1.42 1.36 1.5h.14Z",
    fill: primaryFill
  }));
  ;
};
