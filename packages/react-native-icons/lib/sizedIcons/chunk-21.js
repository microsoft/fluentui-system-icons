...
const TableFreezeColumnAndRow16FilledIcon = props => {
  ...
  return /*#__PURE__*/React.createElement(Svg, _extends({
    ...
    d: "M4.5 2A2.5 2.5 0 0 0 2 4.5v7A2.5 2.5 0 0 0 4.5 14H10v-3H6v2H4.5A1.5 1.5 0 0 1 3 11.5v-7C3 3.67 3.67 3 4.5 3h7c.83 0 1.5.67 1.5 1.5V6h-2v4h3V4.5A2.5 2.5 0 0 0 11.5 2h-7ZM6 6v4h4V6H6Zm5 5v3h.5a2.5 2.5 0 0 0 2.5-2.5V11h-3Z",
    fill: primaryFill
  }));
  ;
};
...
const TableFreezeColumnAndRow16RegularIcon = props => {
  ...
  return /*#__PURE__*/React.createElement(Svg, _extends({
    ...
    d: "M2 4.5A2.5 2.5 0 0 1 4.5 2h7A2.5 2.5 0 0 1 14 4.5v7a2.5 2.5 0 0 1-2.5 2.5h-7A2.5 2.5 0 0 1 2 11.5v-7ZM6 13h4v-2H6v2Zm0-3h4V6H6v4Zm7-4h-2v4h2V6Zm0 5h-2v2h.5c.83 0 1.5-.67 1.5-1.5V11Zm-8.5 2H5V5h8v-.5c0-.83-.67-1.5-1.5-1.5h-7C3.67 3 3 3.67 3 4.5v7c0 .83.67 1.5 1.5 1.5Z",
    fill: primaryFill
  }));
  ;
};
...
const TableFreezeColumnAndRow24FilledIcon = props => {
  ...
  return /*#__PURE__*/React.createElement(Svg, _extends({
    ...
    d: "M6.25 3A3.25 3.25 0 0 0 3 6.25v11.5C3 19.55 4.46 21 6.25 21h8.25v-5h-5v3.5H6.25c-.97 0-1.75-.78-1.75-1.75V6.25c0-.97.78-1.75 1.75-1.75h11.5c.97 0 1.75.78 1.75 1.75V9.5H16v5h5V6.25C21 4.45 19.54 3 17.75 3H6.25ZM16 16v5h1.75c1.8 0 3.25-1.46 3.25-3.25V16h-5Zm-1.5-1.5v-5h-5v5h5Z",
    fill: primaryFill
  }));
  ;
};
...
const TableFreezeColumnAndRow28RegularIcon = props => {
  ...
  return /*#__PURE__*/React.createElement(Svg, _extends({
    ...
    d: "M3 6.75A3.75 3.75 0 0 1 6.75 3h14.5A3.75 3.75 0 0 1 25 6.75v14.5A3.75 3.75 0 0 1 21.25 25H6.75A3.75 3.75 0 0 1 3 21.25V6.75ZM6.75 23.5H9.5v-14h14V6.75c0-1.24-1-2.25-2.25-2.25H6.75c-1.24 0-2.25 1-2.25 2.25v14.5c0 1.24 1 2.25 2.25 2.25ZM17 17v-6h-6v6h6Zm6.5-6h-5v6h5v-6ZM11 18.5v5h6v-5h-6Zm7.5 5h2.75c1.24 0 2.25-1 2.25-2.25V18.5h-5v5Z",
    fill: primaryFill
  }));
  ;
};
