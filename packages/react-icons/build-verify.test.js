...
describe('Build Verification', () => {
  ...
  describe(`Atoms`, () => {
    ...
    it(`should have same number of atoms/svg icon files in lib and lib-cjs`, async () => {
      ...
      expect(esmStats.jsFiles.length).toMatchInlineSnapshot(`2850`);
      expect(cjsStats.jsFiles.length).toMatchInlineSnapshot(`2850`);
    });
    it(`should have same number of atoms/fonts icon files in lib and lib-cjs`, async () => {
      ...
      expect(esmStats.jsFiles.length).toMatchInlineSnapshot(`2843`);
      expect(cjsStats.jsFiles.length).toMatchInlineSnapshot(`2843`);
    });
