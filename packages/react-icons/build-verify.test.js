...
describe('Build Verification', () => {
  ...
  describe(`Atoms`, () => {
    ...
    it(`should have same number of atoms/svg icon files in lib and lib-cjs`, async () => {
      ...
      expect(esmStats.jsFiles.length).toMatchInlineSnapshot(`2803`);
      expect(cjsStats.jsFiles.length).toMatchInlineSnapshot(`2803`);
    });
    it(`should have same number of atoms/fonts icon files in lib and lib-cjs`, async () => {
      ...
      expect(esmStats.jsFiles.length).toMatchInlineSnapshot(`2796`);
      expect(cjsStats.jsFiles.length).toMatchInlineSnapshot(`2796`);
    });
