...
const CurrencyDollarEuro20Filled = (iconProps: IFluentIconsProps, props: React.HTMLAttributes<HTMLElement>): JSX.Element => {
  const {
    primaryFill,
    className
  } = iconProps;
...
export default CurrencyDollarEuro20Filled;