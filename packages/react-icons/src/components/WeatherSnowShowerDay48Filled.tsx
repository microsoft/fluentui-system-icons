...
const WeatherSnowShowerDay48Filled = (iconProps: IFluentIconsProps, props: React.HTMLAttributes<HTMLElement>): JSX.Element => {
  const {
    primaryFill,
    className
  } = iconProps;
...
export default WeatherSnowShowerDay48Filled;