...
const WeatherPartlyCloudyNight20Regular = (iconProps: IFluentIconsProps, props: React.HTMLAttributes<HTMLElement>): JSX.Element => {
  const {
    primaryFill,
    className
  } = iconProps;
...
export default WeatherPartlyCloudyNight20Regular;