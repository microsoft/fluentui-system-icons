...
>
> **CSS-in-JS:** Griffel AOT (standard) / vanilla CSS bundled as JS strings via webpack `css-loader` + `style-loader` (headless)
>
...
| Headless, CSS-in-JS     | 38.039 kB | 10.444 kB |  -0.098 kB (-0.3%) |  -0.082 kB (-0.8%) |
...
| Headless, CSS-in-JS     | 11.510 kB | 4.590 kB | +1.344 kB (+13.2%) | +0.437 kB (+10.5%) |
...
| Headless, CSS-in-JS     | 8.992 kB | 3.639 kB |  +0.067 kB (+0.8%) |  -0.018 kB (-0.5%) |
