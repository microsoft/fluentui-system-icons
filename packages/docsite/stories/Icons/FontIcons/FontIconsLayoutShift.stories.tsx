  ...
  docs: {
    description: {
      story: [
        ...
        '',
        'Both cases share one box and a dashed vertical guide at the reserved label position. To see it',
        'live: in the built Storybook, DevTools → Network → disable cache + throttle, then reload — row',
        '1 starts left of the guide and jumps onto it; row 2 stays on it. The dashed icon outlines show',
        'the reserved 1em box.',
      ].join(' '),
    },
  },
};
