import type { BundlerCompilation } from './bundler-api';
...
export function assertSupportedSelector(resource: string, compilation: BundlerCompilation): void {
...
export function registerSelectorCapability(compilation: BundlerCompilation): void {
