...
public val FluentIcons.Filled.MailInboxArrowDown16: ImageVector
  get() {
    if (_mailInboxArrowDown16 != null) {
      return _mailInboxArrowDown16!!
    }
    _mailInboxArrowDown16 = fluentIcon(name = "Filled.MailInboxArrowDown16", 16f) {
      materialPath {
          moveTo(14.0F, 9.743F)
          ...
          curveTo(10.633F, 7.986F, 10.57F, 8.0F, 10.503F, 8.0F)
...
private var _mailInboxArrowDown16: ImageVector? = null
