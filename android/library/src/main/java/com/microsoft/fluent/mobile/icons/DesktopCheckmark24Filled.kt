...
public val FluentIcons.Filled.DesktopCheckmark24: ImageVector
  get() {
    if (_desktopCheckmark24 != null) {
      return _desktopCheckmark24!!
    }
    _desktopCheckmark24 = fluentIcon(name = "Filled.DesktopCheckmark24", 24f) {
      materialPath {
          moveTo(23.0F, 6.5F)
          ...
          close()
          moveTo(17.5F, 13.0F)
          curveToRelative(1.746F, 0.0F, 3.331F, -0.688F, 4.499F, -1.809F)
          ...
          curveTo(11.375F, 4.01F, 11.0F, 5.212F, 11.0F, 6.5F)
...
private var _desktopCheckmark24: ImageVector? = null
