...
public val FluentIcons.Regular.Clipboard3Day16: ImageVector
  get() {
    if (_clipboard3Day16 != null) {
      return _clipboard3Day16!!
    }
    _clipboard3Day16 = fluentIcon(name = "Regular.Clipboard3Day16", 316f) {
      materialPath {
          moveTo(5.0F, 10.5F)
          ...
          reflectiveCurveToRelative(0.5F, -0.224F, 0.5F, -0.5F)
          verticalLineToRelative(-4.0F)
          curveTo(11.0F, 6.224F, 10.776F, 6.0F, 10.5F, 6.0F)
...
private var _clipboard3Day16: ImageVector? = null
