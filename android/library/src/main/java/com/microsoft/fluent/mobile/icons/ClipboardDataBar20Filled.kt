...
public val FluentIcons.Filled.ClipboardDataBar20: ImageVector
  get() {
    if (_clipboardDataBar20 != null) {
      return _clipboardDataBar20!!
    }
    _clipboardDataBar20 = fluentIcon(name = "Filled.ClipboardDataBar20", 20f) {
      materialPath {
          moveTo(8.5F, 2.0F)
          ...
          curveToRelative(0.0F, -0.276F, 0.224F, -0.5F, 0.5F, -0.5F)
          reflectiveCurveTo(13.0F, 11.724F, 13.0F, 12.0F)
          close()
...
private var _clipboardDataBar20: ImageVector? = null
