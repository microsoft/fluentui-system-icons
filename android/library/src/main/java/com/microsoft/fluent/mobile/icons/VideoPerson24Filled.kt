...
public val FluentIcons.Filled.VideoPerson24: ImageVector
  get() {
    if (_videoPerson24 != null) {
      return _videoPerson24!!
    }
    _videoPerson24 = fluentIcon(name = "Filled.VideoPerson24", 24f) {
      materialPath {
          moveTo(19.745F, 4.0F)
...
private var _videoPerson24: ImageVector? = null
