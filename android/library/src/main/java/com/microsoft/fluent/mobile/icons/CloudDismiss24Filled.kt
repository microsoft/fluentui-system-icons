...
public val FluentIcons.Filled.CloudDismiss24: ImageVector
  get() {
    if (_cloudDismiss24 != null) {
      return _cloudDismiss24!!
    }
    _cloudDismiss24 = fluentIcon(name = "Filled.CloudDismiss24", 24f) {
      materialPath {
          moveTo(6.08F, 8.02F)
...
private var _cloudDismiss24: ImageVector? = null
