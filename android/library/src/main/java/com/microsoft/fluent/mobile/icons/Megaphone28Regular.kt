...
public val FluentIcons.Regular.Megaphone28: ImageVector
  get() {
    if (_megaphone28 != null) {
      return _megaphone28!!
    }
    _megaphone28 = fluentIcon(name = "Regular.Megaphone28", 28f) {
      materialPath {
          moveTo(26.0F, 7.353F)
          ...
          close()
          moveToRelative(-3.072F, -1.208F)
          curveTo(23.722F, 5.934F, 24.5F, 6.532F, 24.5F, 7.353F)
          verticalLineToRelative(13.293F)
          curveToRelative(0.0F, 0.822F, -0.778F, 1.42F, -1.572F, 1.208F)
          lineTo(4.432F, 16.921F)
          curveToRelative(-0.547F, -0.146F, -0.928F, -0.641F, -0.928F, -1.208F)
          verticalLineToRelative(-3.427F)
          curveToRelative(0.0F, -0.566F, 0.38F, -1.062F, 0.928F, -1.207F)
          lineToRelative(18.496F, -4.934F)
          close()
          moveToRelative(-8.856F, 14.9F)
          curveToRelative(-0.525F, 0.871F, -1.48F, 1.455F, -2.572F, 1.455F)
          curveToRelative(-1.638F, 0.0F, -2.969F, -1.312F, -3.0F, -2.941F)
