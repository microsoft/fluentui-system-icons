...
public val FluentIcons.Regular.CommentArrowRight12: ImageVector
  get() {
    if (_commentArrowRight12 != null) {
      return _commentArrowRight12!!
    }
    _commentArrowRight12 = fluentIcon(name = "Regular.CommentArrowRight12", 12f) {
      materialPath {
          moveTo(12.0F, 3.5F)
          ...
          curveTo(6.015F, 3.367F, 6.0F, 3.43F, 6.0F, 3.497F)
...
private var _commentArrowRight12: ImageVector? = null
