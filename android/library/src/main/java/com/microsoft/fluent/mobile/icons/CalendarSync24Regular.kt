...
public val FluentIcons.Regular.CalendarSync24: ImageVector
  get() {
    if (_calendarSync24 != null) {
      return _calendarSync24!!
    }
    _calendarSync24 = fluentIcon(name = "Regular.CalendarSync24", 24f) {
      materialPath {
          moveTo(17.75F, 3.0F)
...
private var _calendarSync24: ImageVector? = null
