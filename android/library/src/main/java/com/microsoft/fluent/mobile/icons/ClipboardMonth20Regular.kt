...
public val FluentIcons.Regular.ClipboardMonth20: ImageVector
  get() {
    if (_clipboardMonth20 != null) {
      return _clipboardMonth20!!
    }
    _clipboardMonth20 = fluentIcon(name = "Regular.ClipboardMonth20", 20f) {
      materialPath {
          moveTo(7.0F, 10.0F)
...
private var _clipboardMonth20: ImageVector? = null
