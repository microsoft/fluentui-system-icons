...
public val FluentIcons.Filled.TextAddT24: ImageVector
  get() {
    if (_textAddT24 != null) {
      return _textAddT24!!
    }
    _textAddT24 = fluentIcon(name = "Filled.TextAddT24", 24f) {
      materialPath {
          moveTo(3.75F, 5.0F)
          ...
          curveToRelative(-0.633F, 1.003F, -1.0F, 2.192F, -1.0F, 3.466F)
...
private var _textAddT24: ImageVector? = null
