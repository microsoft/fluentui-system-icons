...
public val FluentIcons.Filled.TextBulletListTree16: ImageVector
  get() {
    if (_textBulletListTree16 != null) {
      return _textBulletListTree16!!
    }
    _textBulletListTree16 = fluentIcon(name = "Filled.TextBulletListTree16", 16f) {
      materialPath {
          moveTo(2.25F, 5.0F)
          ...
          reflectiveCurveTo(5.06F, 11.0F, 5.75F, 11.0F)
          reflectiveCurveTo(7.0F, 11.56F, 7.0F, 12.25F)
          close()
          moveTo(5.75F, 3.0F)
