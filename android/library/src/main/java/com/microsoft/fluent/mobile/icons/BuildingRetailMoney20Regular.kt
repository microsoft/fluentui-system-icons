...
public val FluentIcons.Regular.BuildingRetailMoney20: ImageVector
  get() {
    if (_buildingRetailMoney20 != null) {
      return _buildingRetailMoney20!!
    }
    _buildingRetailMoney20 = fluentIcon(name = "Regular.BuildingRetailMoney20", 20f) {
      materialPath {
          moveTo(2.0F, 4.5F)
          ...
          curveTo(9.382F, 12.646F, 9.0F, 13.278F, 9.0F, 14.0F)
