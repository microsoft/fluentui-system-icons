...
public val FluentIcons.Filled.NotebookAdd20: ImageVector
  get() {
    if (_notebookAdd20 != null) {
      return _notebookAdd20!!
    }
    _notebookAdd20 = fluentIcon(name = "Filled.NotebookAdd20", 20f) {
      materialPath {
          moveTo(5.0F, 2.0F)
          ...
          curveToRelative(0.0F, 0.276F, -0.224F, 0.5F, -0.5F, 0.5F)
          horizontalLineToRelative(-7.0F)
          curveTo(5.224F, 7.5F, 5.0F, 7.276F, 5.0F, 7.0F)
          verticalLineTo(5.0F)
          close()
...
private var _notebookAdd20: ImageVector? = null
