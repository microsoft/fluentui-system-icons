...
public val FluentIcons.Regular.BookmarkMultiple24: ImageVector
  get() {
    if (_bookmarkMultiple24 != null) {
      return _bookmarkMultiple24!!
    }
    _bookmarkMultiple24 = fluentIcon(name = "Regular.BookmarkMultiple24", 24f) {
      materialPath {
          moveTo(4.0F, 6.748F)
          ...
          verticalLineToRelative(13.196F)
          lineToRelative(4.873F, -2.842F)
          curveToRelative(0.233F, -0.137F, 0.522F, -0.137F, 0.755F, 0.0F)
          lineToRelative(4.873F, 2.842F)
          verticalLineTo(6.748F)
          curveToRelative(0.0F, -0.414F, -0.336F, -0.75F, -0.75F, -0.75F)
          horizontalLineToRelative(-9.0F)
          close()
          moveToRelative(9.0F, -3.998F)
