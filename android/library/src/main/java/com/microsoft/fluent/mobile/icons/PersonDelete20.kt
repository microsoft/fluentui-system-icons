...
public val FluentIcons.Regular.PersonDelete20: ImageVector
  get() {
    if (_personDelete20 != null) {
      return _personDelete20!!
    }
    _personDelete20 = fluentIcon(name = "Regular.PersonDelete20", 20f) {
      materialPath {
          moveTo(5.0F, 6.0F)
          ...
          curveToRelative(0.2F, 0.0F, 0.398F, -0.005F, 0.592F, -0.015F)
...
private var _personDelete20: ImageVector? = null
