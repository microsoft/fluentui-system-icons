...
public val FluentIcons.Regular.ClipboardTask20: ImageVector
  get() {
    if (_clipboardTask20 != null) {
      return _clipboardTask20!!
    }
    _clipboardTask20 = fluentIcon(name = "Regular.ClipboardTask20", 20f) {
      materialPath {
...
private var _clipboardTask20: ImageVector? = null
