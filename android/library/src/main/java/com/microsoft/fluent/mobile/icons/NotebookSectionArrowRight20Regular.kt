...
public val FluentIcons.Regular.NotebookSectionArrowRight20: ImageVector
  get() {
    if (_notebookSectionArrowRight20 != null) {
      return _notebookSectionArrowRight20!!
    }
    _notebookSectionArrowRight20 = fluentIcon(name = "Regular.NotebookSectionArrowRight20", 20f) {
      materialPath {
          moveTo(14.0F, 2.5F)
          ...
          reflectiveCurveTo(16.985F, 19.0F, 14.5F, 19.0F)
...
private var _notebookSectionArrowRight20: ImageVector? = null
