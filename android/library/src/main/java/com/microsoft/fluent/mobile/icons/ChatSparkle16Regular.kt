...
public val FluentIcons.Regular.ChatSparkle16: ImageVector
  get() {
    if (_chatSparkle16 != null) {
      return _chatSparkle16!!
    }
    _chatSparkle16 = fluentIcon(name = "Regular.ChatSparkle16", 16f) {
      materialPath {
          ...
          curveTo(4.235F, 4.186F, 3.0F, 5.949F, 3.0F, 8.0F)
          ...
          curveToRelative(1.732F, 0.0F, 3.259F, -0.881F, 4.156F, -2.22F)
