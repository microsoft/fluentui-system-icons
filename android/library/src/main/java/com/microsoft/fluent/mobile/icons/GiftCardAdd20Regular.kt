...
public val FluentIcons.Regular.GiftCardAdd20: ImageVector
  get() {
    if (_giftCardAdd20 != null) {
      return _giftCardAdd20!!
    }
    _giftCardAdd20 = fluentIcon(name = "Regular.GiftCardAdd20", 20f) {
      materialPath {
          moveTo(2.0F, 4.75F)
...
private var _giftCardAdd20: ImageVector? = null
