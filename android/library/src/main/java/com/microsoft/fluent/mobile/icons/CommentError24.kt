...
public val FluentIcons.Regular.CommentError24: ImageVector
  get() {
    if (_commentError24 != null) {
      return _commentError24!!
    }
    _commentError24 = fluentIcon(name = "Regular.CommentError24", 24f) {
      materialPath {
          moveTo(23.0F, 6.5F)
          ...
          close()
          moveTo(17.5F, 3.0F)
          curveTo(17.224F, 3.0F, 17.0F, 3.224F, 17.0F, 3.5F)
...
private var _commentError24: ImageVector? = null
