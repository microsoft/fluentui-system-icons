...
public val FluentIcons.Filled.ListBarTree16: ImageVector
  get() {
    if (_listBarTree16 != null) {
      return _listBarTree16!!
    }
    _listBarTree16 = fluentIcon(name = "Filled.ListBarTree16", 16f) {
      materialPath {
          moveTo(6.0F, 5.0F)
          ...
          verticalLineToRelative(-0.5F)
          curveTo(4.0F, 11.56F, 4.56F, 11.0F, 5.25F, 11.0F)
          close()        
      }
    }
    return _listBarTree16!!
...
private var _listBarTree16: ImageVector? = null
