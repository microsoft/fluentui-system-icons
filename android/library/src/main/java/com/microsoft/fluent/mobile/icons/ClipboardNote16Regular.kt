...
public val FluentIcons.Regular.ClipboardNote16: ImageVector
  get() {
    if (_clipboardNote16 != null) {
      return _clipboardNote16!!
    }
    _clipboardNote16 = fluentIcon(name = "Regular.ClipboardNote16", 16f) {
      materialPath {
          moveTo(5.085F, 2.0F)
          ...
          curveToRelative(0.132F, 0.373F, 0.336F, 0.711F, 0.594F, 1.0F)
          horizontalLineTo(4.5F)
          ...
          close()
          moveTo(8.0F, 7.0F)
          curveTo(6.895F, 7.0F, 6.0F, 7.895F, 6.0F, 9.0F)
...
private var _clipboardNote16: ImageVector? = null
