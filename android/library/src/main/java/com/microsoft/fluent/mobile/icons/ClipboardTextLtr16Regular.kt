...
public val FluentIcons.Regular.ClipboardTextLtr16: ImageVector
  get() {
    if (_clipboardTextLtr16 != null) {
      return _clipboardTextLtr16!!
    }
    _clipboardTextLtr16 = fluentIcon(name = "Regular.ClipboardTextLtr16", 16f) {
      materialPath {
          moveTo(6.5F, 1.0F)
          ...
          moveTo(4.5F, 3.0F)
          horizontalLineToRelative(0.585F)
          curveTo(5.291F, 3.583F, 5.847F, 4.0F, 6.5F, 4.0F)
          horizontalLineToRelative(3.0F)
          ...
          curveTo(7.776F, 8.5F, 8.0F, 8.724F, 8.0F, 9.0F)
...
private var _clipboardTextLtr16: ImageVector? = null
