...
public val FluentIcons.Filled.VideoPerson32: ImageVector
  get() {
    if (_videoPerson32 != null) {
      return _videoPerson32!!
    }
    _videoPerson32 = fluentIcon(name = "Filled.VideoPerson32", 32f) {
      materialPath {
          moveTo(2.0F, 7.25F)
...
private var _videoPerson32: ImageVector? = null
