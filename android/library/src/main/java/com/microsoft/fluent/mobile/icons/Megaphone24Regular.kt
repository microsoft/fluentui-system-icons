...
public val FluentIcons.Regular.Megaphone24: ImageVector
  get() {
    if (_megaphone24 != null) {
      return _megaphone24!!
    }
    _megaphone24 = fluentIcon(name = "Regular.Megaphone24", 24f) {
      materialPath {
          ...
          close()
          moveToRelative(12.037F, -10.9F)
          lineToRelative(-15.5F, 4.605F)
          curveTo(3.718F, 10.245F, 3.5F, 10.537F, 3.5F, 10.87F)
          verticalLineToRelative(2.261F)
          curveToRelative(0.0F, 0.332F, 0.218F, 0.625F, 0.536F, 0.72F)
          lineToRelative(15.5F, 4.607F)
          curveToRelative(0.07F, 0.02F, 0.142F, 0.03F, 0.214F, 0.03F)
          curveToRelative(0.414F, 0.0F, 0.75F, -0.335F, 0.75F, -0.75F)
          verticalLineTo(6.264F)
          curveToRelative(0.0F, -0.072F, -0.01F, -0.144F, -0.031F, -0.213F)
          curveToRelative(-0.118F, -0.397F, -0.536F, -0.624F, -0.933F, -0.506F)
          close()        
      }
    }
    return _megaphone24!!
