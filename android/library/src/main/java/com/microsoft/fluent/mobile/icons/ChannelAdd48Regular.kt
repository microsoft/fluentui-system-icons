...
public val FluentIcons.Regular.ChannelAdd48: ImageVector
  get() {
    if (_channelAdd48 != null) {
      return _channelAdd48!!
    }
    _channelAdd48 = fluentIcon(name = "Regular.ChannelAdd48", 48f) {
      materialPath {
          moveTo(7.5F, 10.5F)
...
private var _channelAdd48: ImageVector? = null
