...
public val FluentIcons.Filled.VideoPersonCall16: ImageVector
  get() {
    if (_videoPersonCall16 != null) {
      return _videoPersonCall16!!
    }
    _videoPersonCall16 = fluentIcon(name = "Filled.VideoPersonCall16", 16f) {
      materialPath {
          moveTo(10.0F, 7.0F)
          ...
          curveToRelative(0.453F, 0.0F, 0.835F, 0.3F, 0.958F, 0.714F)
          curveToRelative(-0.68F, -0.103F, -1.377F, 0.142F, -1.841F, 0.66F)
          lineToRelative(-0.545F, 0.608F)
          curveTo(8.302F, 12.283F, 8.13F, 12.635F, 8.05F, 13.0F)
          horizontalLineToRelative(-5.3F)
          curveTo(1.784F, 13.0F, 1.0F, 12.216F, 1.0F, 11.25F)
          verticalLineToRelative(-6.5F)
          close()
          moveToRelative(11.584F, 2.831F)
...
private var _videoPersonCall16: ImageVector? = null
