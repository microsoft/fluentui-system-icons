...
public val FluentIcons.Regular.DocumentHeaderDismiss20: ImageVector
  get() {
    if (_documentHeaderDismiss20 != null) {
      return _documentHeaderDismiss20!!
    }
    _documentHeaderDismiss20 = fluentIcon(name = "Regular.DocumentHeaderDismiss20", 20f) {
      materialPath {
          moveTo(6.0F, 2.0F)
...
private var _documentHeaderDismiss20: ImageVector? = null
