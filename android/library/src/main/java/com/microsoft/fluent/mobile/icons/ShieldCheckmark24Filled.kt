...
public val FluentIcons.Filled.ShieldCheckmark24: ImageVector
  get() {
    if (_shieldCheckmark24 != null) {
      return _shieldCheckmark24!!
    }
    _shieldCheckmark24 = fluentIcon(name = "Filled.ShieldCheckmark24", 24f) {
      materialPath {
          moveTo(3.0F, 5.75F)
          ...
          curveTo(19.957F, 11.366F, 18.77F, 11.0F, 17.5F, 11.0F)
          curveToRelative(-3.59F, 0.0F, -6.5F, 2.91F, -6.5F, 6.5F)
          curveToRelative(0.0F, 1.651F, 0.616F, 3.158F, 1.63F, 4.305F)
