...
public val FluentIcons.Regular.ClipboardMore20: ImageVector
  get() {
    if (_clipboardMore20 != null) {
      return _clipboardMore20!!
    }
    _clipboardMore20 = fluentIcon(name = "Regular.ClipboardMore20", 20f) {
      materialPath {
          moveTo(7.085F, 3.0F)
          ...
          curveToRelative(-0.429F, 0.213F, -0.78F, 0.56F, -1.0F, 0.984F)
          verticalLineTo(4.5F)
          ...
          curveToRelative(0.0F, 0.36F, 0.084F, 0.699F, 0.234F, 1.0F)
          horizontalLineTo(5.5F)
...
private var _clipboardMore20: ImageVector? = null
