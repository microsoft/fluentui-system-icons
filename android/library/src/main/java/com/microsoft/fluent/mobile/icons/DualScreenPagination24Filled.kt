...
public val FluentIcons.Filled.DualScreenPagination24: ImageVector
  get() {
    if (_dualScreenPagination24 != null) {
      return _dualScreenPagination24!!
    }
    _dualScreenPagination24 = fluentIcon(name = "Filled.DualScreenPagination24", 24f) {
      materialPath {
...
private var _dualScreenPagination24: ImageVector? = null
