...
public val FluentIcons.Regular.Subtitles20: ImageVector
  get() {
    if (_subtitles20 != null) {
      return _subtitles20!!
    }
    _subtitles20 = fluentIcon(name = "Regular.Subtitles20", 20f) {
      materialPath {
          moveTo(2.0F, 6.75F)
          ...
          curveToRelative(0.276F, 0.0F, 0.5F, 0.224F, 0.5F, 0.5F)
          reflectiveCurveTo(15.776F, 12.0F, 15.5F, 12.0F)
          horizontalLineToRelative(-2.0F)
          curveToRelative(-0.276F, 0.0F, -0.5F, -0.224F, -0.5F, -0.5F)
          close()
          moveTo(9.5F, 13.0F)
...
private var _subtitles20: ImageVector? = null
