...
public val FluentIcons.Filled.ShieldAdd24: ImageVector
  get() {
    if (_shieldAdd24 != null) {
      return _shieldAdd24!!
    }
    _shieldAdd24 = fluentIcon(name = "Filled.ShieldAdd24", 24f) {
      materialPath {
          moveTo(3.0F, 5.75F)
...
private var _shieldAdd24: ImageVector? = null
