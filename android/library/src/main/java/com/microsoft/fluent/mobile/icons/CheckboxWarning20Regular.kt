...
public val FluentIcons.Regular.CheckboxWarning20: ImageVector
  get() {
    if (_checkboxWarning20 != null) {
      return _checkboxWarning20!!
    }
    _checkboxWarning20 = fluentIcon(name = "Regular.CheckboxWarning20", 20f) {
      materialPath {
          moveTo(6.0F, 3.0F)
          ...
          curveToRelative(0.112F, 0.127F, 0.21F, 0.273F, 0.293F, 0.437F)
          lineTo(17.0F, 11.521F)
          verticalLineTo(6.0F)
          curveToRelative(0.0F, -1.657F, -1.343F, -3.0F, -3.0F, -3.0F)
          horizontalLineTo(6.0F)
          close()
          ...
          curveTo(9.774F, 18.217F, 10.258F, 19.0F, 11.002F, 19.0F)
...
private var _checkboxWarning20: ImageVector? = null
