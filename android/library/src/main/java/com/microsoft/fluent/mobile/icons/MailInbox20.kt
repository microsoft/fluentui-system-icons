...
public val FluentIcons.Regular.MailInbox20: ImageVector
  get() {
    if (_mailInbox20 != null) {
      return _mailInbox20!!
    }
    _mailInbox20 = fluentIcon(name = "Regular.MailInbox20", 20f) {
      materialPath {
          moveTo(6.0F, 3.0F)
          ...
          curveTo(8.0F, 10.223F, 7.776F, 10.0F, 7.5F, 10.0F)
          ...
          curveTo(8.72F, 13.32F, 9.287F, 13.5F, 10.0F, 13.5F)
