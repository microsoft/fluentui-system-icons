...
public val FluentIcons.Regular.DualScreenVerticalScroll20: ImageVector
  get() {
    if (_dualScreenVerticalScroll20 != null) {
      return _dualScreenVerticalScroll20!!
    }
    _dualScreenVerticalScroll20 = fluentIcon(name = "Regular.DualScreenVerticalScroll20", 20f) {
      materialPath {
          moveTo(4.0F, 4.0F)
