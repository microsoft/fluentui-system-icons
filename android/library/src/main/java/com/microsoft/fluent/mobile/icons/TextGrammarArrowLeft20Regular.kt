...
public val FluentIcons.Regular.TextGrammarArrowLeft20: ImageVector
  get() {
    if (_textGrammarArrowLeft20 != null) {
      return _textGrammarArrowLeft20!!
    }
    _textGrammarArrowLeft20 = fluentIcon(name = "Regular.TextGrammarArrowLeft20", 20f) {
      materialPath {
          moveTo(2.5F, 5.0F)
          ...
          curveTo(7.986F, 14.633F, 8.0F, 14.57F, 8.0F, 14.503F)
...
private var _textGrammarArrowLeft20: ImageVector? = null
