...
public val FluentIcons.Regular.CalendarError24: ImageVector
  get() {
    if (_calendarError24 != null) {
      return _calendarError24!!
    }
    _calendarError24 = fluentIcon(name = "Regular.CalendarError24", 24f) {
      materialPath {
          moveTo(17.75F, 3.0F)
...
private var _calendarError24: ImageVector? = null
