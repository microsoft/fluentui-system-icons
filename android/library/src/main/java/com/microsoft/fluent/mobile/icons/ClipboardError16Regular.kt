...
public val FluentIcons.Regular.ClipboardError16: ImageVector
  get() {
    if (_clipboardError16 != null) {
      return _clipboardError16!!
    }
    _clipboardError16 = fluentIcon(name = "Regular.ClipboardError16", 16f) {
      materialPath {
          moveTo(5.085F, 2.0F)
...
private var _clipboardError16: ImageVector? = null
