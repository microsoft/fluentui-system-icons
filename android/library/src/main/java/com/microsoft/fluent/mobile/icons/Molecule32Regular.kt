...
public val FluentIcons.Regular.Molecule32: ImageVector
  get() {
    if (_molecule32 != null) {
      return _molecule32!!
    }
    _molecule32 = fluentIcon(name = "Regular.Molecule32", 32f) {
      materialPath {
          moveTo(22.0F, 16.0F)
          ...
          close()
          moveTo(8.5F, 21.0F)
          curveTo(6.567F, 21.0F, 5.0F, 19.433F, 5.0F, 17.5F)
          reflectiveCurveTo(6.567F, 14.0F, 8.5F, 14.0F)
          reflectiveCurveToRelative(3.5F, 1.567F, 3.5F, 3.5F)
          reflectiveCurveTo(10.433F, 21.0F, 8.5F, 21.0F)
          close()
          moveTo(24.0F, 25.5F)
          curveToRelative(0.0F, 1.38F, -1.12F, 2.5F, -2.5F, 2.5F)
          reflectiveCurveTo(19.0F, 26.88F, 19.0F, 25.5F)
