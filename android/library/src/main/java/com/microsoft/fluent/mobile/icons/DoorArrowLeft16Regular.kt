...
public val FluentIcons.Regular.DoorArrowLeft16: ImageVector
  get() {
    if (_doorArrowLeft16 != null) {
      return _doorArrowLeft16!!
    }
    _doorArrowLeft16 = fluentIcon(name = "Regular.DoorArrowLeft16", 16f) {
      materialPath {
          moveTo(4.75F, 1.0F)
          curveTo(3.784F, 1.0F, 3.0F, 1.784F, 3.0F, 2.75F)
          verticalLineToRelative(10.5F)
          curveTo(3.0F, 14.216F, 3.784F, 15.0F, 4.75F, 15.0F)
          horizontalLineToRelative(2.507F)
          ...
          reflectiveCurveTo(5.0F, 8.552F, 5.0F, 8.0F)
...
private var _doorArrowLeft16: ImageVector? = null
