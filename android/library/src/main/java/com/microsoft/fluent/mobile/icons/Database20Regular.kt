...
public val FluentIcons.Regular.Database20: ImageVector
  get() {
    if (_database20 != null) {
      return _database20!!
    }
    _database20 = fluentIcon(name = "Regular.Database20", 20f) {
      materialPath {
          moveTo(4.0F, 5.0F)
          ...
          curveToRelative(0.0F, 1.007F, -0.875F, 1.755F, -1.904F, 2.223F)
          curveTo(13.022F, 17.71F, 11.573F, 18.0F, 10.0F, 18.0F)
          reflectiveCurveToRelative(-3.022F, -0.289F, -4.096F, -0.777F)
          ...
          curveToRelative(0.0F, 0.374F, 0.356F, 0.875F, 1.318F, 1.313F)
          curveTo(7.234F, 16.729F, 8.536F, 17.0F, 10.0F, 17.0F)
          reflectiveCurveToRelative(2.766F, -0.27F, 3.682F, -0.687F)
          curveTo(14.644F, 15.875F, 15.0F, 15.373F, 15.0F, 15.0F)
