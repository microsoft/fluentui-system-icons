...
public val FluentIcons.Filled.DoorArrowRight16: ImageVector
  get() {
    if (_doorArrowRight16 != null) {
      return _doorArrowRight16!!
    }
    _doorArrowRight16 = fluentIcon(name = "Filled.DoorArrowRight16", 16f) {
      materialPath {
          moveTo(3.0F, 2.75F)
          ...
          curveTo(13.986F, 11.367F, 14.0F, 11.43F, 14.0F, 11.497F)
...
private var _doorArrowRight16: ImageVector? = null
