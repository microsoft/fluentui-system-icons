...
public val FluentIcons.Regular.CommentCheckmark20: ImageVector
  get() {
    if (_commentCheckmark20 != null) {
      return _commentCheckmark20!!
    }
    _commentCheckmark20 = fluentIcon(name = "Regular.CommentCheckmark20", 20f) {
      materialPath {
          moveTo(19.0F, 5.5F)
          ...
          curveTo(9.438F, 3.317F, 9.306F, 3.651F, 9.207F, 4.0F)
          horizontalLineTo(4.6F)
          curveTo(3.704F, 4.0F, 3.0F, 4.713F, 3.0F, 5.566F)
          verticalLineToRelative(6.71F)
