...
public val FluentIcons.Filled.ViewDesktop20: ImageVector
  get() {
    if (_viewDesktop20 != null) {
      return _viewDesktop20!!
    }
    _viewDesktop20 = fluentIcon(name = "Filled.ViewDesktop20", 20f) {
      materialPath {
          moveTo(1.962F, 4.5F)
...
private var _viewDesktop20: ImageVector? = null
