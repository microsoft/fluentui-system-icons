...
public val FluentIcons.Regular.TextDescription20: ImageVector
  get() {
    if (_textDescription20 != null) {
      return _textDescription20!!
    }
    _textDescription20 = fluentIcon(name = "Regular.TextDescription20", 20f) {
      materialPath {
          moveTo(2.5F, 5.0F)
...
private var _textDescription20: ImageVector? = null
