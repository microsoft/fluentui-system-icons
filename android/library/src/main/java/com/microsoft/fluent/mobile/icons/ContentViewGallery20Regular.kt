...
public val FluentIcons.Regular.ContentViewGallery20: ImageVector
  get() {
    if (_contentViewGallery20 != null) {
      return _contentViewGallery20!!
    }
    _contentViewGallery20 = fluentIcon(name = "Regular.ContentViewGallery20", 20f) {
      materialPath {
          moveTo(6.0F, 6.0F)
...
private var _contentViewGallery20: ImageVector? = null
