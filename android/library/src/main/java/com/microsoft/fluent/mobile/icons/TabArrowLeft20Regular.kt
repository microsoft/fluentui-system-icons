...
public val FluentIcons.Regular.TabArrowLeft20: ImageVector
  get() {
    if (_tabArrowLeft20 != null) {
      return _tabArrowLeft20!!
    }
    _tabArrowLeft20 = fluentIcon(name = "Regular.TabArrowLeft20", 20f) {
      materialPath {
          moveTo(3.0F, 5.5F)
...
private var _tabArrowLeft20: ImageVector? = null
