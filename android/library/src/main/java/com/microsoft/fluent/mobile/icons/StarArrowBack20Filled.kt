...
public val FluentIcons.Filled.StarArrowBack20: ImageVector
  get() {
    if (_starArrowBack20 != null) {
      return _starArrowBack20!!
    }
    _starArrowBack20 = fluentIcon(name = "Filled.StarArrowBack20", 20f) {
      materialPath {
          ...
          curveTo(16.364F, 9.246F, 15.461F, 9.0F, 14.5F, 9.0F)
          curveTo(11.462F, 9.0F, 9.0F, 11.462F, 9.0F, 14.5F)
          curveToRelative(0.0F, 0.498F, 0.066F, 0.98F, 0.19F, 1.438F)
...
private var _starArrowBack20: ImageVector? = null
