...
public val FluentIcons.Regular.PanelLeftTextAdd24: ImageVector
  get() {
    if (_panelLeftTextAdd24 != null) {
      return _panelLeftTextAdd24!!
    }
    _panelLeftTextAdd24 = fluentIcon(name = "Regular.PanelLeftTextAdd24", 24f) {
      materialPath {
          moveTo(4.75F, 8.5F)
...
private var _panelLeftTextAdd24: ImageVector? = null
