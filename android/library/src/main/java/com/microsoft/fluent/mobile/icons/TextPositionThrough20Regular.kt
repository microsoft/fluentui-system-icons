...
public val FluentIcons.Regular.TextPositionThrough20: ImageVector
  get() {
    if (_textPositionThrough20 != null) {
      return _textPositionThrough20!!
    }
    _textPositionThrough20 = fluentIcon(name = "Regular.TextPositionThrough20", 20f) {
      materialPath {
          moveTo(3.0F, 3.5F)
          ...
          curveToRelative(-0.126F, -0.356F, -0.295F, -0.691F, -0.502F, -1.0F)
...
private var _textPositionThrough20: ImageVector? = null
