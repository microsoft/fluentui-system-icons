...
public val FluentIcons.Regular.AlignSpaceEvenlyHorizontal20: ImageVector
  get() {
    if (_alignSpaceEvenlyHorizontal20 != null) {
      return _alignSpaceEvenlyHorizontal20!!
    }
    _alignSpaceEvenlyHorizontal20 = fluentIcon(name = "Regular.AlignSpaceEvenlyHorizontal20", 20f) {
      materialPath {
          moveTo(3.0F, 16.0F)
          ...
          curveToRelative(0.0F, -0.552F, -0.448F, -1.0F, -1.0F, -1.0F)
          horizontalLineTo(9.0F)
          curveTo(8.448F, 5.0F, 8.0F, 5.448F, 8.0F, 6.0F)
          verticalLineToRelative(8.0F)
          close()
          moveToRelative(7.0F, 2.0F)
          curveToRelative(-1.105F, 0.0F, -2.0F, -0.895F, -2.0F, -2.0F)
