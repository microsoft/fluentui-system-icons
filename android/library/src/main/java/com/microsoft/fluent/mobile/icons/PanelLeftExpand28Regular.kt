...
public val FluentIcons.Regular.PanelLeftExpand28: ImageVector
  get() {
    if (_panelLeftExpand28 != null) {
      return _panelLeftExpand28!!
    }
    _panelLeftExpand28 = fluentIcon(name = "Regular.PanelLeftExpand28", 28f) {
      materialPath {
