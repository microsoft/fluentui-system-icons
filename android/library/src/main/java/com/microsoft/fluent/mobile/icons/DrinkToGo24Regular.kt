...
public val FluentIcons.Regular.DrinkToGo24: ImageVector
  get() {
    if (_drinkToGo24 != null) {
      return _drinkToGo24!!
    }
    _drinkToGo24 = fluentIcon(name = "Regular.DrinkToGo24", 24f) {
      materialPath {
          moveTo(15.72F, 2.22F)
          ...
          close()
          moveToRelative(0.717F, 7.28F)
          horizontalLineTo(7.563F)
          lineToRelative(1.555F, 9.837F)
          curveTo(9.217F, 20.032F, 9.81F, 20.5F, 10.602F, 20.5F)
          horizontalLineTo(13.4F)
          curveToRelative(0.792F, 0.0F, 1.385F, -0.468F, 1.486F, -1.174F)
          lineTo(16.437F, 9.5F)
          close()
          moveTo(17.222F, 6.0F)
