...
public val FluentIcons.Filled.TableInsertColumn16: ImageVector
  get() {
    if (_tableInsertColumn16 != null) {
      return _tableInsertColumn16!!
    }
    _tableInsertColumn16 = fluentIcon(name = "Filled.TableInsertColumn16", 16f) {
      materialPath {
          moveTo(3.0F, 2.5F)
          ...
          horizontalLineToRelative(-3.0F)
          curveTo(5.672F, 14.0F, 5.0F, 13.328F, 5.0F, 12.5F)
