...
public val FluentIcons.Regular.CalendarLtr20: ImageVector
  get() {
    if (_calendarLtr20 != null) {
      return _calendarLtr20!!
    }
    _calendarLtr20 = fluentIcon(name = "Regular.CalendarLtr20", 20f) {
      materialPath {
          moveTo(7.0F, 11.0F)
...
private var _calendarLtr20: ImageVector? = null
