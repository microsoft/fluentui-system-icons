...
public val FluentIcons.Filled.CheckboxArrowRight20: ImageVector
  get() {
    if (_checkboxArrowRight20 != null) {
      return _checkboxArrowRight20!!
    }
    _checkboxArrowRight20 = fluentIcon(name = "Filled.CheckboxArrowRight20", 20f) {
      materialPath {
          moveTo(5.0F, 2.0F)
...
private var _checkboxArrowRight20: ImageVector? = null
