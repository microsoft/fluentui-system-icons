...
public val FluentIcons.Regular.MailDismiss20: ImageVector
  get() {
    if (_mailDismiss20 != null) {
      return _mailDismiss20!!
    }
    _mailDismiss20 = fluentIcon(name = "Regular.MailDismiss20", 20f) {
      materialPath {
          moveTo(19.0F, 5.5F)
...
private var _mailDismiss20: ImageVector? = null
