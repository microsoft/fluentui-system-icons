...
public val FluentIcons.Regular.MailError24: ImageVector
  get() {
    if (_mailError24 != null) {
      return _mailError24!!
    }
    _mailError24 = fluentIcon(name = "Regular.MailError24", 24f) {
      materialPath {
          moveTo(23.0F, 6.5F)
...
private var _mailError24: ImageVector? = null
