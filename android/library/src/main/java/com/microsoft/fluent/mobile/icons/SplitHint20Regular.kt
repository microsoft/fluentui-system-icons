...
public val FluentIcons.Regular.SplitHint20: ImageVector
  get() {
    if (_splitHint20 != null) {
      return _splitHint20!!
    }
    _splitHint20 = fluentIcon(name = "Regular.SplitHint20", 20f) {
      materialPath {
          moveTo(9.5F, 2.0F)
...
private var _splitHint20: ImageVector? = null
