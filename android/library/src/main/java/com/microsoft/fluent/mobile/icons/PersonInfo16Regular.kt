...
public val FluentIcons.Regular.PersonInfo16: ImageVector
  get() {
    if (_personInfo16 != null) {
      return _personInfo16!!
    }
    _personInfo16 = fluentIcon(name = "Regular.PersonInfo16", 16f) {
      materialPath {
          moveTo(2.0F, 10.0F)
          ...
          reflectiveCurveTo(7.0F, 12.433F, 7.0F, 10.5F)
...
private var _personInfo16: ImageVector? = null
