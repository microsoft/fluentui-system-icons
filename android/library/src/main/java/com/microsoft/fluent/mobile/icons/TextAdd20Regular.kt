...
public val FluentIcons.Regular.TextAdd20: ImageVector
  get() {
    if (_textAdd20 != null) {
      return _textAdd20!!
    }
    _textAdd20 = fluentIcon(name = "Regular.TextAdd20", 20f) {
      materialPath {
          moveTo(3.0F, 3.5F)
          ...
          reflectiveCurveTo(6.224F, 16.0F, 6.5F, 16.0F)
...
private var _textAdd20: ImageVector? = null
