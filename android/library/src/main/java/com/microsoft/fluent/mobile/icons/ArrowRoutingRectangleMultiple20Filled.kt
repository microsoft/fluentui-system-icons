...
public val FluentIcons.Filled.ArrowRoutingRectangleMultiple20: ImageVector
  get() {
    if (_arrowRoutingRectangleMultiple20 != null) {
      return _arrowRoutingRectangleMultiple20!!
    }
    _arrowRoutingRectangleMultiple20 = fluentIcon(name = "Filled.ArrowRoutingRectangleMultiple20", 20f) {
      materialPath {
          moveTo(11.0F, 12.5F)
