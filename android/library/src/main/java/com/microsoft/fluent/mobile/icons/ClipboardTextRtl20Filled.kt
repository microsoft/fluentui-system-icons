...
public val FluentIcons.Filled.ClipboardTextRtl20: ImageVector
  get() {
    if (_clipboardTextRtl20 != null) {
      return _clipboardTextRtl20!!
    }
    _clipboardTextRtl20 = fluentIcon(name = "Filled.ClipboardTextRtl20", 20f) {
      materialPath {
          moveTo(7.085F, 3.0F)
...
private var _clipboardTextRtl20: ImageVector? = null
