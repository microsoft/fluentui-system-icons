...
public val FluentIcons.Regular.DesktopToolbox24: ImageVector
  get() {
    if (_desktopToolbox24 != null) {
      return _desktopToolbox24!!
    }
    _desktopToolbox24 = fluentIcon(name = "Regular.DesktopToolbox24", 24f) {
      materialPath {
          moveTo(6.75F, 22.0F)
          ...
          curveToRelative(0.0F, 0.172F, 0.017F, 0.339F, 0.05F, 0.5F)
          ...
          reflectiveCurveTo(16.0F, 20.665F, 16.0F, 20.25F)
...
private var _desktopToolbox24: ImageVector? = null
