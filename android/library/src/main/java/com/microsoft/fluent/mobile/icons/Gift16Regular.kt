...
public val FluentIcons.Regular.Gift16: ImageVector
  get() {
    if (_gift16 != null) {
      return _gift16!!
    }
    _gift16 = fluentIcon(name = "Regular.Gift16", 16f) {
      materialPath {
          moveTo(6.0F, 2.0F)
          curveToRelative(0.597F, 0.0F, 1.133F, 0.262F, 1.5F, 0.677F)
          curveTo(7.867F, 2.262F, 8.403F, 2.0F, 9.0F, 2.0F)
          ...
          curveTo(4.098F, 4.706F, 4.0F, 4.364F, 4.0F, 4.0F)
