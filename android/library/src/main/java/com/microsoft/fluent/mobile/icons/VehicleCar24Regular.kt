...
public val FluentIcons.Regular.VehicleCar24: ImageVector
  get() {
    if (_vehicleCar24 != null) {
      return _vehicleCar24!!
    }
    _vehicleCar24 = fluentIcon(name = "Regular.VehicleCar24", 24f) {
      materialPath {
          moveTo(15.8F, 3.0F)
          curveToRelative(1.49F, 0.0F, 2.79F, 1.014F, 3.152F, 2.46F)
          lineTo(19.337F, 7.0F)
...
private var _vehicleCar24: ImageVector? = null
