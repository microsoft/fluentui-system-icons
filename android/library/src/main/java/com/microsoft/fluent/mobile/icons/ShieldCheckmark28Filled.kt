...
public val FluentIcons.Filled.ShieldCheckmark28: ImageVector
  get() {
    if (_shieldCheckmark28 != null) {
      return _shieldCheckmark28!!
    }
    _shieldCheckmark28 = fluentIcon(name = "Filled.ShieldCheckmark28", 28f) {
      materialPath {
          ...
          curveToRelative(0.0F, 0.162F, -0.005F, 0.324F, -0.015F, 0.485F)
          curveTo(23.733F, 13.553F, 22.181F, 13.0F, 20.5F, 13.0F)
          curveToRelative(-4.142F, 0.0F, -7.5F, 3.358F, -7.5F, 7.5F)
          curveToRelative(0.0F, 2.036F, 0.811F, 3.882F, 2.128F, 5.234F)
          curveToRelative(-0.342F, 0.104F, -0.676F, 0.185F, -1.0F, 0.242F)
...
private var _shieldCheckmark28: ImageVector? = null
