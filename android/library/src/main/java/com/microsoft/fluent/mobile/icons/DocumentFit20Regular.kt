...
public val FluentIcons.Regular.DocumentFit20: ImageVector
  get() {
    if (_documentFit20 != null) {
      return _documentFit20!!
    }
    _documentFit20 = fluentIcon(name = "Regular.DocumentFit20", 20f) {
      materialPath {
          moveTo(6.0F, 2.0F)
          ...
          verticalLineToRelative(-1.0F)
          curveTo(7.0F, 13.224F, 6.776F, 13.0F, 6.5F, 13.0F)
...
private var _documentFit20: ImageVector? = null
