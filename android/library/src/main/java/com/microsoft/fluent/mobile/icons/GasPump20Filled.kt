...
public val FluentIcons.Filled.GasPump20: ImageVector
  get() {
    if (_gasPump20 != null) {
      return _gasPump20!!
    }
    _gasPump20 = fluentIcon(name = "Filled.GasPump20", 20f) {
      materialPath {
          moveTo(4.0F, 17.0F)
          verticalLineTo(4.5F)
          ...
          curveToRelative(0.0F, -0.325F, -0.105F, -0.64F, -0.3F, -0.9F)
          lineTo(15.6F, 6.8F)
...
private var _gasPump20: ImageVector? = null
