...
public val FluentIcons.Filled.DatabaseArrowUp20: ImageVector
  get() {
    if (_databaseArrowUp20 != null) {
      return _databaseArrowUp20!!
    }
    _databaseArrowUp20 = fluentIcon(name = "Filled.DatabaseArrowUp20", 20f) {
      materialPath {
          moveTo(10.0F, 8.0F)
          ...
          curveToRelative(0.0F, 1.328F, 0.47F, 2.547F, 1.255F, 3.497F)
          lineTo(10.0F, 18.0F)
          curveToRelative(-3.314F, 0.0F, -6.0F, -1.343F, -6.0F, -3.0F)
