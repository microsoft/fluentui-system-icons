...
public val FluentIcons.Regular.CheckboxPerson24: ImageVector
  get() {
    if (_checkboxPerson24 != null) {
      return _checkboxPerson24!!
    }
    _checkboxPerson24 = fluentIcon(name = "Regular.CheckboxPerson24", 24f) {
      materialPath {
          moveTo(6.25F, 3.0F)
...
private var _checkboxPerson24: ImageVector? = null
