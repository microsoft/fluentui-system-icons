...
public val FluentIcons.Regular.PersonMail16: ImageVector
  get() {
    if (_personMail16 != null) {
      return _personMail16!!
    }
    _personMail16 = fluentIcon(name = "Regular.PersonMail16", 16f) {
      materialPath {
          moveTo(2.0F, 10.0F)
          curveToRelative(0.0F, 1.507F, 1.086F, 3.047F, 3.0F, 3.69F)
          verticalLineToRelative(-1.068F)
          curveTo(3.7F, 12.072F, 3.0F, 11.005F, 3.0F, 10.0F)
          verticalLineTo(9.5F)
