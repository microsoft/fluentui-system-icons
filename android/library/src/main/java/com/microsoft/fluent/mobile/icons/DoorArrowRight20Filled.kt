...
public val FluentIcons.Filled.DoorArrowRight20: ImageVector
  get() {
    if (_doorArrowRight20 != null) {
      return _doorArrowRight20!!
    }
    _doorArrowRight20 = fluentIcon(name = "Filled.DoorArrowRight20", 20f) {
      materialPath {
          moveTo(6.0F, 2.5F)
          ...
          curveTo(9.326F, 16.637F, 9.0F, 15.607F, 9.0F, 14.5F)
...
private var _doorArrowRight20: ImageVector? = null
