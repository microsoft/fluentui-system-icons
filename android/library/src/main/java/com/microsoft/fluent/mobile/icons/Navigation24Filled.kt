...
public val FluentIcons.Filled.Navigation24: ImageVector
  get() {
    if (_navigation24 != null) {
      return _navigation24!!
    }
    _navigation24 = fluentIcon(name = "Filled.Navigation24", 24f) {
      materialPath {
          moveTo(3.0F, 17.0F)
...
private var _navigation24: ImageVector? = null
