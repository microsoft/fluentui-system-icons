...
public val FluentIcons.Filled.ReadingModeMobile20: ImageVector
  get() {
    if (_readingModeMobile20 != null) {
      return _readingModeMobile20!!
    }
    _readingModeMobile20 = fluentIcon(name = "Filled.ReadingModeMobile20", 20f) {
      materialPath {
          moveTo(4.0F, 3.5F)
...
private var _readingModeMobile20: ImageVector? = null
