...
public val FluentIcons.Regular.VideoPersonStar24: ImageVector
  get() {
    if (_videoPersonStar24 != null) {
      return _videoPersonStar24!!
    }
    _videoPersonStar24 = fluentIcon(name = "Regular.VideoPersonStar24", 24f) {
      materialPath {
          moveTo(19.745F, 4.0F)
          ...
          curveToRelative(0.081F, 0.523F, 0.225F, 1.026F, 0.423F, 1.5F)
          horizontalLineTo(4.25F)
          curveToRelative(-1.243F, 0.0F, -2.25F, -1.007F, -2.25F, -2.25F)
          verticalLineTo(6.25F)
          ...
          curveToRelative(-0.174F, -0.56F, -0.936F, -0.56F, -1.11F, 0.0F)
...
private var _videoPersonStar24: ImageVector? = null
