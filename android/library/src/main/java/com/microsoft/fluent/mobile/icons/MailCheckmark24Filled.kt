...
public val FluentIcons.Filled.MailCheckmark24: ImageVector
  get() {
    if (_mailCheckmark24 != null) {
      return _mailCheckmark24!!
    }
    _mailCheckmark24 = fluentIcon(name = "Filled.MailCheckmark24", 24f) {
      materialPath {
          moveTo(23.0F, 6.5F)
...
private var _mailCheckmark24: ImageVector? = null
