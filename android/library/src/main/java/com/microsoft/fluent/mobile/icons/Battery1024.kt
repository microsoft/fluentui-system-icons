...
public val FluentIcons.Regular.Battery1024: ImageVector
  get() {
    if (_battery1024 != null) {
      return _battery1024!!
    }
    _battery1024 = fluentIcon(name = "Regular.Battery1024", 1024f) {
      materialPath {
          moveTo(17.0F, 6.0F)
...
private var _battery1024: ImageVector? = null
