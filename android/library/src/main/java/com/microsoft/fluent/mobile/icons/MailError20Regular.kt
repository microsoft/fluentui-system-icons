...
public val FluentIcons.Regular.MailError20: ImageVector
  get() {
    if (_mailError20 != null) {
      return _mailError20!!
    }
    _mailError20 = fluentIcon(name = "Regular.MailError20", 20f) {
      materialPath {
          moveTo(19.0F, 5.5F)
...
private var _mailError20: ImageVector? = null
