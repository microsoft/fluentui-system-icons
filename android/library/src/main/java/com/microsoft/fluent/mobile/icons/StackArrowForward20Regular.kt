...
public val FluentIcons.Regular.StackArrowForward20: ImageVector
  get() {
    if (_stackArrowForward20 != null) {
      return _stackArrowForward20!!
    }
    _stackArrowForward20 = fluentIcon(name = "Regular.StackArrowForward20", 20f) {
      materialPath {
          moveTo(14.5F, 10.0F)
          ...
          curveTo(13.231F, 4.5F, 12.0F, 5.731F, 12.0F, 7.25F)
          verticalLineTo(7.5F)
          ...
          curveTo(17.986F, 5.132F, 18.0F, 5.068F, 18.0F, 5.0F)
          ...
          curveTo(9.306F, 3.651F, 9.437F, 3.317F, 9.6F, 3.0F)
          horizontalLineTo(4.0F)
...
private var _stackArrowForward20: ImageVector? = null
