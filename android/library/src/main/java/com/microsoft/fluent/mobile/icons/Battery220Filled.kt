...
public val FluentIcons.Filled.Battery220: ImageVector
  get() {
    if (_battery220 != null) {
      return _battery220!!
    }
    _battery220 = fluentIcon(name = "Filled.Battery220", 220f) {
      materialPath {
          ...
          curveTo(5.627F, 12.946F, 6.0F, 12.572F, 6.0F, 12.111F)
