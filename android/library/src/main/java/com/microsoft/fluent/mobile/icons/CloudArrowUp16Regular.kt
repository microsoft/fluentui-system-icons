...
public val FluentIcons.Regular.CloudArrowUp16: ImageVector
  get() {
    if (_cloudArrowUp16 != null) {
      return _cloudArrowUp16!!
    }
    _cloudArrowUp16 = fluentIcon(name = "Regular.CloudArrowUp16", 16f) {
      materialPath {
          moveTo(8.0F, 3.0F)
          ...
          curveTo(10.423F, 3.84F, 9.31F, 3.0F, 8.0F, 3.0F)
          close()
          ...
          curveTo(10.633F, 8.014F, 10.57F, 8.0F, 10.503F, 8.0F)
...
private var _cloudArrowUp16: ImageVector? = null
