...
public val FluentIcons.Filled.PanelBottomContract20: ImageVector
  get() {
    if (_panelBottomContract20 != null) {
      return _panelBottomContract20!!
    }
    _panelBottomContract20 = fluentIcon(name = "Filled.PanelBottomContract20", 20f) {
      materialPath {
          ...
          lineToRelative(-1.75F, 2.0F)
          curveToRelative(-0.285F, 0.325F, -0.696F, 0.512F, -1.129F, 0.512F)
          curveToRelative(-0.432F, 0.0F, -0.844F, -0.187F, -1.129F, -0.512F)
          lineToRelative(-1.75F, -2.0F)
...
private var _panelBottomContract20: ImageVector? = null
