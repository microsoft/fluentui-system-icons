...
public val FluentIcons.Filled.VideoPersonClock20: ImageVector
  get() {
    if (_videoPersonClock20 != null) {
      return _videoPersonClock20!!
    }
    _videoPersonClock20 = fluentIcon(name = "Filled.VideoPersonClock20", 20f) {
      materialPath {
          moveTo(10.0F, 10.0F)
...
private var _videoPersonClock20: ImageVector? = null
