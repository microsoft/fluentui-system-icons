...
public val FluentIcons.Regular.AlignSpaceBetweenHorizontal20: ImageVector
  get() {
    if (_alignSpaceBetweenHorizontal20 != null) {
      return _alignSpaceBetweenHorizontal20!!
    }
    _alignSpaceBetweenHorizontal20 = fluentIcon(name = "Regular.AlignSpaceBetweenHorizontal20", 20f) {
      materialPath {
          moveTo(6.0F, 1.0F)
