...
public val FluentIcons.Regular.ExpandUpRight20: ImageVector
  get() {
    if (_expandUpRight20 != null) {
      return _expandUpRight20!!
    }
    _expandUpRight20 = fluentIcon(name = "Regular.ExpandUpRight20", 20f) {
      materialPath {
          moveTo(4.0F, 6.0F)
...
private var _expandUpRight20: ImageVector? = null
