...
public val FluentIcons.Filled.CommentArrowRight16: ImageVector
  get() {
    if (_commentArrowRight16 != null) {
      return _commentArrowRight16!!
    }
    _commentArrowRight16 = fluentIcon(name = "Filled.CommentArrowRight16", 16f) {
      materialPath {
          moveTo(15.0F, 5.5F)
          ...
          curveTo(8.014F, 5.367F, 8.0F, 5.43F, 8.0F, 5.497F)
...
private var _commentArrowRight16: ImageVector? = null
