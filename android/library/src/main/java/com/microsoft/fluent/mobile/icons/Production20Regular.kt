...
public val FluentIcons.Regular.Production20: ImageVector
  get() {
    if (_production20 != null) {
      return _production20!!
    }
    _production20 = fluentIcon(name = "Regular.Production20", 20f) {
      materialPath {
          moveTo(5.0F, 3.5F)
...
private var _production20: ImageVector? = null
