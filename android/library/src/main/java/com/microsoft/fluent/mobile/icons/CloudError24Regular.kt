...
public val FluentIcons.Regular.CloudError24: ImageVector
  get() {
    if (_cloudError24 != null) {
      return _cloudError24!!
    }
    _cloudError24 = fluentIcon(name = "Regular.CloudError24", 24f) {
      materialPath {
          moveTo(12.0F, 4.5F)
...
private var _cloudError24: ImageVector? = null
