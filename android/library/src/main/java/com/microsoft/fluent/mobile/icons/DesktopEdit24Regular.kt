...
public val FluentIcons.Regular.DesktopEdit24: ImageVector
  get() {
    if (_desktopEdit24 != null) {
      return _desktopEdit24!!
    }
    _desktopEdit24 = fluentIcon(name = "Regular.DesktopEdit24", 24f) {
      materialPath {
          moveTo(19.1F, 1.67F)
          ...
          curveToRelative(0.473F, -0.118F, 0.904F, -0.362F, 1.248F, -0.707F)
          ...
          close()
          moveTo(4.25F, 3.0F)
          horizontalLineToRelative(12.105F)
          ...
          verticalLineTo(8.149F)
          lineToRelative(1.5F, -1.5F)
          verticalLineToRelative(9.103F)
          curveToRelative(0.0F, 1.19F, -0.925F, 2.165F, -2.096F, 2.245F)
...
private var _desktopEdit24: ImageVector? = null
