...
public val FluentIcons.Regular.LocationArrowUp48: ImageVector
  get() {
    if (_locationArrowUp48 != null) {
      return _locationArrowUp48!!
    }
    _locationArrowUp48 = fluentIcon(name = "Regular.LocationArrowUp48", 48f) {
      materialPath {
          moveTo(28.116F, 19.884F)
          ...
          reflectiveCurveTo(9.5F, 12.992F, 9.5F, 21.0F)
...
private var _locationArrowUp48: ImageVector? = null
