...
public val FluentIcons.Filled.FilmstripSplit16: ImageVector
  get() {
    if (_filmstripSplit16 != null) {
      return _filmstripSplit16!!
    }
    _filmstripSplit16 = fluentIcon(name = "Filled.FilmstripSplit16", 16f) {
      materialPath {
          moveTo(8.5F, 1.5F)
...
private var _filmstripSplit16: ImageVector? = null
