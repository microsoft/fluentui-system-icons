...
public val FluentIcons.Regular.DocumentAdd20: ImageVector
  get() {
    if (_documentAdd20 != null) {
      return _documentAdd20!!
    }
    _documentAdd20 = fluentIcon(name = "Regular.DocumentAdd20", 20f) {
      materialPath {
          moveTo(6.0F, 2.0F)
...
private var _documentAdd20: ImageVector? = null
