...
public val FluentIcons.Filled.MailDismiss24: ImageVector
  get() {
    if (_mailDismiss24 != null) {
      return _mailDismiss24!!
    }
    _mailDismiss24 = fluentIcon(name = "Filled.MailDismiss24", 24f) {
      materialPath {
          moveTo(23.0F, 6.5F)
...
private var _mailDismiss24: ImageVector? = null
