...
public val FluentIcons.Filled.MailAllRead16: ImageVector
  get() {
    if (_mailAllRead16 != null) {
      return _mailAllRead16!!
    }
    _mailAllRead16 = fluentIcon(name = "Filled.MailAllRead16", 16f) {
      materialPath {
          moveTo(7.24F, 1.061F)
...
private var _mailAllRead16: ImageVector? = null
