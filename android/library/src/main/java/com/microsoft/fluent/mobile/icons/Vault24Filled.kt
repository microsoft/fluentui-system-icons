...
public val FluentIcons.Filled.Vault24: ImageVector
  get() {
    if (_vault24 != null) {
      return _vault24!!
    }
    _vault24 = fluentIcon(name = "Filled.Vault24", 24f) {
      materialPath {
          moveTo(14.0F, 13.5F)
          ...
          curveToRelative(-0.293F, -0.293F, -0.767F, -0.293F, -1.06F, 0.0F)
          lineToRelative(-1.196F, 1.195F)
          curveTo(15.077F, 9.152F, 14.556F, 9.0F, 14.0F, 9.0F)
...
private var _vault24: ImageVector? = null
