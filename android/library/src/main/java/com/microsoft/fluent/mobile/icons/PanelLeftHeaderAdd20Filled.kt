...
public val FluentIcons.Filled.PanelLeftHeaderAdd20: ImageVector
  get() {
    if (_panelLeftHeaderAdd20 != null) {
      return _panelLeftHeaderAdd20!!
    }
    _panelLeftHeaderAdd20 = fluentIcon(name = "Filled.PanelLeftHeaderAdd20", 20f) {
      materialPath {
          moveTo(2.0F, 6.0F)
...
private var _panelLeftHeaderAdd20: ImageVector? = null
