...
public val FluentIcons.Regular.MusicNote124: ImageVector
  get() {
    if (_musicNote124 != null) {
      return _musicNote124!!
    }
    _musicNote124 = fluentIcon(name = "Regular.MusicNote124", 124f) {
      materialPath {
          ...
          reflectiveCurveTo(5.5F, 19.38F, 5.5F, 18.0F)
          reflectiveCurveToRelative(1.12F, -2.5F, 2.5F, -2.5F)
          reflectiveCurveToRelative(2.5F, 1.12F, 2.5F, 2.5F)
          close()
          moveToRelative(8.0F, -8.332F)
          lineTo(12.0F, 7.23F)
          verticalLineTo(3.832F)
          lineToRelative(5.364F, 2.012F)
          curveTo(18.047F, 6.1F, 18.5F, 6.753F, 18.5F, 7.482F)
