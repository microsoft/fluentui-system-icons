...
public val FluentIcons.Filled.ArrowTurnLeftUp48: ImageVector
  get() {
    if (_arrowTurnLeftUp48 != null) {
      return _arrowTurnLeftUp48!!
    }
    _arrowTurnLeftUp48 = fluentIcon(name = "Filled.ArrowTurnLeftUp48", 48f) {
      materialPath {
          moveTo(40.5F, 35.0F)
          curveToRelative(0.828F, 0.0F, 1.5F, 0.672F, 1.5F, 1.5F)
          reflectiveCurveTo(41.328F, 38.0F, 40.5F, 38.0F)
