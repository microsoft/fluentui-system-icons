...
public val FluentIcons.Regular.PeopleStar16: ImageVector
  get() {
    if (_peopleStar16 != null) {
      return _peopleStar16!!
    }
    _peopleStar16 = fluentIcon(name = "Regular.PeopleStar16", 16f) {
      materialPath {
          moveTo(4.0F, 4.5F)
...
private var _peopleStar16: ImageVector? = null
