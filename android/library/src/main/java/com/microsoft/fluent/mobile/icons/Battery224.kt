...
public val FluentIcons.Regular.Battery224: ImageVector
  get() {
    if (_battery224 != null) {
      return _battery224!!
    }
    _battery224 = fluentIcon(name = "Regular.Battery224", 224f) {
      materialPath {
          moveTo(17.0F, 6.0F)
          ...
          lineTo(5.0F, 14.003F)
          verticalLineToRelative(-4.0F)
          curveTo(5.0F, 9.49F, 5.386F, 9.068F, 5.883F, 9.01F)
          lineTo(6.0F, 9.003F)
          lineTo(8.0F, 9.0F)
          lineTo(6.0F, 9.003F)
          close()        
...
private var _battery224: ImageVector? = null
