...
public val FluentIcons.Filled.ShareScreenPersonP16: ImageVector
  get() {
    if (_shareScreenPersonP16 != null) {
      return _shareScreenPersonP16!!
    }
    _shareScreenPersonP16 = fluentIcon(name = "Filled.ShareScreenPersonP16", 16f) {
      materialPath {
          moveTo(1.0F, 5.5F)
          ...
          curveTo(14.363F, 6.21F, 13.073F, 5.0F, 11.5F, 5.0F)
          ...
          reflectiveCurveTo(6.105F, 5.0F, 5.0F, 5.0F)
          horizontalLineTo(3.5F)
          ...
          reflectiveCurveTo(5.552F, 6.0F, 5.0F, 6.0F)
...
private var _shareScreenPersonP16: ImageVector? = null
