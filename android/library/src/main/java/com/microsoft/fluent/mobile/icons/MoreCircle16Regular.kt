...
public val FluentIcons.Regular.MoreCircle16: ImageVector
  get() {
    if (_moreCircle16 != null) {
      return _moreCircle16!!
    }
    _moreCircle16 = fluentIcon(name = "Regular.MoreCircle16", 16f) {
      materialPath {
          moveTo(3.0F, 8.0F)
          ...
          moveTo(5.0F, 9.0F)
          curveToRelative(0.552F, 0.0F, 1.0F, -0.448F, 1.0F, -1.0F)
          reflectiveCurveTo(5.552F, 7.0F, 5.0F, 7.0F)
          reflectiveCurveTo(4.0F, 7.448F, 4.0F, 8.0F)
          reflectiveCurveToRelative(0.448F, 1.0F, 1.0F, 1.0F)
          close()        
      }
    }
