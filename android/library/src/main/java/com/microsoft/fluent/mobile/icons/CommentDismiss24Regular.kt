...
public val FluentIcons.Regular.CommentDismiss24: ImageVector
  get() {
    if (_commentDismiss24 != null) {
      return _commentDismiss24!!
    }
    _commentDismiss24 = fluentIcon(name = "Regular.CommentDismiss24", 24f) {
      materialPath {
          moveTo(23.0F, 6.5F)
...
private var _commentDismiss24: ImageVector? = null
