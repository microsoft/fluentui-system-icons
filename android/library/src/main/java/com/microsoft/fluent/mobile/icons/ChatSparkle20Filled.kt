...
public val FluentIcons.Filled.ChatSparkle20: ImageVector
  get() {
    if (_chatSparkle20 != null) {
      return _chatSparkle20!!
    }
    _chatSparkle20 = fluentIcon(name = "Filled.ChatSparkle20", 20f) {
      materialPath {
          ...
          curveTo(10.09F, 4.077F, 10.0F, 3.797F, 10.0F, 3.498F)
