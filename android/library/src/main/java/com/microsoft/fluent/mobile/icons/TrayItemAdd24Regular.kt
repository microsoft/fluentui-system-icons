...
public val FluentIcons.Regular.TrayItemAdd24: ImageVector
  get() {
    if (_trayItemAdd24 != null) {
      return _trayItemAdd24!!
    }
    _trayItemAdd24 = fluentIcon(name = "Regular.TrayItemAdd24", 24f) {
      materialPath {
          moveTo(14.0F, 3.5F)
...
private var _trayItemAdd24: ImageVector? = null
