...
public val FluentIcons.Regular.ChannelAdd20: ImageVector
  get() {
    if (_channelAdd20 != null) {
      return _channelAdd20!!
    }
    _channelAdd20 = fluentIcon(name = "Regular.ChannelAdd20", 20f) {
      materialPath {
          moveTo(3.5F, 4.5F)
...
private var _channelAdd20: ImageVector? = null
