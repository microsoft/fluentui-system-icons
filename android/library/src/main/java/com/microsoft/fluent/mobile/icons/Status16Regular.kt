...
public val FluentIcons.Regular.Status16: ImageVector
  get() {
    if (_status16 != null) {
      return _status16!!
    }
    _status16 = fluentIcon(name = "Regular.Status16", 16f) {
      materialPath {
          ...
          curveToRelative(0.495F, -0.495F, 1.297F, -0.495F, 1.793F, 0.0F)
          curveToRelative(0.495F, 0.495F, 0.495F, 1.297F, 0.0F, 1.793F)
          lineTo(9.48F, 8.313F)
          lineTo(6.79F, 9.21F)
