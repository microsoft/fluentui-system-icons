...
public val FluentIcons.Regular.MusicNoteOff120: ImageVector
  get() {
    if (_musicNoteOff120 != null) {
      return _musicNoteOff120!!
    }
    _musicNoteOff120 = fluentIcon(name = "Regular.MusicNoteOff120", 120f) {
      materialPath {
          ...
          reflectiveCurveTo(8.493F, 17.0F, 7.25F, 17.0F)
          reflectiveCurveTo(5.0F, 15.993F, 5.0F, 14.75F)
          close()
          ...
          curveToRelative(0.0F, -0.658F, -0.43F, -1.24F, -1.059F, -1.434F)
          lineTo(10.5F, 3.177F)
