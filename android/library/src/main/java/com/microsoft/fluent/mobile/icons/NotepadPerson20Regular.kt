...
public val FluentIcons.Regular.NotepadPerson20: ImageVector
  get() {
    if (_notepadPerson20 != null) {
      return _notepadPerson20!!
    }
    _notepadPerson20 = fluentIcon(name = "Regular.NotepadPerson20", 20f) {
      materialPath {
          moveTo(7.5F, 7.0F)
          ...
          horizontalLineToRelative(5.867F)
          curveToRelative(-0.168F, -0.319F, -0.276F, -0.657F, -0.329F, -1.0F)
          horizontalLineTo(5.5F)
          ...
          curveTo(15.163F, 9.014F, 15.33F, 9.0F, 15.5F, 9.0F)
...
private var _notepadPerson20: ImageVector? = null
