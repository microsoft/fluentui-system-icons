...
public val FluentIcons.Regular.PhoneDesktop20: ImageVector
  get() {
    if (_phoneDesktop20 != null) {
      return _phoneDesktop20!!
    }
    _phoneDesktop20 = fluentIcon(name = "Regular.PhoneDesktop20", 20f) {
      materialPath {
          moveTo(6.0F, 3.0F)
          ...
          reflectiveCurveTo(4.224F, 16.0F, 4.5F, 16.0F)
          horizontalLineToRelative(1.0F)
