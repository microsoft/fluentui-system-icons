...
public val FluentIcons.Regular.DatabaseArrowDown20: ImageVector
  get() {
    if (_databaseArrowDown20 != null) {
      return _databaseArrowDown20!!
    }
    _databaseArrowDown20 = fluentIcon(name = "Regular.DatabaseArrowDown20", 20f) {
      materialPath {
          moveTo(4.0F, 5.0F)
...
private var _databaseArrowDown20: ImageVector? = null
