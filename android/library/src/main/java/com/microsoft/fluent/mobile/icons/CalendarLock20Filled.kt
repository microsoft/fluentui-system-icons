...
public val FluentIcons.Filled.CalendarLock20: ImageVector
  get() {
    if (_calendarLock20 != null) {
      return _calendarLock20!!
    }
    _calendarLock20 = fluentIcon(name = "Filled.CalendarLock20", 20f) {
      materialPath {
          moveTo(17.0F, 7.0F)
          ...
          curveTo(11.637F, 12.285F, 11.0F, 13.068F, 11.0F, 14.0F)
...
private var _calendarLock20: ImageVector? = null
