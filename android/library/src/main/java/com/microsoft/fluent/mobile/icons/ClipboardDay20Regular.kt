...
public val FluentIcons.Regular.ClipboardDay20: ImageVector
  get() {
    if (_clipboardDay20 != null) {
      return _clipboardDay20!!
    }
    _clipboardDay20 = fluentIcon(name = "Regular.ClipboardDay20", 20f) {
      materialPath {
          moveTo(7.0F, 7.5F)
...
private var _clipboardDay20: ImageVector? = null
