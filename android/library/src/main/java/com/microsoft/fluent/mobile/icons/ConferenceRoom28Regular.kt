...
public val FluentIcons.Regular.ConferenceRoom28: ImageVector
  get() {
    if (_conferenceRoom28 != null) {
      return _conferenceRoom28!!
    }
    _conferenceRoom28 = fluentIcon(name = "Regular.ConferenceRoom28", 28f) {
      materialPath {
          ...
          lineToRelative(10.0F, -1.956F)
          verticalLineTo(5.618F)
          lineToRelative(-10.0F, -1.957F)
          close()
          moveTo(10.0F, 4.501F)
          verticalLineTo(6.0F)
