...
public val FluentIcons.Regular.Diamond28: ImageVector
  get() {
    if (_diamond28 != null) {
      return _diamond28!!
    }
    _diamond28 = fluentIcon(name = "Regular.Diamond28", 28f) {
      materialPath {
          ...
          close()
          moveToRelative(1.06F, -2.475F)
          curveToRelative(-0.39F, 0.39F, -0.39F, 1.024F, 0.0F, 1.414F)
          lineToRelative(8.503F, 8.502F)
          curveToRelative(0.39F, 0.39F, 1.024F, 0.39F, 1.414F, 0.0F)
          lineToRelative(8.502F, -8.502F)
          curveToRelative(0.39F, -0.39F, 0.39F, -1.024F, 0.0F, -1.414F)
          lineTo(14.71F, 4.793F)
          curveToRelative(-0.39F, -0.39F, -1.024F, -0.39F, -1.414F, 0.0F)
          lineToRelative(-8.502F, 8.502F)
          close()        
      }
