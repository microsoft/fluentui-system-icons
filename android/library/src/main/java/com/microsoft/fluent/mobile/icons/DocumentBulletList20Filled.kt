...
public val FluentIcons.Filled.DocumentBulletList20: ImageVector
  get() {
    if (_documentBulletList20 != null) {
      return _documentBulletList20!!
    }
    _documentBulletList20 = fluentIcon(name = "Filled.DocumentBulletList20", 20f) {
      materialPath {
          moveTo(10.0F, 6.5F)
          verticalLineTo(2.0F)
...
private var _documentBulletList20: ImageVector? = null
