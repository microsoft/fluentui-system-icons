...
public val FluentIcons.Regular.MailDismiss16: ImageVector
  get() {
    if (_mailDismiss16 != null) {
      return _mailDismiss16!!
    }
    _mailDismiss16 = fluentIcon(name = "Regular.MailDismiss16", 16f) {
      materialPath {
          moveTo(15.0F, 5.5F)
...
private var _mailDismiss16: ImageVector? = null
