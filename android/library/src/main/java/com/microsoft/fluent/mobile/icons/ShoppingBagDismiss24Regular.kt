...
public val FluentIcons.Regular.ShoppingBagDismiss24: ImageVector
  get() {
    if (_shoppingBagDismiss24 != null) {
      return _shoppingBagDismiss24!!
    }
    _shoppingBagDismiss24 = fluentIcon(name = "Regular.ShoppingBagDismiss24", 24f) {
      materialPath {
          moveTo(7.0F, 7.0F)
          verticalLineTo(5.0F)
...
private var _shoppingBagDismiss24: ImageVector? = null
