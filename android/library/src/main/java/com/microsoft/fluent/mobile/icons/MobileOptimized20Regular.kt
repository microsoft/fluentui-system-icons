...
public val FluentIcons.Regular.MobileOptimized20: ImageVector
  get() {
    if (_mobileOptimized20 != null) {
      return _mobileOptimized20!!
    }
    _mobileOptimized20 = fluentIcon(name = "Regular.MobileOptimized20", 20f) {
      materialPath {
          moveTo(5.0F, 2.5F)
          ...
          verticalLineToRelative(2.0F)
          curveTo(15.0F, 4.776F, 15.224F, 5.0F, 15.5F, 5.0F)
          horizontalLineToRelative(2.0F)
          ...
          close()
          moveTo(4.5F, 18.0F)
          curveTo(4.776F, 18.0F, 5.0F, 17.776F, 5.0F, 17.5F)
          verticalLineToRelative(-2.0F)
...
private var _mobileOptimized20: ImageVector? = null
