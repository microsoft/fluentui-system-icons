...
public val FluentIcons.Regular.Location48: ImageVector
  get() {
    if (_location48 != null) {
      return _location48!!
    }
    _location48 = fluentIcon(name = "Regular.Location48", 48f) {
      materialPath {
          moveTo(24.005F, 15.5F)
...
private var _location48: ImageVector? = null
