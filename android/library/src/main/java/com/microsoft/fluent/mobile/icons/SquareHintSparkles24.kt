...
public val FluentIcons.Filled.SquareHintSparkles24: ImageVector
  get() {
    if (_squareHintSparkles24 != null) {
      return _squareHintSparkles24!!
    }
    _squareHintSparkles24 = fluentIcon(name = "Filled.SquareHintSparkles24", 24f) {
      materialPath {
          ...
          curveTo(12.033F, 4.83F, 12.001F, 4.651F, 12.0F, 4.469F)
          ...
          reflectiveCurveTo(4.552F, 7.0F, 4.0F, 7.0F)
          reflectiveCurveTo(3.0F, 6.552F, 3.0F, 6.0F)
