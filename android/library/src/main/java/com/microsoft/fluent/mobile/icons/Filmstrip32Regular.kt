...
public val FluentIcons.Regular.Filmstrip32: ImageVector
  get() {
    if (_filmstrip32 != null) {
      return _filmstrip32!!
    }
    _filmstrip32 = fluentIcon(name = "Regular.Filmstrip32", 32f) {
      materialPath {
          moveTo(2.0F, 8.5F)
...
private var _filmstrip32: ImageVector? = null
