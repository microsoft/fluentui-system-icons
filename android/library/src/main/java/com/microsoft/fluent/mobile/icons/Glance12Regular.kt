...
public val FluentIcons.Regular.Glance12: ImageVector
  get() {
    if (_glance12 != null) {
      return _glance12!!
    }
    _glance12 = fluentIcon(name = "Regular.Glance12", 12f) {
      materialPath {
          moveTo(6.0F, 9.5F)
          ...
          verticalLineToRelative(3.0F)
          curveTo(10.0F, 9.776F, 9.776F, 10.0F, 9.5F, 10.0F)
          horizontalLineToRelative(-2.0F)
          close()
          moveTo(1.0F, 5.5F)
          ...
          horizontalLineToRelative(1.0F)
          curveTo(3.776F, 9.0F, 4.0F, 9.224F, 4.0F, 9.5F)
          reflectiveCurveTo(3.776F, 10.0F, 3.5F, 10.0F)
          horizontalLineToRelative(-1.0F)
          close()        
      }
    }
...
private var _glance12: ImageVector? = null
