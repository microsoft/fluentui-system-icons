...
public val FluentIcons.Regular.DeleteDismiss20: ImageVector
  get() {
    if (_deleteDismiss20 != null) {
      return _deleteDismiss20!!
    }
    _deleteDismiss20 = fluentIcon(name = "Regular.DeleteDismiss20", 20f) {
      materialPath {
          moveTo(11.5F, 4.0F)
          ...
          curveTo(15.643F, 9.11F, 15.314F, 9.05F, 14.975F, 9.02F)
          lineTo(15.44F, 5.0F)
...
private var _deleteDismiss20: ImageVector? = null
