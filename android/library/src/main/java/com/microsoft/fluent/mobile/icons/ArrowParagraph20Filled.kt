...
public val FluentIcons.Filled.ArrowParagraph20: ImageVector
  get() {
    if (_arrowParagraph20 != null) {
      return _arrowParagraph20!!
    }
    _arrowParagraph20 = fluentIcon(name = "Filled.ArrowParagraph20", 20f) {
      materialPath {
          moveTo(17.25F, 2.0F)
          curveTo(17.664F, 2.0F, 18.0F, 2.336F, 18.0F, 2.75F)
          verticalLineToRelative(2.5F)
          curveTo(18.0F, 6.769F, 16.769F, 8.0F, 15.25F, 8.0F)
          ...
          curveToRelative(-0.26F, -0.287F, -0.26F, -0.723F, 0.0F, -1.01F)
          lineToRelative(2.5F, -2.75F)
...
private var _arrowParagraph20: ImageVector? = null
