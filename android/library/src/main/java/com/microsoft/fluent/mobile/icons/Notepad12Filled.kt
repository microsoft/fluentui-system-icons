...
public val FluentIcons.Filled.Notepad12: ImageVector
  get() {
    if (_notepad12 != null) {
      return _notepad12!!
    }
    _notepad12 = fluentIcon(name = "Filled.Notepad12", 12f) {
      materialPath {
          moveTo(4.0F, 1.5F)
          curveTo(4.0F, 1.224F, 4.224F, 1.0F, 4.5F, 1.0F)
          ...
          curveTo(5.776F, 7.0F, 6.0F, 6.776F, 6.0F, 6.5F)
          reflectiveCurveTo(5.776F, 6.0F, 5.5F, 6.0F)
          horizontalLineToRelative(-1.0F)
          curveTo(4.224F, 6.0F, 4.0F, 6.224F, 4.0F, 6.5F)
          close()
          moveTo(4.5F, 9.0F)
          curveTo(4.776F, 9.0F, 5.0F, 8.776F, 5.0F, 8.5F)
...
private var _notepad12: ImageVector? = null
