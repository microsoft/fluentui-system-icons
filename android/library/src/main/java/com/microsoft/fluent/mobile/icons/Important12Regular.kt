...
public val FluentIcons.Regular.Important12: ImageVector
  get() {
    if (_important12 != null) {
      return _important12!!
    }
    _important12 = fluentIcon(name = "Regular.Important12", 12f) {
      materialPath {
          moveTo(4.283F, 2.98F)
          ...
          curveTo(6.79F, 2.396F, 6.447F, 2.0F, 6.0F, 2.0F)
          curveTo(5.553F, 2.0F, 5.21F, 2.396F, 5.273F, 2.838F)
          lineToRelative(0.576F, 4.03F)
          curveTo(5.859F, 6.945F, 5.924F, 7.0F, 6.0F, 7.0F)
          reflectiveCurveToRelative(0.14F, -0.056F, 0.152F, -0.131F)
          lineToRelative(0.575F, -4.03F)
          close()
          moveTo(6.0F, 11.0F)
          curveToRelative(0.552F, 0.0F, 1.0F, -0.448F, 1.0F, -1.0F)
          reflectiveCurveTo(6.552F, 9.0F, 6.0F, 9.0F)
