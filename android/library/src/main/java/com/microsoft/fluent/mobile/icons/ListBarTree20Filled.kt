...
public val FluentIcons.Filled.ListBarTree20: ImageVector
  get() {
    if (_listBarTree20 != null) {
      return _listBarTree20!!
    }
    _listBarTree20 = fluentIcon(name = "Filled.ListBarTree20", 20f) {
      materialPath {
          moveTo(8.0F, 7.0F)
          ...
          verticalLineToRelative(-1.0F)
          curveTo(5.0F, 13.672F, 5.672F, 13.0F, 6.5F, 13.0F)
          close()        
      }
    }
    return _listBarTree20!!
...
private var _listBarTree20: ImageVector? = null
