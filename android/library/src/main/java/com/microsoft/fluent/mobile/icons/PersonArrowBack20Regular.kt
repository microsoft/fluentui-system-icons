...
public val FluentIcons.Regular.PersonArrowBack20: ImageVector
  get() {
    if (_personArrowBack20 != null) {
      return _personArrowBack20!!
    }
    _personArrowBack20 = fluentIcon(name = "Regular.PersonArrowBack20", 20f) {
      materialPath {
          moveTo(9.0F, 2.0F)
...
private var _personArrowBack20: ImageVector? = null
