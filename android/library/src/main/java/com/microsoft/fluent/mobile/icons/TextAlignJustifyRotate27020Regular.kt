...
public val FluentIcons.Regular.TextAlignJustifyRotate27020: ImageVector
  get() {
    if (_textAlignJustifyRotate27020 != null) {
      return _textAlignJustifyRotate27020!!
    }
    _textAlignJustifyRotate27020 = fluentIcon(name = "Regular.TextAlignJustifyRotate27020", 27020f) {
      materialPath {
          moveTo(4.5F, 18.0F)
...
private var _textAlignJustifyRotate27020: ImageVector? = null
