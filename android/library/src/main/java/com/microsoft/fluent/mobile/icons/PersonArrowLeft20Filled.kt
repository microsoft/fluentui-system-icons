...
public val FluentIcons.Filled.PersonArrowLeft20: ImageVector
  get() {
    if (_personArrowLeft20 != null) {
      return _personArrowLeft20!!
    }
    _personArrowLeft20 = fluentIcon(name = "Filled.PersonArrowLeft20", 20f) {
      materialPath {
          moveTo(9.0F, 2.0F)
...
private var _personArrowLeft20: ImageVector? = null
