...
public val FluentIcons.Regular.PanelLeftHeaderAdd48: ImageVector
  get() {
    if (_panelLeftHeaderAdd48 != null) {
      return _panelLeftHeaderAdd48!!
    }
    _panelLeftHeaderAdd48 = fluentIcon(name = "Regular.PanelLeftHeaderAdd48", 48f) {
      materialPath {
          moveTo(4.0F, 13.25F)
...
private var _panelLeftHeaderAdd48: ImageVector? = null
