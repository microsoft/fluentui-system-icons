...
public val FluentIcons.Filled.ClipboardMultiple16: ImageVector
  get() {
    if (_clipboardMultiple16 != null) {
      return _clipboardMultiple16!!
    }
    _clipboardMultiple16 = fluentIcon(name = "Filled.ClipboardMultiple16", 16f) {
      materialPath {
          moveTo(6.5F, 1.0F)
...
private var _clipboardMultiple16: ImageVector? = null
