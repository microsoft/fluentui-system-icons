...
public val FluentIcons.Filled.ContentView28: ImageVector
  get() {
    if (_contentView28 != null) {
      return _contentView28!!
    }
    _contentView28 = fluentIcon(name = "Filled.ContentView28", 28f) {
      materialPath {
          moveTo(6.75F, 3.0F)
          ...
          horizontalLineToRelative(-5.5F)
          curveTo(6.336F, 16.5F, 6.0F, 16.164F, 6.0F, 15.75F)
          ...
          reflectiveCurveToRelative(-0.336F, 0.75F, -0.75F, 0.75F)
          horizontalLineToRelative(-5.5F)
          curveTo(6.336F, 20.25F, 6.0F, 19.914F, 6.0F, 19.5F)
          close()
...
private var _contentView28: ImageVector? = null
