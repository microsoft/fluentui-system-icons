...
public val FluentIcons.Filled.DocumentArrowDown20: ImageVector
  get() {
    if (_documentArrowDown20 != null) {
      return _documentArrowDown20!!
    }
    _documentArrowDown20 = fluentIcon(name = "Filled.DocumentArrowDown20", 20f) {
      materialPath {
          moveTo(10.0F, 2.0F)
          ...
          curveTo(10.528F, 17.05F, 11.0F, 15.83F, 11.0F, 14.5F)
...
private var _documentArrowDown20: ImageVector? = null
