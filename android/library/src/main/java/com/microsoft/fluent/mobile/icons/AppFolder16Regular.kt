...
public val FluentIcons.Regular.AppFolder16: ImageVector
  get() {
    if (_appFolder16 != null) {
      return _appFolder16!!
    }
    _appFolder16 = fluentIcon(name = "Regular.AppFolder16", 16f) {
      materialPath {
          moveTo(4.0F, 5.0F)
...
private var _appFolder16: ImageVector? = null
