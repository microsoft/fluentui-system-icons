...
public val FluentIcons.Filled.MailInboxAdd16: ImageVector
  get() {
    if (_mailInboxAdd16 != null) {
      return _mailInboxAdd16!!
    }
    _mailInboxAdd16 = fluentIcon(name = "Filled.MailInboxAdd16", 16f) {
      materialPath {
          moveTo(15.0F, 5.5F)
...
private var _mailInboxAdd16: ImageVector? = null
