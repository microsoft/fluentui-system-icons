...
public val FluentIcons.Filled.Building16: ImageVector
  get() {
    if (_building16 != null) {
      return _building16!!
    }
    _building16 = fluentIcon(name = "Filled.Building16", 16f) {
      materialPath {
          moveTo(5.5F, 2.0F)
          ...
          moveTo(9.0F, 7.0F)
          curveToRelative(0.0F, 0.276F, -0.224F, 0.5F, -0.5F, 0.5F)
          reflectiveCurveTo(8.0F, 7.276F, 8.0F, 7.0F)
          reflectiveCurveToRelative(0.224F, -0.5F, 0.5F, -0.5F)
          reflectiveCurveTo(9.0F, 6.724F, 9.0F, 7.0F)
          close()
          moveToRelative(0.0F, 2.5F)
