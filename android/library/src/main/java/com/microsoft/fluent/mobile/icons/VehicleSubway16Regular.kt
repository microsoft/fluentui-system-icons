...
public val FluentIcons.Regular.VehicleSubway16: ImageVector
  get() {
    if (_vehicleSubway16 != null) {
      return _vehicleSubway16!!
    }
    _vehicleSubway16 = fluentIcon(name = "Regular.VehicleSubway16", 16f) {
      materialPath {
          moveTo(7.0F, 10.0F)
          ...
          curveTo(9.776F, 4.0F, 10.0F, 4.224F, 10.0F, 4.5F)
...
private var _vehicleSubway16: ImageVector? = null
