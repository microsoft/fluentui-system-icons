...
public val FluentIcons.Filled.TagDismiss20: ImageVector
  get() {
    if (_tagDismiss20 != null) {
      return _tagDismiss20!!
    }
    _tagDismiss20 = fluentIcon(name = "Filled.TagDismiss20", 20f) {
      materialPath {
          ...
          curveTo(9.339F, 16.672F, 9.0F, 15.626F, 9.0F, 14.5F)
          curveTo(9.0F, 11.462F, 11.462F, 9.0F, 14.5F, 9.0F)
          curveToRelative(1.2F, 0.0F, 2.311F, 0.385F, 3.215F, 1.037F)
          curveToRelative(0.194F, -0.314F, 0.3F, -0.679F, 0.299F, -1.054F)
...
private var _tagDismiss20: ImageVector? = null
