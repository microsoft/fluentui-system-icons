...
public val FluentIcons.Filled.Connector20: ImageVector
  get() {
    if (_connector20 != null) {
      return _connector20!!
    }
    _connector20 = fluentIcon(name = "Filled.Connector20", 20f) {
      materialPath {
          moveTo(4.5F, 3.0F)
          curveTo(4.224F, 3.0F, 4.0F, 3.224F, 4.0F, 3.5F)
          verticalLineToRelative(2.793F)
          lineTo(2.147F, 8.146F)
          curveTo(2.053F, 8.24F, 2.0F, 8.367F, 2.0F, 8.5F)
          ...
          verticalLineToRelative(2.5F)
          curveTo(6.0F, 16.776F, 6.224F, 17.0F, 6.5F, 17.0F)
          ...
          curveTo(17.947F, 11.76F, 18.0F, 11.633F, 18.0F, 11.5F)
          verticalLineToRelative(-5.0F)
...
private var _connector20: ImageVector? = null
