...
public val FluentIcons.Filled.ImageArrowForward20: ImageVector
  get() {
    if (_imageArrowForward20 != null) {
      return _imageArrowForward20!!
    }
    _imageArrowForward20 = fluentIcon(name = "Filled.ImageArrowForward20", 20f) {
      materialPath {
          moveTo(5.5F, 10.0F)
          ...
          curveTo(10.784F, 3.75F, 11.0F, 4.6F, 11.0F, 5.5F)
          close()
          moveTo(12.5F, 8.0F)
          ...
          reflectiveCurveTo(13.328F, 9.0F, 12.5F, 9.0F)
          close()
          moveToRelative(-8.235F, 7.448F)
          curveTo(4.755F, 16.796F, 5.354F, 17.0F, 6.0F, 17.0F)
...
private var _imageArrowForward20: ImageVector? = null
