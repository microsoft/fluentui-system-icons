...
public val FluentIcons.Regular.WeatherSunny24: ImageVector
  get() {
    if (_weatherSunny24 != null) {
      return _weatherSunny24!!
    }
    _weatherSunny24 = fluentIcon(name = "Regular.WeatherSunny24", 24f) {
      materialPath {
          moveTo(12.0F, 2.0F)
...
private var _weatherSunny24: ImageVector? = null
