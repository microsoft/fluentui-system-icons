...
public val FluentIcons.Regular.PrintAdd20: ImageVector
  get() {
    if (_printAdd20 != null) {
      return _printAdd20!!
    }
    _printAdd20 = fluentIcon(name = "Regular.PrintAdd20", 20f) {
      materialPath {
          moveTo(19.0F, 5.5F)
          ...
          horizontalLineTo(5.0F)
          verticalLineToRelative(-1.5F)
          curveTo(5.0F, 11.672F, 5.672F, 11.0F, 6.5F, 11.0F)
          horizontalLineToRelative(7.0F)
...
private var _printAdd20: ImageVector? = null
