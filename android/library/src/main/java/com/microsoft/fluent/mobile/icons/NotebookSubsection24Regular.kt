...
public val FluentIcons.Regular.NotebookSubsection24: ImageVector
  get() {
    if (_notebookSubsection24 != null) {
      return _notebookSubsection24!!
    }
    _notebookSubsection24 = fluentIcon(name = "Regular.NotebookSubsection24", 24f) {
      materialPath {
          moveTo(9.0F, 2.0F)
          ...
          close()
          moveToRelative(8.0F, 11.75F)
          verticalLineTo(6.0F)
          horizontalLineTo(9.25F)
          curveTo(8.836F, 6.0F, 8.5F, 6.336F, 8.5F, 6.75F)
          verticalLineToRelative(11.0F)
          curveToRelative(0.0F, 0.414F, 0.336F, 0.75F, 0.75F, 0.75F)
          horizontalLineTo(15.0F)
          close()        
