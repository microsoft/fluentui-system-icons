...
public val FluentIcons.Filled.VideoClip48: ImageVector
  get() {
    if (_videoClip48 != null) {
      return _videoClip48!!
    }
    _videoClip48 = fluentIcon(name = "Filled.VideoClip48", 48f) {
      materialPath {
          moveTo(10.25F, 8.0F)
          ...
          close()
          moveTo(18.0F, 18.0F)
          curveToRelative(0.0F, -1.139F, 1.219F, -1.863F, 2.218F, -1.317F)
          lineToRelative(11.0F, 6.0F)
          curveToRelative(1.042F, 0.569F, 1.042F, 2.065F, 0.0F, 2.634F)
          lineToRelative(-11.0F, 6.0F)
          curveTo(19.218F, 31.862F, 18.0F, 31.139F, 18.0F, 30.0F)
