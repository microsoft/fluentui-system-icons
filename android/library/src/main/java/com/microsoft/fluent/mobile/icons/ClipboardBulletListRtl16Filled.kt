...
public val FluentIcons.Filled.ClipboardBulletListRtl16: ImageVector
  get() {
    if (_clipboardBulletListRtl16 != null) {
      return _clipboardBulletListRtl16!!
    }
    _clipboardBulletListRtl16 = fluentIcon(name = "Filled.ClipboardBulletListRtl16", 16f) {
      materialPath {
          moveTo(5.085F, 2.0F)
          ...
          reflectiveCurveTo(10.224F, 8.0F, 10.5F, 8.0F)
          close()
          moveToRelative(0.0F, 3.0F)
...
private var _clipboardBulletListRtl16: ImageVector? = null
