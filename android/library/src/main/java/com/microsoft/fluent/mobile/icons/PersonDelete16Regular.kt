...
public val FluentIcons.Regular.PersonDelete16: ImageVector
  get() {
    if (_personDelete16 != null) {
      return _personDelete16!!
    }
    _personDelete16 = fluentIcon(name = "Regular.PersonDelete16", 16f) {
      materialPath {
          moveTo(9.5F, 9.0F)
          ...
          reflectiveCurveTo(5.034F, 7.0F, 6.0F, 7.0F)
          reflectiveCurveToRelative(1.75F, -0.784F, 1.75F, -1.75F)
          reflectiveCurveTo(6.966F, 3.5F, 6.0F, 3.5F)
          close()
          moveToRelative(4.784F, -2.411F)
