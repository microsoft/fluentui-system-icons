...
public val FluentIcons.Regular.Triangle16: ImageVector
  get() {
    if (_triangle16 != null) {
      return _triangle16!!
    }
    _triangle16 = fluentIcon(name = "Regular.Triangle16", 16f) {
      materialPath {
          ...
          close()
          moveTo(8.44F, 2.26F)
          curveToRelative(-0.19F, -0.345F, -0.687F, -0.345F, -0.877F, 0.0F)
          lineToRelative(-5.499F, 9.999F)
          curveToRelative(-0.183F, 0.333F, 0.058F, 0.74F, 0.438F, 0.74F)
          horizontalLineTo(13.5F)
          curveToRelative(0.38F, 0.0F, 0.622F, -0.407F, 0.439F, -0.74F)
