...
public val FluentIcons.Regular.CalendarWeekNumbers24: ImageVector
  get() {
    if (_calendarWeekNumbers24 != null) {
      return _calendarWeekNumbers24!!
    }
    _calendarWeekNumbers24 = fluentIcon(name = "Regular.CalendarWeekNumbers24", 24f) {
      materialPath {
          moveTo(17.75F, 3.0F)
...
private var _calendarWeekNumbers24: ImageVector? = null
