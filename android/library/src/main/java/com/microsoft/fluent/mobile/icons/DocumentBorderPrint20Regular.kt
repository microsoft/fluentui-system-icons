...
public val FluentIcons.Regular.DocumentBorderPrint20: ImageVector
  get() {
    if (_documentBorderPrint20 != null) {
      return _documentBorderPrint20!!
    }
    _documentBorderPrint20 = fluentIcon(name = "Regular.DocumentBorderPrint20", 20f) {
      materialPath {
          moveTo(6.5F, 2.0F)
...
private var _documentBorderPrint20: ImageVector? = null
