...
public val FluentIcons.Regular.ArrowsBidirectional24: ImageVector
  get() {
    if (_arrowsBidirectional24 != null) {
      return _arrowsBidirectional24!!
    }
    _arrowsBidirectional24 = fluentIcon(name = "Regular.ArrowsBidirectional24", 24f) {
      materialPath {
          ...
          close()
          moveToRelative(-11.164F, 3.0F)
          lineToRelative(3.667F, -3.498F)
          verticalLineToRelative(1.248F)
          curveToRelative(0.0F, 0.415F, 0.337F, 0.75F, 0.75F, 0.75F)
