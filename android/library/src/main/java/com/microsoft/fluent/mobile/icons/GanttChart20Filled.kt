...
public val FluentIcons.Filled.GanttChart20: ImageVector
  get() {
    if (_ganttChart20 != null) {
      return _ganttChart20!!
    }
    _ganttChart20 = fluentIcon(name = "Filled.GanttChart20", 20f) {
      materialPath {
          moveTo(2.0F, 6.5F)
          ...
          reflectiveCurveTo(16.328F, 13.0F, 15.5F, 13.0F)
          close()
...
private var _ganttChart20: ImageVector? = null
