...
public val FluentIcons.Regular.ClipboardCheckmark16: ImageVector
  get() {
    if (_clipboardCheckmark16 != null) {
      return _clipboardCheckmark16!!
    }
    _clipboardCheckmark16 = fluentIcon(name = "Regular.ClipboardCheckmark16", 16f) {
      materialPath {
          moveTo(5.085F, 2.0F)
...
private var _clipboardCheckmark16: ImageVector? = null
