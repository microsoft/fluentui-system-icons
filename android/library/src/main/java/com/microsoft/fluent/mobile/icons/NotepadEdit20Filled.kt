...
public val FluentIcons.Filled.NotepadEdit20: ImageVector
  get() {
    if (_notepadEdit20 != null) {
      return _notepadEdit20!!
    }
    _notepadEdit20 = fluentIcon(name = "Filled.NotepadEdit20", 20f) {
      materialPath {
          ...
          lineToRelative(4.83F, -4.83F)
          curveTo(15.368F, 9.575F, 15.674F, 9.372F, 16.0F, 9.233F)
          verticalLineTo(4.5F)
...
private var _notepadEdit20: ImageVector? = null
