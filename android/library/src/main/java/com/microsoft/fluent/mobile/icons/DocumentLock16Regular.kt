...
public val FluentIcons.Regular.DocumentLock16: ImageVector
  get() {
    if (_documentLock16 != null) {
      return _documentLock16!!
    }
    _documentLock16 = fluentIcon(name = "Regular.DocumentLock16", 16f) {
      materialPath {
          moveTo(6.0F, 1.0F)
          ...
          reflectiveCurveTo(4.75F, 12.414F, 4.75F, 12.0F)
          reflectiveCurveToRelative(0.336F, -0.75F, 0.75F, -0.75F)
          close()        
      }
    }
...
private var _documentLock16: ImageVector? = null
