...
public val FluentIcons.Regular.CalendarMonth20: ImageVector
  get() {
    if (_calendarMonth20 != null) {
      return _calendarMonth20!!
    }
    _calendarMonth20 = fluentIcon(name = "Regular.CalendarMonth20", 20f) {
      materialPath {
          moveTo(14.5F, 3.0F)
...
private var _calendarMonth20: ImageVector? = null
