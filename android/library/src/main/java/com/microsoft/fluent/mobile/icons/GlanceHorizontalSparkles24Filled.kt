...
public val FluentIcons.Filled.GlanceHorizontalSparkles24: ImageVector
  get() {
    if (_glanceHorizontalSparkles24 != null) {
      return _glanceHorizontalSparkles24!!
    }
    _glanceHorizontalSparkles24 = fluentIcon(name = "Filled.GlanceHorizontalSparkles24", 24f) {
      materialPath {
          ...
          curveTo(11.082F, 13.706F, 11.835F, 13.0F, 12.753F, 13.0F)
          horizontalLineToRelative(6.5F)
          close()        
      }
    }
