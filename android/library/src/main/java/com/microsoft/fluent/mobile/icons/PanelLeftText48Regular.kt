...
public val FluentIcons.Regular.PanelLeftText48: ImageVector
  get() {
    if (_panelLeftText48 != null) {
      return _panelLeftText48!!
    }
    _panelLeftText48 = fluentIcon(name = "Regular.PanelLeftText48", 48f) {
      materialPath {
          moveTo(8.5F, 15.0F)
...
private var _panelLeftText48: ImageVector? = null
