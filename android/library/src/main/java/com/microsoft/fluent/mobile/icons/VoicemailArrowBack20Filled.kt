...
public val FluentIcons.Filled.VoicemailArrowBack20: ImageVector
  get() {
    if (_voicemailArrowBack20 != null) {
      return _voicemailArrowBack20!!
    }
    _voicemailArrowBack20 = fluentIcon(name = "Filled.VoicemailArrowBack20", 20f) {
      materialPath {
          moveTo(6.0F, 10.0F)
          ...
          curveToRelative(0.0F, -1.715F, 0.785F, -3.246F, 2.015F, -4.255F)
...
private var _voicemailArrowBack20: ImageVector? = null
