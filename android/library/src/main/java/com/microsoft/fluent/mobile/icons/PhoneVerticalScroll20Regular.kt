...
public val FluentIcons.Regular.PhoneVerticalScroll20: ImageVector
  get() {
    if (_phoneVerticalScroll20 != null) {
      return _phoneVerticalScroll20!!
    }
    _phoneVerticalScroll20 = fluentIcon(name = "Regular.PhoneVerticalScroll20", 20f) {
      materialPath {
