...
public val FluentIcons.Regular.DocumentAdd16: ImageVector
  get() {
    if (_documentAdd16 != null) {
      return _documentAdd16!!
    }
    _documentAdd16 = fluentIcon(name = "Regular.DocumentAdd16", 16f) {
      materialPath {
          moveTo(6.0F, 1.0F)
...
private var _documentAdd16: ImageVector? = null
