...
public val FluentIcons.Regular.MailArrowDoubleBack24: ImageVector
  get() {
    if (_mailArrowDoubleBack24 != null) {
      return _mailArrowDoubleBack24!!
    }
    _mailArrowDoubleBack24 = fluentIcon(name = "Regular.MailArrowDoubleBack24", 24f) {
      materialPath {
          moveTo(17.5F, 12.0F)
          ...
          reflectiveCurveTo(20.5F, 8.276F, 20.5F, 8.0F)
          verticalLineTo(7.5F)
          curveTo(20.5F, 7.224F, 20.276F, 7.0F, 20.0F, 7.0F)
...
private var _mailArrowDoubleBack24: ImageVector? = null
