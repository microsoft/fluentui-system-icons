...
public val FluentIcons.Filled.Battery320: ImageVector
  get() {
    if (_battery320 != null) {
      return _battery320!!
    }
    _battery320 = fluentIcon(name = "Filled.Battery320", 320f) {
      materialPath {
          ...
          curveTo(6.627F, 12.946F, 7.0F, 12.572F, 7.0F, 12.111F)
