...
public val FluentIcons.Filled.Print16: ImageVector
  get() {
    if (_print16 != null) {
      return _print16!!
    }
    _print16 = fluentIcon(name = "Filled.Print16", 16f) {
      materialPath {
          moveTo(4.0F, 3.5F)
          ...
          curveTo(1.672F, 12.0F, 1.0F, 11.328F, 1.0F, 10.5F)
          verticalLineTo(6.0F)
...
private var _print16: ImageVector? = null
