...
public val FluentIcons.Filled.PanelLeftHeaderAdd24: ImageVector
  get() {
    if (_panelLeftHeaderAdd24 != null) {
      return _panelLeftHeaderAdd24!!
    }
    _panelLeftHeaderAdd24 = fluentIcon(name = "Filled.PanelLeftHeaderAdd24", 24f) {
      materialPath {
          moveTo(2.0F, 7.25F)
...
private var _panelLeftHeaderAdd24: ImageVector? = null
