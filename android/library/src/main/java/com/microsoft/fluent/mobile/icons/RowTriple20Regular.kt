...
public val FluentIcons.Regular.RowTriple20: ImageVector
  get() {
    if (_rowTriple20 != null) {
      return _rowTriple20!!
    }
    _rowTriple20 = fluentIcon(name = "Regular.RowTriple20", 20f) {
      materialPath {
          moveTo(3.0F, 3.5F)
          ...
          horizontalLineToRelative(11.0F)
          curveTo(15.776F, 5.0F, 16.0F, 4.776F, 16.0F, 4.5F)
          verticalLineToRelative(-1.0F)
