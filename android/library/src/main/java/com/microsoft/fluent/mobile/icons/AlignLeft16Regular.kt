...
public val FluentIcons.Regular.AlignLeft16: ImageVector
  get() {
    if (_alignLeft16 != null) {
      return _alignLeft16!!
    }
    _alignLeft16 = fluentIcon(name = "Regular.AlignLeft16", 16f) {
      materialPath {
          moveTo(2.0F, 1.5F)
          ...
          verticalLineToRelative(1.5F)
          curveTo(13.0F, 5.664F, 12.664F, 6.0F, 12.25F, 6.0F)
          horizontalLineToRelative(-6.5F)
          curveTo(5.336F, 6.0F, 5.0F, 5.664F, 5.0F, 5.25F)
          verticalLineToRelative(-1.5F)
          close()
          moveTo(5.75F, 9.0F)
          ...
          close()
          moveTo(5.0F, 10.75F)
          curveTo(5.0F, 10.336F, 5.336F, 10.0F, 5.75F, 10.0F)
          horizontalLineToRelative(4.5F)
