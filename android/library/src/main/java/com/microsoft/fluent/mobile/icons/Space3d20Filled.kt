...
public val FluentIcons.Filled.Space3d20: ImageVector
  get() {
    if (_space3d20 != null) {
      return _space3d20!!
    }
    _space3d20 = fluentIcon(name = "Filled.Space3d20", 320f) {
      materialPath {
          moveTo(3.0F, 6.0F)
