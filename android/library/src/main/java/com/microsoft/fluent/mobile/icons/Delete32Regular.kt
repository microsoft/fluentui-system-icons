...
public val FluentIcons.Regular.Delete32: ImageVector
  get() {
    if (_delete32 != null) {
      return _delete32!!
    }
    _delete32 = fluentIcon(name = "Regular.Delete32", 32f) {
      materialPath {
          moveTo(13.5F, 6.5F)
          verticalLineTo(7.0F)
          ...
          curveToRelative(1.525F, 0.0F, 2.808F, -1.144F, 2.98F, -2.66F)
          lineTo(24.48F, 9.0F)
