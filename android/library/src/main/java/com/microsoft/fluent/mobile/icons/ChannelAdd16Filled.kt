...
public val FluentIcons.Filled.ChannelAdd16: ImageVector
  get() {
    if (_channelAdd16 != null) {
      return _channelAdd16!!
    }
    _channelAdd16 = fluentIcon(name = "Filled.ChannelAdd16", 16f) {
      materialPath {
          moveTo(1.63F, 2.29F)
...
private var _channelAdd16: ImageVector? = null
