...
public val FluentIcons.Regular.Grid16: ImageVector
  get() {
    if (_grid16 != null) {
      return _grid16!!
    }
    _grid16 = fluentIcon(name = "Regular.Grid16", 16f) {
      materialPath {
          moveTo(3.5F, 2.0F)
          ...
          horizontalLineToRelative(2.0F)
          curveTo(6.328F, 9.0F, 7.0F, 9.672F, 7.0F, 10.5F)
          verticalLineToRelative(2.0F)
          curveTo(7.0F, 13.328F, 6.328F, 14.0F, 5.5F, 14.0F)
          horizontalLineToRelative(-2.0F)
