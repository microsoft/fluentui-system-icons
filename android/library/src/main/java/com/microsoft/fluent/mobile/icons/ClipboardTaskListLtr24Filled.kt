...
public val FluentIcons.Filled.ClipboardTaskListLtr24: ImageVector
  get() {
    if (_clipboardTaskListLtr24 != null) {
      return _clipboardTaskListLtr24!!
    }
    _clipboardTaskListLtr24 = fluentIcon(name = "Filled.ClipboardTaskListLtr24", 24f) {
      materialPath {
          moveTo(13.75F, 2.0F)
          ...
          horizontalLineToRelative(-3.5F)
          curveToRelative(-0.414F, 0.0F, -0.75F, -0.336F, -0.75F, -0.75F)
          reflectiveCurveTo(12.836F, 15.0F, 13.25F, 15.0F)
          close()
...
private var _clipboardTaskListLtr24: ImageVector? = null
