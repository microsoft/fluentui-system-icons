...
public val FluentIcons.Filled.ClipboardText32: ImageVector
  get() {
    if (_clipboardText32 != null) {
      return _clipboardText32!!
    }
    _clipboardText32 = fluentIcon(name = "Filled.ClipboardText32", 32f) {
      materialPath {
          moveTo(21.83F, 4.0F)
...
private var _clipboardText32: ImageVector? = null
