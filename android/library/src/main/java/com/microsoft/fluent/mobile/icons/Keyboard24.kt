...
public val FluentIcons.Regular.Keyboard24: ImageVector
  get() {
    if (_keyboard24 != null) {
      return _keyboard24!!
    }
    _keyboard24 = fluentIcon(name = "Regular.Keyboard24", 24f) {
      materialPath {
          moveTo(19.745F, 5.0F)
...
private var _keyboard24: ImageVector? = null
