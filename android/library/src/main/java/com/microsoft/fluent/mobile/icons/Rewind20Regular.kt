...
public val FluentIcons.Regular.Rewind20: ImageVector
  get() {
    if (_rewind20 != null) {
      return _rewind20!!
    }
    _rewind20 = fluentIcon(name = "Regular.Rewind20", 20f) {
      materialPath {
          moveTo(10.0F, 5.487F)
          ...
          lineToRelative(-5.88F, -4.312F)
          curveToRelative(-0.135F, -0.1F, -0.135F, -0.303F, 0.0F, -0.403F)
          close()
