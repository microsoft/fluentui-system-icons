...
public val FluentIcons.Filled.DeleteArrowBack20: ImageVector
  get() {
    if (_deleteArrowBack20 != null) {
      return _deleteArrowBack20!!
    }
    _deleteArrowBack20 = fluentIcon(name = "Filled.DeleteArrowBack20", 20f) {
      materialPath {
          moveTo(11.5F, 4.0F)
...
private var _deleteArrowBack20: ImageVector? = null
