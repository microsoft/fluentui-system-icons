...
public val FluentIcons.Regular.ArrowFlowDiagonalUpRight16: ImageVector
  get() {
    if (_arrowFlowDiagonalUpRight16 != null) {
      return _arrowFlowDiagonalUpRight16!!
    }
    _arrowFlowDiagonalUpRight16 = fluentIcon(name = "Regular.ArrowFlowDiagonalUpRight16", 16f) {
      materialPath {
          moveTo(8.5F, 3.0F)
