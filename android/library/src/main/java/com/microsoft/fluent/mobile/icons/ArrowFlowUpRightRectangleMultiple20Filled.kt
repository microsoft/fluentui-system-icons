...
public val FluentIcons.Filled.ArrowFlowUpRightRectangleMultiple20: ImageVector
  get() {
    if (_arrowFlowUpRightRectangleMultiple20 != null) {
      return _arrowFlowUpRightRectangleMultiple20!!
    }
    _arrowFlowUpRightRectangleMultiple20 = fluentIcon(name = "Filled.ArrowFlowUpRightRectangleMultiple20", 20f) {
      materialPath {
          moveTo(11.0F, 12.5F)
          ...
          curveToRelative(0.0F, -0.276F, -0.224F, -0.5F, -0.5F, -0.5F)
          reflectiveCurveTo(18.0F, 14.224F, 18.0F, 14.5F)
...
private var _arrowFlowUpRightRectangleMultiple20: ImageVector? = null
