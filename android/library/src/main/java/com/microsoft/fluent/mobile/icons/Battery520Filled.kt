...
public val FluentIcons.Filled.Battery520: ImageVector
  get() {
    if (_battery520 != null) {
      return _battery520!!
    }
    _battery520 = fluentIcon(name = "Filled.Battery520", 520f) {
      materialPath {
          ...
          curveTo(8.627F, 12.946F, 9.0F, 12.572F, 9.0F, 12.111F)
