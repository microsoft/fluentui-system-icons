...
public val FluentIcons.Regular.PersonArrowRight20: ImageVector
  get() {
    if (_personArrowRight20 != null) {
      return _personArrowRight20!!
    }
    _personArrowRight20 = fluentIcon(name = "Regular.PersonArrowRight20", 20f) {
      materialPath {
          moveTo(9.0F, 2.0F)
...
private var _personArrowRight20: ImageVector? = null
