...
public val FluentIcons.Regular.TextAlignCenterRotate27020: ImageVector
  get() {
    if (_textAlignCenterRotate27020 != null) {
      return _textAlignCenterRotate27020!!
    }
    _textAlignCenterRotate27020 = fluentIcon(name = "Regular.TextAlignCenterRotate27020", 27020f) {
      materialPath {
          moveTo(4.5F, 16.0F)
...
private var _textAlignCenterRotate27020: ImageVector? = null
