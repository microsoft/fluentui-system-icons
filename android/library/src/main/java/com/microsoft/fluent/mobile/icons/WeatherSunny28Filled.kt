...
public val FluentIcons.Filled.WeatherSunny28: ImageVector
  get() {
    if (_weatherSunny28 != null) {
      return _weatherSunny28!!
    }
    _weatherSunny28 = fluentIcon(name = "Filled.WeatherSunny28", 28f) {
      materialPath {
          moveTo(14.0F, 2.0F)
          ...
          close()
          moveTo(4.25F, 14.75F)
          curveTo(4.664F, 14.75F, 5.0F, 14.414F, 5.0F, 14.0F)
          reflectiveCurveToRelative(-0.336F, -0.75F, -0.75F, -0.75F)
...
private var _weatherSunny28: ImageVector? = null
