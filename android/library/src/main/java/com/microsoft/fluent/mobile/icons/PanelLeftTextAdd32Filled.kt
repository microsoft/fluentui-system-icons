...
public val FluentIcons.Filled.PanelLeftTextAdd32: ImageVector
  get() {
    if (_panelLeftTextAdd32 != null) {
      return _panelLeftTextAdd32!!
    }
    _panelLeftTextAdd32 = fluentIcon(name = "Filled.PanelLeftTextAdd32", 32f) {
      materialPath {
          moveTo(2.0F, 8.5F)
...
private var _panelLeftTextAdd32: ImageVector? = null
