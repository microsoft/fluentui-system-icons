...
public val FluentIcons.Regular.WindowApps48: ImageVector
  get() {
    if (_windowApps48 != null) {
      return _windowApps48!!
    }
    _windowApps48 = fluentIcon(name = "Regular.WindowApps48", 48f) {
      materialPath {
          moveTo(12.25F, 6.0F)
...
private var _windowApps48: ImageVector? = null
