...
public val FluentIcons.Filled.TvUsb24: ImageVector
  get() {
    if (_tvUsb24 != null) {
      return _tvUsb24!!
    }
    _tvUsb24 = fluentIcon(name = "Filled.TvUsb24", 24f) {
      materialPath {
          moveTo(4.75F, 3.0F)
          ...
          curveTo(16.057F, 17.793F, 16.0F, 17.602F, 16.0F, 17.408F)
          ...
          curveToRelative(0.0F, 0.198F, -0.058F, 0.39F, -0.167F, 0.554F)
          lineTo(21.5F, 20.0F)
          verticalLineToRelative(2.0F)
          curveToRelative(0.0F, 0.552F, -0.448F, 1.0F, -1.0F, 1.0F)
...
private var _tvUsb24: ImageVector? = null
