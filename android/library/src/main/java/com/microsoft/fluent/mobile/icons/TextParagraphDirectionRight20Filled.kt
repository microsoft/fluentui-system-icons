...
public val FluentIcons.Filled.TextParagraphDirectionRight20: ImageVector
  get() {
    if (_textParagraphDirectionRight20 != null) {
      return _textParagraphDirectionRight20!!
    }
    _textParagraphDirectionRight20 = fluentIcon(name = "Filled.TextParagraphDirectionRight20", 20f) {
      materialPath {
          moveTo(11.5F, 3.0F)
