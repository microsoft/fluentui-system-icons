...
public val FluentIcons.Regular.PanelLeftTextAdd48: ImageVector
  get() {
    if (_panelLeftTextAdd48 != null) {
      return _panelLeftTextAdd48!!
    }
    _panelLeftTextAdd48 = fluentIcon(name = "Regular.PanelLeftTextAdd48", 48f) {
      materialPath {
          moveTo(8.5F, 15.0F)
...
private var _panelLeftTextAdd48: ImageVector? = null
