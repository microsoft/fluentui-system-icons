...
public val FluentIcons.Regular.PollHorizontal20: ImageVector
  get() {
    if (_pollHorizontal20 != null) {
      return _pollHorizontal20!!
    }
    _pollHorizontal20 = fluentIcon(name = "Regular.PollHorizontal20", 20f) {
      materialPath {
          moveTo(16.0F, 8.0F)
          ...
          moveTo(8.0F, 2.0F)
          curveToRelative(1.105F, 0.0F, 2.0F, 0.895F, 2.0F, 2.0F)
          reflectiveCurveTo(9.105F, 6.0F, 8.0F, 6.0F)
          horizontalLineTo(4.0F)
          curveTo(2.895F, 6.0F, 2.0F, 5.105F, 2.0F, 4.0F)
          reflectiveCurveToRelative(0.895F, -2.0F, 2.0F, -2.0F)
