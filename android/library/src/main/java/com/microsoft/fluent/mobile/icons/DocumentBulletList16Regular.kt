...
public val FluentIcons.Regular.DocumentBulletList16: ImageVector
  get() {
    if (_documentBulletList16 != null) {
      return _documentBulletList16!!
    }
    _documentBulletList16 = fluentIcon(name = "Regular.DocumentBulletList16", 16f) {
      materialPath {
          moveTo(5.0F, 1.0F)
          ...
          close()
          moveTo(5.5F, 12.0F)
          curveTo(5.776F, 12.0F, 6.0F, 11.776F, 6.0F, 11.5F)
          reflectiveCurveTo(5.776F, 11.0F, 5.5F, 11.0F)
          reflectiveCurveTo(5.0F, 11.224F, 5.0F, 11.5F)
