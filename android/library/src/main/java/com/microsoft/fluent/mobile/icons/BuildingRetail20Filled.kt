...
public val FluentIcons.Filled.BuildingRetail20: ImageVector
  get() {
    if (_buildingRetail20 != null) {
      return _buildingRetail20!!
    }
    _buildingRetail20 = fluentIcon(name = "Filled.BuildingRetail20", 20f) {
      materialPath {
          moveTo(6.0F, 10.0F)
          verticalLineTo(8.0F)
...
private var _buildingRetail20: ImageVector? = null
