...
public val FluentIcons.Regular.Receipt28: ImageVector
  get() {
    if (_receipt28 != null) {
      return _receipt28!!
    }
    _receipt28 = fluentIcon(name = "Regular.Receipt28", 28f) {
      materialPath {
          moveTo(3.0F, 5.75F)
          curveTo(3.0F, 4.231F, 4.231F, 3.0F, 5.75F, 3.0F)
          horizontalLineToRelative(11.5F)
          curveTo(18.769F, 3.0F, 20.0F, 4.231F, 20.0F, 5.75F)
          ...
          close()
          moveTo(7.75F, 18.0F)
          curveTo(7.336F, 18.0F, 7.0F, 18.336F, 7.0F, 18.75F)
          reflectiveCurveToRelative(0.336F, 0.75F, 0.75F, 0.75F)
...
private var _receipt28: ImageVector? = null
