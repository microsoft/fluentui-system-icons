...
public val FluentIcons.Regular.Patient24: ImageVector
  get() {
    if (_patient24 != null) {
      return _patient24!!
    }
    _patient24 = fluentIcon(name = "Regular.Patient24", 24f) {
      materialPath {
          moveTo(17.75F, 2.0F)
...
private var _patient24: ImageVector? = null
