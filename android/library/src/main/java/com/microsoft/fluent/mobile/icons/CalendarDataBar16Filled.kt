...
public val FluentIcons.Filled.CalendarDataBar16: ImageVector
  get() {
    if (_calendarDataBar16 != null) {
      return _calendarDataBar16!!
    }
    _calendarDataBar16 = fluentIcon(name = "Filled.CalendarDataBar16", 16f) {
      materialPath {
          moveTo(12.0F, 6.0F)
          ...
          curveTo(9.706F, 10.098F, 9.364F, 10.0F, 9.0F, 10.0F)
          curveToRelative(-1.105F, 0.0F, -2.0F, 0.895F, -2.0F, 2.0F)
          verticalLineToRelative(2.0F)
