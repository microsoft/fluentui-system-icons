...
public val FluentIcons.Filled.MailInboxAll20: ImageVector
  get() {
    if (_mailInboxAll20 != null) {
      return _mailInboxAll20!!
    }
    _mailInboxAll20 = fluentIcon(name = "Filled.MailInboxAll20", 20f) {
      materialPath {
          moveTo(6.0F, 5.5F)
...
private var _mailInboxAll20: ImageVector? = null
