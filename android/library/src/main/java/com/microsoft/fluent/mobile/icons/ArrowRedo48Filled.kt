...
public val FluentIcons.Filled.ArrowRedo48: ImageVector
  get() {
    if (_arrowRedo48 != null) {
      return _arrowRedo48!!
    }
    _arrowRedo48 = fluentIcon(name = "Filled.ArrowRedo48", 48f) {
      materialPath {
          moveTo(41.002F, 5.5F)
          ...
          lineTo(35.776F, 19.0F)
          horizontalLineTo(24.502F)
...
private var _arrowRedo48: ImageVector? = null
