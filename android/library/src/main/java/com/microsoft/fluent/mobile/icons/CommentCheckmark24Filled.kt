...
public val FluentIcons.Filled.CommentCheckmark24: ImageVector
  get() {
    if (_commentCheckmark24 != null) {
      return _commentCheckmark24!!
    }
    _commentCheckmark24 = fluentIcon(name = "Filled.CommentCheckmark24", 24f) {
      materialPath {
          moveTo(23.0F, 6.5F)
          ...
          curveTo(11.375F, 4.01F, 11.0F, 5.211F, 11.0F, 6.5F)
...
private var _commentCheckmark24: ImageVector? = null
