...
public val FluentIcons.Filled.DocumentBulletListArrowLeft16: ImageVector
  get() {
    if (_documentBulletListArrowLeft16 != null) {
      return _documentBulletListArrowLeft16!!
    }
    _documentBulletListArrowLeft16 = fluentIcon(name = "Filled.DocumentBulletListArrowLeft16", 16f) {
      materialPath {
          moveTo(9.0F, 1.0F)
          ...
          curveToRelative(0.73F, -0.514F, 1.328F, -1.2F, 1.737F, -2.0F)
          ...
          horizontalLineToRelative(-1.1F)
          curveTo(9.49F, 6.22F, 7.637F, 5.0F, 5.5F, 5.0F)
          ...
          curveTo(3.014F, 10.367F, 3.0F, 10.43F, 3.0F, 10.497F)
...
private var _documentBulletListArrowLeft16: ImageVector? = null
