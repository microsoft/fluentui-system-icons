...
public val FluentIcons.Filled.DocumentArrowLeft20: ImageVector
  get() {
    if (_documentArrowLeft20 != null) {
      return _documentArrowLeft20!!
    }
    _documentArrowLeft20 = fluentIcon(name = "Filled.DocumentArrowLeft20", 20f) {
      materialPath {
          moveTo(10.0F, 2.0F)
...
private var _documentArrowLeft20: ImageVector? = null
