...
public val FluentIcons.Filled.CommentArrowLeft12: ImageVector
  get() {
    if (_commentArrowLeft12 != null) {
      return _commentArrowLeft12!!
    }
    _commentArrowLeft12 = fluentIcon(name = "Filled.CommentArrowLeft12", 12f) {
      materialPath {
          moveTo(12.0F, 3.5F)
...
private var _commentArrowLeft12: ImageVector? = null
