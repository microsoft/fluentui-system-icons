...
public val FluentIcons.Regular.MailPause20: ImageVector
  get() {
    if (_mailPause20 != null) {
      return _mailPause20!!
    }
    _mailPause20 = fluentIcon(name = "Regular.MailPause20", 20f) {
      materialPath {
          moveTo(17.0F, 14.5F)
...
private var _mailPause20: ImageVector? = null
