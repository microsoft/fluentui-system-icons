...
public val FluentIcons.Regular.DocumentError20: ImageVector
  get() {
    if (_documentError20 != null) {
      return _documentError20!!
    }
    _documentError20 = fluentIcon(name = "Regular.DocumentError20", 20f) {
      materialPath {
          moveTo(6.0F, 2.0F)
...
private var _documentError20: ImageVector? = null
