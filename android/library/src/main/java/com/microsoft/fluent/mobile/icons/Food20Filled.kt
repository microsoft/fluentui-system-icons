...
public val FluentIcons.Filled.Food20: ImageVector
  get() {
    if (_food20 != null) {
      return _food20!!
    }
    _food20 = fluentIcon(name = "Filled.Food20", 20f) {
      materialPath {
          moveTo(9.5F, 3.0F)
          ...
          curveTo(5.914F, 8.73F, 5.083F, 7.804F, 5.007F, 6.671F)
          lineTo(5.0F, 6.5F)
          verticalLineToRelative(-3.0F)
          ...
          curveToRelative(0.538F, -0.19F, 0.935F, -0.678F, 0.993F, -1.265F)
          lineTo(9.0F, 6.5F)
          verticalLineToRelative(-3.0F)
...
private var _food20: ImageVector? = null
