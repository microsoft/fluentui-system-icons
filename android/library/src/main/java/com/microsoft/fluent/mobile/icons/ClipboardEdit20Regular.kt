...
public val FluentIcons.Regular.ClipboardEdit20: ImageVector
  get() {
    if (_clipboardEdit20 != null) {
      return _clipboardEdit20!!
    }
    _clipboardEdit20 = fluentIcon(name = "Regular.ClipboardEdit20", 20f) {
      materialPath {
          moveTo(8.5F, 2.0F)
...
private var _clipboardEdit20: ImageVector? = null
