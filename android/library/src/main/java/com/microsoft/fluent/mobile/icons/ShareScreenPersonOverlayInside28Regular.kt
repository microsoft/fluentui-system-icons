...
public val FluentIcons.Regular.ShareScreenPersonOverlayInside28: ImageVector
  get() {
    if (_shareScreenPersonOverlayInside28 != null) {
      return _shareScreenPersonOverlayInside28!!
    }
    _shareScreenPersonOverlayInside28 = fluentIcon(name = "Regular.ShareScreenPersonOverlayInside28", 28f) {
      materialPath {
          moveTo(6.5F, 7.0F)
          ...
          reflectiveCurveTo(16.0F, 11.88F, 16.0F, 10.5F)
          reflectiveCurveTo(17.12F, 8.0F, 18.5F, 8.0F)
          reflectiveCurveTo(21.0F, 9.12F, 21.0F, 10.5F)
          close()
...
private var _shareScreenPersonOverlayInside28: ImageVector? = null
