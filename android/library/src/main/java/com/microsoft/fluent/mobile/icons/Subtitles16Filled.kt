...
public val FluentIcons.Filled.Subtitles16: ImageVector
  get() {
    if (_subtitles16 != null) {
      return _subtitles16!!
    }
    _subtitles16 = fluentIcon(name = "Filled.Subtitles16", 16f) {
      materialPath {
          moveTo(1.0F, 5.5F)
          ...
          close()
          moveTo(10.0F, 8.5F)
          curveTo(10.0F, 8.776F, 10.224F, 9.0F, 10.5F, 9.0F)
...
private var _subtitles16: ImageVector? = null
