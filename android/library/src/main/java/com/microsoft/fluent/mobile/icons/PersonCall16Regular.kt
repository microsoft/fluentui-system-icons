...
public val FluentIcons.Regular.PersonCall16: ImageVector
  get() {
    if (_personCall16 != null) {
      return _personCall16!!
    }
    _personCall16 = fluentIcon(name = "Regular.PersonCall16", 16f) {
      materialPath {
          moveTo(7.067F, 12.926F)
          curveToRelative(-0.084F, 0.333F, -0.089F, 0.679F, -0.016F, 1.009F)
          curveTo(4.488F, 13.573F, 3.0F, 11.764F, 3.0F, 10.0F)
          verticalLineTo(9.5F)
          curveTo(3.0F, 8.672F, 3.672F, 8.0F, 4.5F, 8.0F)
          horizontalLineToRelative(6.023F)
          curveToRelative(0.015F, 0.355F, 0.127F, 0.701F, 0.328F, 1.0F)
          horizontalLineTo(4.5F)
          curveTo(4.224F, 9.0F, 4.0F, 9.224F, 4.0F, 9.5F)
          verticalLineTo(10.0F)
          curveToRelative(0.0F, 1.253F, 1.088F, 2.6F, 3.067F, 2.926F)
          close()
          moveTo(8.0F, 1.5F)
...
private var _personCall16: ImageVector? = null
