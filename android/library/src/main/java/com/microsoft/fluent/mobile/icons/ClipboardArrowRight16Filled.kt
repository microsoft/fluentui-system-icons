...
public val FluentIcons.Filled.ClipboardArrowRight16: ImageVector
  get() {
    if (_clipboardArrowRight16 != null) {
      return _clipboardArrowRight16!!
    }
    _clipboardArrowRight16 = fluentIcon(name = "Filled.ClipboardArrowRight16", 16f) {
      materialPath {
          moveTo(5.085F, 2.0F)
...
private var _clipboardArrowRight16: ImageVector? = null
