...
public val FluentIcons.Filled.PanelRightContract20: ImageVector
  get() {
    if (_panelRightContract20 != null) {
      return _panelRightContract20!!
    }
    _panelRightContract20 = fluentIcon(name = "Filled.PanelRightContract20", 20f) {
      materialPath {
          moveTo(9.179F, 10.5F)
...
private var _panelRightContract20: ImageVector? = null
