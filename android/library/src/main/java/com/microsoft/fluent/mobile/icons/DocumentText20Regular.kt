...
public val FluentIcons.Regular.DocumentText20: ImageVector
  get() {
    if (_documentText20 != null) {
      return _documentText20!!
    }
    _documentText20 = fluentIcon(name = "Regular.DocumentText20", 20f) {
      materialPath {
          moveTo(6.5F, 10.0F)
...
private var _documentText20: ImageVector? = null
