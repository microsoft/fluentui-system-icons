...
public val FluentIcons.Regular.SidebarSearchRtl20: ImageVector
  get() {
    if (_sidebarSearchRtl20 != null) {
      return _sidebarSearchRtl20!!
    }
    _sidebarSearchRtl20 = fluentIcon(name = "Regular.SidebarSearchRtl20", 20f) {
      materialPath {
          moveTo(3.0F, 5.5F)
          ...
          lineToRelative(-2.55F, -2.55F)
          curveTo(14.012F, 15.74F, 13.286F, 16.0F, 12.5F, 16.0F)
