...
public val FluentIcons.Filled.GiftCardArrowRight24: ImageVector
  get() {
    if (_giftCardArrowRight24 != null) {
      return _giftCardArrowRight24!!
    }
    _giftCardArrowRight24 = fluentIcon(name = "Filled.GiftCardArrowRight24", 24f) {
      materialPath {
          moveTo(8.0F, 2.0F)
