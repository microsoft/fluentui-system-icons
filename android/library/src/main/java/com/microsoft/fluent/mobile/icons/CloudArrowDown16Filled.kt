...
public val FluentIcons.Filled.CloudArrowDown16: ImageVector
  get() {
    if (_cloudArrowDown16 != null) {
      return _cloudArrowDown16!!
    }
    _cloudArrowDown16 = fluentIcon(name = "Filled.CloudArrowDown16", 16f) {
      materialPath {
          moveTo(4.03F, 5.507F)
          ...
          curveTo(10.367F, 12.986F, 10.43F, 13.0F, 10.497F, 13.0F)
...
private var _cloudArrowDown16: ImageVector? = null
