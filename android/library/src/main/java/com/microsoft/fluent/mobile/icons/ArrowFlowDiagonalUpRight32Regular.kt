...
public val FluentIcons.Regular.ArrowFlowDiagonalUpRight32: ImageVector
  get() {
    if (_arrowFlowDiagonalUpRight32 != null) {
      return _arrowFlowDiagonalUpRight32!!
    }
    _arrowFlowDiagonalUpRight32 = fluentIcon(name = "Regular.ArrowFlowDiagonalUpRight32", 32f) {
      materialPath {
          moveTo(17.0F, 5.0F)
