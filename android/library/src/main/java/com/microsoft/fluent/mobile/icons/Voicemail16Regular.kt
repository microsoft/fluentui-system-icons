...
public val FluentIcons.Regular.Voicemail16: ImageVector
  get() {
    if (_voicemail16 != null) {
      return _voicemail16!!
    }
    _voicemail16 = fluentIcon(name = "Regular.Voicemail16", 16f) {
      materialPath {
          moveTo(7.332F, 7.0F)
          ...
          close()
          moveTo(5.0F, 7.75F)
          curveTo(5.0F, 8.164F, 5.336F, 8.5F, 5.75F, 8.5F)
          reflectiveCurveTo(6.5F, 8.164F, 6.5F, 7.75F)
          reflectiveCurveTo(6.164F, 7.0F, 5.75F, 7.0F)
          reflectiveCurveTo(5.0F, 7.336F, 5.0F, 7.75F)
          close()
          moveTo(10.25F, 7.0F)
          curveTo(9.836F, 7.0F, 9.5F, 7.336F, 9.5F, 7.75F)
          reflectiveCurveTo(9.836F, 8.5F, 10.25F, 8.5F)
          reflectiveCurveTo(11.0F, 8.164F, 11.0F, 7.75F)
          reflectiveCurveTo(10.664F, 7.0F, 10.25F, 7.0F)
          close()
          moveTo(3.5F, 3.0F)
