...
public val FluentIcons.Regular.TableDeleteRow20: ImageVector
  get() {
    if (_tableDeleteRow20 != null) {
      return _tableDeleteRow20!!
    }
    _tableDeleteRow20 = fluentIcon(name = "Regular.TableDeleteRow20", 20f) {
      materialPath {
          moveTo(16.5F, 2.0F)
          ...
          curveTo(3.895F, 6.0F, 3.0F, 5.105F, 3.0F, 4.0F)
          verticalLineTo(2.5F)
...
private var _tableDeleteRow20: ImageVector? = null
