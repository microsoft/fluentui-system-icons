...
public val FluentIcons.Regular.SquareMultiple48: ImageVector
  get() {
    if (_squareMultiple48 != null) {
      return _squareMultiple48!!
    }
    _squareMultiple48 = fluentIcon(name = "Regular.SquareMultiple48", 48f) {
      materialPath {
          moveTo(16.497F, 10.0F)
          ...
          horizontalLineToRelative(-14.5F)
          curveToRelative(-1.988F, 0.0F, -3.614F, 1.546F, -3.743F, 3.5F)
          close()
          moveToRelative(-6.247F, 2.0F)
          curveTo(6.798F, 12.0F, 4.0F, 14.798F, 4.0F, 18.25F)
