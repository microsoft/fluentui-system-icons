...
public val FluentIcons.Filled.VehicleCarParking24: ImageVector
  get() {
    if (_vehicleCarParking24 != null) {
      return _vehicleCarParking24!!
    }
    _vehicleCarParking24 = fluentIcon(name = "Filled.VehicleCarParking24", 24f) {
      materialPath {
          moveTo(17.25F, 2.0F)
          ...
          curveTo(9.781F, 14.057F, 9.5F, 14.37F, 9.5F, 14.75F)
