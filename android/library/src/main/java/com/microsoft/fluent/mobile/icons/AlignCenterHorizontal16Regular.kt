...
public val FluentIcons.Regular.AlignCenterHorizontal16: ImageVector
  get() {
    if (_alignCenterHorizontal16 != null) {
      return _alignCenterHorizontal16!!
    }
    _alignCenterHorizontal16 = fluentIcon(name = "Regular.AlignCenterHorizontal16", 16f) {
      materialPath {
          moveTo(15.0F, 7.5F)
          ...
          curveTo(10.0F, 9.664F, 10.336F, 10.0F, 10.75F, 10.0F)
          horizontalLineToRelative(1.5F)
          curveTo(12.664F, 10.0F, 13.0F, 9.664F, 13.0F, 9.25F)
