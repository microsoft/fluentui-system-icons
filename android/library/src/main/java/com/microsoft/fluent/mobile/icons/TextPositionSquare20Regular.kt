...
public val FluentIcons.Regular.TextPositionSquare20: ImageVector
  get() {
    if (_textPositionSquare20 != null) {
      return _textPositionSquare20!!
    }
    _textPositionSquare20 = fluentIcon(name = "Regular.TextPositionSquare20", 20f) {
      materialPath {
          moveTo(3.0F, 3.5F)
          ...
          curveTo(4.776F, 7.0F, 5.0F, 6.776F, 5.0F, 6.5F)
          reflectiveCurveTo(4.776F, 6.0F, 4.5F, 6.0F)
          horizontalLineToRelative(-1.0F)
          close()
          moveTo(15.0F, 6.5F)
          curveTo(15.0F, 6.224F, 15.224F, 6.0F, 15.5F, 6.0F)
          horizontalLineToRelative(1.0F)
          ...
          horizontalLineToRelative(1.0F)
          curveTo(4.776F, 10.0F, 5.0F, 9.776F, 5.0F, 9.5F)
          reflectiveCurveTo(4.776F, 9.0F, 4.5F, 9.0F)
          horizontalLineToRelative(-1.0F)
          close()
          moveTo(15.0F, 9.5F)
          curveTo(15.0F, 9.224F, 15.224F, 9.0F, 15.5F, 9.0F)
          horizontalLineToRelative(1.0F)
          curveTo(16.776F, 9.0F, 17.0F, 9.224F, 17.0F, 9.5F)
          reflectiveCurveTo(16.776F, 10.0F, 16.5F, 10.0F)
          horizontalLineToRelative(-1.0F)
          curveTo(15.224F, 10.0F, 15.0F, 9.776F, 15.0F, 9.5F)
          close()
          moveTo(3.5F, 12.0F)
          curveTo(3.224F, 12.0F, 3.0F, 12.224F, 3.0F, 12.5F)
          reflectiveCurveTo(3.224F, 13.0F, 3.5F, 13.0F)
          horizontalLineToRelative(1.0F)
          curveTo(4.776F, 13.0F, 5.0F, 12.776F, 5.0F, 12.5F)
          reflectiveCurveTo(4.776F, 12.0F, 4.5F, 12.0F)
          horizontalLineToRelative(-1.0F)
          close()
          moveTo(15.0F, 12.5F)
...
private var _textPositionSquare20: ImageVector? = null
