...
public val FluentIcons.Filled.DocumentCss20: ImageVector
  get() {
    if (_documentCss20 != null) {
      return _documentCss20!!
    }
    _documentCss20 = fluentIcon(name = "Filled.DocumentCss20", 20f) {
      materialPath {
          moveTo(10.0F, 6.5F)
          verticalLineTo(2.0F)
