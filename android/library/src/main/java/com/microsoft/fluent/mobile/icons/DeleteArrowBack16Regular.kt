...
public val FluentIcons.Regular.DeleteArrowBack16: ImageVector
  get() {
    if (_deleteArrowBack16 != null) {
      return _deleteArrowBack16!!
    }
    _deleteArrowBack16 = fluentIcon(name = "Regular.DeleteArrowBack16", 16f) {
      materialPath {
          moveTo(9.0F, 3.0F)
...
private var _deleteArrowBack16: ImageVector? = null
