...
public val FluentIcons.Regular.FastForward16: ImageVector
  get() {
    if (_fastForward16 != null) {
      return _fastForward16!!
    }
    _fastForward16 = fluentIcon(name = "Regular.FastForward16", 16f) {
      materialPath {
          moveTo(2.0F, 4.465F)
