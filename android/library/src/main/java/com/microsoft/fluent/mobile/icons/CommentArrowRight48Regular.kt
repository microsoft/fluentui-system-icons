...
public val FluentIcons.Regular.CommentArrowRight48: ImageVector
  get() {
    if (_commentArrowRight48 != null) {
      return _commentArrowRight48!!
    }
    _commentArrowRight48 = fluentIcon(name = "Regular.CommentArrowRight48", 48f) {
      materialPath {
          moveTo(46.0F, 13.0F)
          curveToRelative(0.0F, 6.075F, -4.925F, 11.0F, -11.0F, 11.0F)
          reflectiveCurveToRelative(-11.0F, -4.925F, -11.0F, -11.0F)
          reflectiveCurveTo(28.925F, 2.0F, 35.0F, 2.0F)
          reflectiveCurveToRelative(11.0F, 4.925F, 11.0F, 11.0F)
          close()
...
private var _commentArrowRight48: ImageVector? = null
