...
public val FluentIcons.Filled.DocumentHeaderArrowDown20: ImageVector
  get() {
    if (_documentHeaderArrowDown20 != null) {
      return _documentHeaderArrowDown20!!
    }
    _documentHeaderArrowDown20 = fluentIcon(name = "Filled.DocumentHeaderArrowDown20", 20f) {
      materialPath {
          moveTo(6.0F, 2.0F)
          ...
          curveTo(9.472F, 17.05F, 9.0F, 15.83F, 9.0F, 14.5F)
...
private var _documentHeaderArrowDown20: ImageVector? = null
