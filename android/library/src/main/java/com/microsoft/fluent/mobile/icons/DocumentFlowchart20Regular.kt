...
public val FluentIcons.Regular.DocumentFlowchart20: ImageVector
  get() {
    if (_documentFlowchart20 != null) {
      return _documentFlowchart20!!
    }
    _documentFlowchart20 = fluentIcon(name = "Regular.DocumentFlowchart20", 20f) {
      materialPath {
          moveTo(6.0F, 7.5F)
...
private var _documentFlowchart20: ImageVector? = null
