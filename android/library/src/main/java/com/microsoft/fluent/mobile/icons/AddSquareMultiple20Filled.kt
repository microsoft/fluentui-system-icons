...
public val FluentIcons.Filled.AddSquareMultiple20: ImageVector
  get() {
    if (_addSquareMultiple20 != null) {
      return _addSquareMultiple20!!
    }
    _addSquareMultiple20 = fluentIcon(name = "Filled.AddSquareMultiple20", 20f) {
      materialPath {
          moveTo(16.0F, 5.268F)
          ...
          curveTo(9.5F, 11.776F, 9.276F, 12.0F, 9.0F, 12.0F)
...
private var _addSquareMultiple20: ImageVector? = null
