...
public val FluentIcons.Regular.Screenshot20: ImageVector
  get() {
    if (_screenshot20 != null) {
      return _screenshot20!!
    }
    _screenshot20 = fluentIcon(name = "Regular.Screenshot20", 20f) {
      materialPath {
          moveTo(6.5F, 5.0F)
          ...
          curveTo(8.776F, 6.0F, 9.0F, 5.776F, 9.0F, 5.5F)
          reflectiveCurveTo(8.776F, 5.0F, 8.5F, 5.0F)
          horizontalLineToRelative(-2.0F)
          close()
          ...
          close()
          moveTo(6.0F, 11.5F)
          curveTo(6.0F, 11.224F, 5.776F, 11.0F, 5.5F, 11.0F)
