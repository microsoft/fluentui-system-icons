...
public val FluentIcons.Regular.Battery220: ImageVector
  get() {
    if (_battery220 != null) {
      return _battery220!!
    }
    _battery220 = fluentIcon(name = "Regular.Battery220", 220f) {
      materialPath {
          moveTo(13.5F, 5.0F)
          ...
          curveToRelative(0.426F, 0.0F, 0.778F, 0.318F, 0.83F, 0.73F)
          lineTo(6.0F, 7.784F)
          verticalLineToRelative(4.327F)
          curveToRelative(0.0F, 0.426F, -0.319F, 0.777F, -0.73F, 0.829F)
          lineToRelative(-0.105F, 0.006F)
          horizontalLineToRelative(-0.33F)
          curveToRelative(-0.426F, 0.0F, -0.778F, -0.319F, -0.83F, -0.73F)
          lineTo(4.0F, 12.11F)
...
private var _battery220: ImageVector? = null
