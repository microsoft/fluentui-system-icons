...
public val FluentIcons.Regular.ClipboardCheckmark24: ImageVector
  get() {
    if (_clipboardCheckmark24 != null) {
      return _clipboardCheckmark24!!
    }
    _clipboardCheckmark24 = fluentIcon(name = "Regular.ClipboardCheckmark24", 24f) {
      materialPath {
          moveTo(13.75F, 2.0F)
          curveToRelative(1.159F, 0.0F, 2.113F, 0.876F, 2.236F, 2.002F)
          verticalLineTo(4.0F)
...
private var _clipboardCheckmark24: ImageVector? = null
