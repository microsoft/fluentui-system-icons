...
public val FluentIcons.Regular.PersonFeedback20: ImageVector
  get() {
    if (_personFeedback20 != null) {
      return _personFeedback20!!
    }
    _personFeedback20 = fluentIcon(name = "Regular.PersonFeedback20", 20f) {
      materialPath {
          moveTo(10.5F, 12.0F)
          ...
          horizontalLineToRelative(-7.0F)
          curveTo(3.224F, 13.0F, 3.0F, 13.224F, 3.0F, 13.5F)
          verticalLineTo(14.0F)
          ...
          reflectiveCurveTo(6.034F, 10.0F, 7.0F, 10.0F)
          reflectiveCurveToRelative(1.75F, -0.784F, 1.75F, -1.75F)
          reflectiveCurveTo(7.966F, 6.5F, 7.0F, 6.5F)
          close()
          moveTo(16.0F, 3.0F)
          horizontalLineToRelative(-4.0F)
