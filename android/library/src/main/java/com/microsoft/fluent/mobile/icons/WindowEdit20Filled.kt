...
public val FluentIcons.Filled.WindowEdit20: ImageVector
  get() {
    if (_windowEdit20 != null) {
      return _windowEdit20!!
    }
    _windowEdit20 = fluentIcon(name = "Filled.WindowEdit20", 20f) {
      materialPath {
          moveTo(3.0F, 6.0F)
          ...
          curveToRelative(-0.341F, 0.016F, -0.68F, 0.092F, -1.0F, 0.229F)
          verticalLineTo(7.0F)
