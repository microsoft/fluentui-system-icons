...
public val FluentIcons.Regular.ShareScreenPerson20: ImageVector
  get() {
    if (_shareScreenPerson20 != null) {
      return _shareScreenPerson20!!
    }
    _shareScreenPerson20 = fluentIcon(name = "Regular.ShareScreenPerson20", 20f) {
      materialPath {
          moveTo(4.75F, 4.0F)
...
private var _shareScreenPerson20: ImageVector? = null
