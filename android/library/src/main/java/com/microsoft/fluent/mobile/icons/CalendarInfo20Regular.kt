...
public val FluentIcons.Regular.CalendarInfo20: ImageVector
  get() {
    if (_calendarInfo20 != null) {
      return _calendarInfo20!!
    }
    _calendarInfo20 = fluentIcon(name = "Regular.CalendarInfo20", 20f) {
      materialPath {
          moveTo(14.5F, 3.0F)
...
private var _calendarInfo20: ImageVector? = null
