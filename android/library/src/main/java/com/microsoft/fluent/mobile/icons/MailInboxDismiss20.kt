...
public val FluentIcons.Regular.MailInboxDismiss20: ImageVector
  get() {
    if (_mailInboxDismiss20 != null) {
      return _mailInboxDismiss20!!
    }
    _mailInboxDismiss20 = fluentIcon(name = "Regular.MailInboxDismiss20", 20f) {
      materialPath {
          moveTo(18.0F, 5.5F)
          ...
          curveTo(8.72F, 14.32F, 9.287F, 14.5F, 10.0F, 14.5F)
          curveToRelative(0.713F, 0.0F, 1.28F, -0.18F, 1.723F, -0.475F)
...
private var _mailInboxDismiss20: ImageVector? = null
