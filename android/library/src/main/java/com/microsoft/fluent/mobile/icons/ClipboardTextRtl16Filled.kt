...
public val FluentIcons.Filled.ClipboardTextRtl16: ImageVector
  get() {
    if (_clipboardTextRtl16 != null) {
      return _clipboardTextRtl16!!
    }
    _clipboardTextRtl16 = fluentIcon(name = "Filled.ClipboardTextRtl16", 16f) {
      materialPath {
          moveTo(6.5F, 1.0F)
          ...
          curveTo(10.776F, 8.5F, 11.0F, 8.724F, 11.0F, 9.0F)
          reflectiveCurveToRelative(-0.224F, 0.5F, -0.5F, 0.5F)
          horizontalLineToRelative(-2.0F)
          curveTo(8.224F, 9.5F, 8.0F, 9.276F, 8.0F, 9.0F)
          close()
...
private var _clipboardTextRtl16: ImageVector? = null
