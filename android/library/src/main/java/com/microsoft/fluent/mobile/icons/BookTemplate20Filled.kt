...
public val FluentIcons.Filled.BookTemplate20: ImageVector
  get() {
    if (_bookTemplate20 != null) {
      return _bookTemplate20!!
    }
    _bookTemplate20 = fluentIcon(name = "Filled.BookTemplate20", 20f) {
      materialPath {
          moveTo(4.5F, 1.0F)
          ...
          curveToRelative(0.132F, -0.373F, 0.336F, -0.712F, 0.594F, -1.0F)
          horizontalLineTo(5.5F)
          curveTo(5.224F, 7.0F, 5.0F, 6.776F, 5.0F, 6.5F)
          reflectiveCurveTo(5.224F, 6.0F, 5.5F, 6.0F)
          horizontalLineTo(16.0F)
          verticalLineTo(3.5F)
          curveTo(16.0F, 2.12F, 14.88F, 1.0F, 13.5F, 1.0F)
...
private var _bookTemplate20: ImageVector? = null
