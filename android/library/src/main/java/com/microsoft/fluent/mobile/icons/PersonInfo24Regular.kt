...
public val FluentIcons.Regular.PersonInfo24: ImageVector
  get() {
    if (_personInfo24 != null) {
      return _personInfo24!!
    }
    _personInfo24 = fluentIcon(name = "Regular.PersonInfo24", 24f) {
      materialPath {
          moveTo(11.313F, 15.5F)
          curveToRelative(0.173F, -0.534F, 0.412F, -1.037F, 0.709F, -1.5F)
          horizontalLineToRelative(-6.77F)
          curveToRelative(-1.241F, 0.0F, -2.248F, 1.007F, -2.248F, 2.249F)
          ...
          curveToRelative(0.6F, 0.0F, 1.173F, -0.034F, 1.717F, -0.1F)
          curveToRelative(-0.39F, -0.425F, -0.726F, -0.902F, -0.994F, -1.42F)
          curveToRelative(-0.234F, 0.013F, -0.475F, 0.02F, -0.723F, 0.02F)
          curveToRelative(-2.738F, 0.0F, -4.704F, -0.747F, -5.957F, -2.214F)
          curveToRelative(-0.348F, -0.408F, -0.54F, -0.926F, -0.54F, -1.462F)
...
private var _personInfo24: ImageVector? = null
