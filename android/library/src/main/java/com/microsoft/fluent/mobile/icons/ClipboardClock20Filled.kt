...
public val FluentIcons.Filled.ClipboardClock20: ImageVector
  get() {
    if (_clipboardClock20 != null) {
      return _clipboardClock20!!
    }
    _clipboardClock20 = fluentIcon(name = "Filled.ClipboardClock20", 20f) {
      materialPath {
          moveTo(10.5F, 9.5F)
          curveTo(10.5F, 9.224F, 10.276F, 9.0F, 10.0F, 9.0F)
...
private var _clipboardClock20: ImageVector? = null
