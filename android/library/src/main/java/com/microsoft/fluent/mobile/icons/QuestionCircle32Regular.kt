...
public val FluentIcons.Regular.QuestionCircle32: ImageVector
  get() {
    if (_questionCircle32 != null) {
      return _questionCircle32!!
    }
    _questionCircle32 = fluentIcon(name = "Regular.QuestionCircle32", 32f) {
      materialPath {
          moveTo(17.5F, 22.0F)
          ...
          curveTo(20.618F, 10.653F, 18.692F, 8.0F, 16.0F, 8.0F)
