...
public val FluentIcons.Regular.PersonAccounts20: ImageVector
  get() {
    if (_personAccounts20 != null) {
      return _personAccounts20!!
    }
    _personAccounts20 = fluentIcon(name = "Regular.PersonAccounts20", 20f) {
      materialPath {
          moveTo(9.0F, 2.0F)
          ...
          curveToRelative(0.37F, -0.491F, 0.915F, -0.842F, 1.543F, -0.958F)
          lineTo(11.05F, 11.0F)
