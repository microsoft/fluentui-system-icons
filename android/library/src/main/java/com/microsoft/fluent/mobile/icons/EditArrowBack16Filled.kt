...
public val FluentIcons.Filled.EditArrowBack16: ImageVector
  get() {
    if (_editArrowBack16 != null) {
      return _editArrowBack16!!
    }
    _editArrowBack16 = fluentIcon(name = "Filled.EditArrowBack16", 16f) {
      materialPath {
          moveTo(9.733F, 1.56F)
          ...
          lineToRelative(0.065F, -0.064F)
          curveTo(5.038F, 11.243F, 5.0F, 10.876F, 5.0F, 10.5F)
          curveToRelative(0.0F, -2.97F, 2.353F, -5.39F, 5.297F, -5.496F)
          lineTo(8.293F, 3.0F)
          close()
          moveTo(10.5F, 15.0F)
...
private var _editArrowBack16: ImageVector? = null
