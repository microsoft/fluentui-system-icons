...
public val FluentIcons.Regular.ClipboardArrowRight20: ImageVector
  get() {
    if (_clipboardArrowRight20 != null) {
      return _clipboardArrowRight20!!
    }
    _clipboardArrowRight20 = fluentIcon(name = "Regular.ClipboardArrowRight20", 20f) {
      materialPath {
          moveTo(7.085F, 3.0F)
...
private var _clipboardArrowRight20: ImageVector? = null
