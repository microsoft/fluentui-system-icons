...
public val FluentIcons.Regular.CheckmarkUnderlineCircle20: ImageVector
  get() {
    if (_checkmarkUnderlineCircle20 != null) {
      return _checkmarkUnderlineCircle20!!
    }
    _checkmarkUnderlineCircle20 = fluentIcon(name = "Regular.CheckmarkUnderlineCircle20", 20f) {
      materialPath {
          moveTo(10.0F, 17.0F)
