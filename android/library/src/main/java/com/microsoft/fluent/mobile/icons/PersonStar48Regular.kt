...
public val FluentIcons.Regular.PersonStar48: ImageVector
  get() {
    if (_personStar48 != null) {
      return _personStar48!!
    }
    _personStar48 = fluentIcon(name = "Regular.PersonStar48", 48f) {
      materialPath {
          moveTo(24.0F, 4.0F)
          ...
          curveToRelative(-0.706F, -0.743F, -1.325F, -1.568F, -1.841F, -2.461F)
          curveToRelative(-3.824F, -0.034F, -7.163F, -0.82F, -9.519F, -2.254F)
