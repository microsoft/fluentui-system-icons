...
public val FluentIcons.Regular.DataWaterfall20: ImageVector
  get() {
    if (_dataWaterfall20 != null) {
      return _dataWaterfall20!!
    }
    _dataWaterfall20 = fluentIcon(name = "Regular.DataWaterfall20", 20f) {
      materialPath {
          moveTo(1.0F, 3.5F)
          ...
          verticalLineToRelative(-4.7F)
          curveToRelative(0.0F, -0.377F, -0.378F, -0.8F, -1.0F, -0.8F)
          horizontalLineToRelative(-3.0F)
          verticalLineToRelative(4.7F)
          curveToRelative(0.0F, 0.377F, 0.378F, 0.8F, 1.0F, 0.8F)
          horizontalLineToRelative(3.0F)
