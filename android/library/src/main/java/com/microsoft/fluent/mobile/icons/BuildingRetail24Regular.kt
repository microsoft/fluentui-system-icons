...
public val FluentIcons.Regular.BuildingRetail24: ImageVector
  get() {
    if (_buildingRetail24 != null) {
      return _buildingRetail24!!
    }
    _buildingRetail24 = fluentIcon(name = "Regular.BuildingRetail24", 24f) {
      materialPath {
          moveTo(6.75F, 8.0F)
...
private var _buildingRetail24: ImageVector? = null
