...
public val FluentIcons.Filled.ClipboardTextLtr20: ImageVector
  get() {
    if (_clipboardTextLtr20 != null) {
      return _clipboardTextLtr20!!
    }
    _clipboardTextLtr20 = fluentIcon(name = "Filled.ClipboardTextLtr20", 20f) {
      materialPath {
          moveTo(8.5F, 2.0F)
...
private var _clipboardTextLtr20: ImageVector? = null
