...
public val FluentIcons.Regular.Battery620: ImageVector
  get() {
    if (_battery620 != null) {
      return _battery620!!
    }
    _battery620 = fluentIcon(name = "Regular.Battery620", 620f) {
      materialPath {
          moveTo(13.5F, 5.0F)
          ...
          curveToRelative(0.427F, 0.0F, 0.778F, 0.318F, 0.83F, 0.73F)
          lineTo(10.0F, 7.784F)
...
private var _battery620: ImageVector? = null
