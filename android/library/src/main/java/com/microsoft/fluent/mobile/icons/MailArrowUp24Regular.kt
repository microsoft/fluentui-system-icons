...
public val FluentIcons.Regular.MailArrowUp24: ImageVector
  get() {
    if (_mailArrowUp24 != null) {
      return _mailArrowUp24!!
    }
    _mailArrowUp24 = fluentIcon(name = "Regular.MailArrowUp24", 24f) {
      materialPath {
          moveTo(23.0F, 6.5F)
...
private var _mailArrowUp24: ImageVector? = null
