...
public val FluentIcons.Regular.TableAdd16: ImageVector
  get() {
    if (_tableAdd16 != null) {
      return _tableAdd16!!
    }
    _tableAdd16 = fluentIcon(name = "Regular.TableAdd16", 16f) {
      materialPath {
          moveTo(4.5F, 2.0F)
          ...
          curveToRelative(0.0F, -1.177F, 0.37F, -2.268F, 1.0F, -3.163F)
          verticalLineTo(6.0F)
          horizontalLineToRelative(1.337F)
          curveTo(8.232F, 5.37F, 9.323F, 5.0F, 10.5F, 5.0F)
...
private var _tableAdd16: ImageVector? = null
