...
public val FluentIcons.Regular.MailInboxAll24: ImageVector
  get() {
    if (_mailInboxAll24 != null) {
      return _mailInboxAll24!!
    }
    _mailInboxAll24 = fluentIcon(name = "Regular.MailInboxAll24", 24f) {
      materialPath {
          moveTo(6.25F, 3.0F)
          ...
          horizontalLineToRelative(10.5F)
          curveTo(17.664F, 6.5F, 18.0F, 6.836F, 18.0F, 7.25F)
          curveToRelative(0.0F, 0.38F, -0.282F, 0.694F, -0.648F, 0.743F)
          lineTo(17.25F, 8.0F)
          horizontalLineTo(6.75F)
...
private var _mailInboxAll24: ImageVector? = null
