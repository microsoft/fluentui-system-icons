...
public val FluentIcons.Filled.DocumentBulletList16: ImageVector
  get() {
    if (_documentBulletList16 != null) {
      return _documentBulletList16!!
    }
    _documentBulletList16 = fluentIcon(name = "Filled.DocumentBulletList16", 16f) {
      materialPath {
          moveTo(8.0F, 1.0F)
...
private var _documentBulletList16: ImageVector? = null
