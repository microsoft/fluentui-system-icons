...
public val FluentIcons.Regular.ClipboardError24: ImageVector
  get() {
    if (_clipboardError24 != null) {
      return _clipboardError24!!
    }
    _clipboardError24 = fluentIcon(name = "Regular.ClipboardError24", 24f) {
      materialPath {
          moveTo(13.75F, 2.0F)
...
private var _clipboardError24: ImageVector? = null
