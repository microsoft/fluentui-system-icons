...
```groovy
implementation 'com.microsoft.design:fluent-system-icons:1.1.158@aar'
```
...
pod "FluentIcons", "1.1.158"
```

#### Carthage

```bash
git "git@github.com:microsoft/fluentui-system-icons.git" "1.1.158"
```
