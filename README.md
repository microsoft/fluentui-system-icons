...
```groovy
implementation 'com.microsoft.design:fluent-system-icons:1.1.314@aar'
```
...
```bash
git "git@github.com:microsoft/fluentui-system-icons.git" "1.1.314"
```
