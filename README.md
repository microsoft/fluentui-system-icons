...
```groovy
implementation 'com.microsoft.design:fluent-system-icons:1.1.216@aar'
```
...
pod "FluentIcons", "1.1.216"
```

#### Carthage

```bash
git "git@github.com:microsoft/fluentui-system-icons.git" "1.1.216"
```
