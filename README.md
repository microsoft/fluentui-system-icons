...
```groovy
implementation 'com.microsoft.design:fluent-system-icons:1.1.6'
```
...
```ruby
pod "FluentIcons", git: "https://github.com/microsoft/fluent-system-icons.git", tag: "1.1.6"
```

#### Carthage

```bash
git "git@github.com:microsoft/fluent-system-icons.git" "1.1.6"
```
