...
```groovy
implementation 'com.microsoft.design:fluent-system-icons:1.1.194@aar'
```
...
pod "FluentIcons", "1.1.194"
```

#### Carthage

```bash
git "git@github.com:microsoft/fluentui-system-icons.git" "1.1.194"
```
